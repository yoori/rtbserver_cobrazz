...
namespace AdServer::Commons
{
  ...
  private:
    ...
    {
    public:
      DelegateJob(const Delegate& delegate, Generics::ActiveObjectCallback* callback)
        noexcept
        : SingleJob(callback),
          delegate_(delegate)
      {}
  ...
  make_delegate_active_object(
    ...
    noexcept
  {
    return DelegateActiveObject_var(new DelegateActiveObject(delegate, callback, threads_number));
  }
}
