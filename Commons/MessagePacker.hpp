...
namespace AdServer::Commons
{
  ...
  private:
    ...
    public:
       ...
       */
      void
      add_message(const String::SubString& message_prefix, const String::SubString& message)
        noexcept
      {
        ++counter_;
  ...
  public:
    ...
    {
    public:
      PoolStream(Sync::PosixMutex& table_lock, Cell& cell, const String::SubString& message_prefix)
        noexcept;
     ...
     */
    PoolStream_var
    add_stream(const Key_var& key, const String::SubString& message_prefix)
      /*throw(eh::Exception)*/;
...
namespace AdServer::Commons
{
    ...
    noexcept
  {
    ...
    for (typename CellsContainer::iterator it(cells.begin()); it != cells.end(); ++it)
    {
