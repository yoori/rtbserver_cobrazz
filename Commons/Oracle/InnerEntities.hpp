...
namespace AdServer::Commons::Oracle
{
  ...
  OCIDescriptorPtr<Type, TypeId>::reset(Type* handle)
  {
    ...
    #ifdef _USE_OCCI
      sword result;
      if ((result = OCIDescriptorFree(handle_, TypeId)) != OCI_SUCCESS)
      {
  ...
  OCIObjectPtr<Type, PIN_FREE>::OCIObjectPtr(void* env_handle, void* error_handle, Type* obj)
