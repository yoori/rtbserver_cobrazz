...
namespace AdServer::Commons::Oracle
{
  ...
  public:
    ...
    ResultSet_var execute_query(const Generics::Time* timeout = 0, unsigned long fetch_size = 1024)
      /*throw(Exception, SqlException, TimedOut, NotSupported)*/;

    template<class ContainerType>
    void set_array(unsigned int param_index, const ContainerType& cont, const char* type)
      /*throw(Exception, SqlException, NotSupported)*/;

    void set_number_array(unsigned int ind, std::vector<std::string>& vec, const char* type)
      /*throw(eh::Exception, TimedOut, Exception, SqlException, NotSupported)*/;

    void set_array(unsigned int ind, std::vector<std::string>& vec, const char* type)
      /*throw(eh::Exception, TimedOut, Exception, SqlException, NotSupported)*/;

    void set_array(unsigned int ind, std::vector<Object_var>& vec, const char* type)
      /*throw(eh::Exception, TimedOut, Exception, SqlException, NotSupported)*/;
    ...
    void set_number_from_string(unsigned int col_index, const char* val)
      /*throw(Exception, SqlException, NotSupported)*/;
  ...
  protected:
    ...
    ResultSet_var execute_query_(const Generics::Time* timeout, unsigned long fetch_size)
...
#ifdef _USE_OCCI
    void describe_type_(const char* full_type_name, OCIObjectPtr<OCIType, true>& type_info)
      /*throw(TimedOut, SqlException)*/;
#endif

    const Generics::Time* use_timeout_(const Generics::Time* timeout) const
      noexcept;
  ...
  public:
    ...
    void set_number_from_string(const char* val)
      /*throw(Exception, SqlException)*/;
  ...
  private:
    ...
    void set_object_attr_(const char* fun, void* val, unsigned long type_id)
      /*throw(SqlException)*/;
...
namespace AdServer::Commons::Oracle
{
   ...
   */
  template<class ContainerType>
  void Statement::set_array(unsigned int param_index, const ContainerType& cont, const char* type)
    /*throw(Exception, SqlException, NotSupported)*/
  {
    std::vector<std::string> vec;
    for (typename ContainerType::const_iterator it = cont.begin(); it != cont.end(); ++it)
    {
