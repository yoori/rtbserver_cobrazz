...
namespace AdServer::Commons::Postgres
{
  ...
  public:
    ...
    void set_value(const TypeValue& value)
      /*throw(eh::Exception)*/;

    void set_date(const Generics::Time& date)
      /*throw(eh::Exception)*/;

    void set_time(const Generics::Time& time)
      /*throw(eh::Exception)*/;

    void set_timestamp(const Generics::Time& timestamp)
      /*throw(eh::Exception)*/;
...
{
  template<class TypeValue>
  void SqlStream::set_value(const TypeValue& value)
    /*throw(eh::Exception)*/
  {
    next_field_();
    stream_ << value;
