...
namespace AdServer::Commons::Postgres
{
  ...
  public:
    ...
    */
    ...
    void set_array(unsigned int param_num, const ContainerType& cont)
      /*throw(Exception)*/;

    void set_array(unsigned int param_num, const ObjectVector& objs)
      /*throw(Exception)*/;

    template<class TypeValue>
    void set_value(unsigned int param_num, const TypeValue& value)
      /*throw(Exception)*/;

    void set_date(unsigned int param_num, const Generics::Time& date)
      /*throw(eh::Exception)*/;

    void set_time(unsigned int param_num, const Generics::Time& time)
      /*throw(eh::Exception)*/;

    void set_timestamp(unsigned int param_num, const Generics::Time& timestamp)
      /*throw(eh::Exception)*/;
...
namespace AdServer::Commons::Postgres
{
  ...
  template<class ContainerType>
  void Statement::set_array(unsigned int param_num, const ContainerType& cont)
    /*throw(Exception)*/
  {
  ...
  template<class TypeValue>
  void Statement::set_value(unsigned int param_num, const TypeValue& value)
    /*throw(Exception)*/
  {
    std::ostringstream ostr;
    ostr << value;
