...
namespace AdServer::CampaignSvcs
{
  ...
  private:
    ...
    bool update_ora_config_(CampaignConfig* new_config, UpdatingState* updating_state)
      /*throw(Exception, eh::Exception)*/;

    Generics::Time
    query_db_stamp_(Commons::Postgres::Connection* conn)
      /*throw(Exception)*/;
    ...
    void query_recursive_tokens_(Commons::Postgres::Connection* conn)
      /*throw(Exception)*/;
    ...
    void query_currency_exchange_(Commons::Postgres::Connection* conn, CampaignConfig* new_config)
      /*throw(Exception, eh::Exception)*/;
    ...
    static const std::string generate_key_(const std::list<BehavioralParameterDef>& bps)
      /*throw(eh::Exception)*/;
    ...
    static
    bool check_numeric_option_(const char* option, bool signed_cmp = false)
      /*throw(Exception, eh::Exception)*/;
