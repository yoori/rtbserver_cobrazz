...
#include "CampaignServerImpl_v320.hpp"

namespace
{
  void
  copy_price_range_seq(
    AdServer::CampaignSvcs_v320::PriceRangeSeq& tgt,
    const AdServer::CampaignSvcs_v330::PriceRangeSeq& src)
    noexcept
  {
  ...
  void
  copy_channel_expr(
    AdServer::CampaignSvcs_v320::ExpressionInfo& result_expr,
    const AdServer::CampaignSvcs_v330::ExpressionInfo& expr)
  {
  ...
  void copy_channel(
    AdServer::CampaignSvcs_v320::ExpressionChannelInfo& result_channel_info,
    const AdServer::CampaignSvcs_v330::ExpressionChannelInfo& channel_info)
  {
    ...
    if (channel_info.type == 'T')
    {
      result_channel_info.type = 'A';
    }
    else
    {
  ...
  copy_simple_channels(
    const AdServer::CampaignSvcs_v330::SimpleChannelKeySeq& simple_channel_seq,
    AdServer::CampaignSvcs_v320::SimpleChannelKeySeq& result_simple_channel_seq,
    const Generics::Time& request_timestamp)
  {
  ...
  void convert_bp_seq(
    AdServer::CampaignSvcs_v320::BehavParameterSeq& result,
    const AdServer::CampaignSvcs_v330::BehavParameterSeq& src)
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::BehavParameter& bp_el = src[bp_el_i];
      if(bp_el.trigger_type != 'R')
      {
        AdServer::CampaignSvcs_v320::BehavParameter& result_bp_el = result[res_el_i++];
  ...
  void convert_ext_categories(
    AdServer::CampaignSvcs_v320::ExternalCategorySeq& result,
    const AdServer::CampaignSvcs_v330::ExternalCategorySeq& src)
  {
    result.length(src.length());
    for(CORBA::ULong i = 0; i < src.length(); ++i)
    {
      const AdServer::CampaignSvcs_v330::ExternalCategoryInfo& cat = src[i];
      AdServer::CampaignSvcs_v320::ExternalCategoryInfo& res = result[i];
...
namespace CampaignSvcs
{
  ...
  CampaignServerImpl_v320::CampaignServerImpl_v320(
  ...
  CampaignServerImpl_v320::~CampaignServerImpl_v320() noexcept
  {}

  void
  CampaignServerImpl_v320::convert_config_(
    ...
    /*throw(Exception, eh::Exception)*/
  {
    ...
    convert_sizes_(sizes, update_info);
    ...
    convert_campaigns_(result_update_info, update_info, sizes, request_timestamp);
    ...
    convert_tags_(result_update_info, update_info, sizes, request_timestamp);
  ...
  void
  CampaignServerImpl_v320::convert_get_config_settings_(
  ...
  AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo*
  CampaignServerImpl_v320::get_config(
    const AdServer::CampaignSvcs_v320::CampaignGetConfigSettings& settings)
  ...
  {
    static const char* FUN = "CampaignServerImpl_v320::get_config()";

    try
    {
      AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo_var campaign_config;
      AdServer::CampaignSvcs_v330::CampaignGetConfigSettings conv_settings;

      convert_get_config_settings_(settings, conv_settings);

      campaign_config = campaign_server_->get_config(conv_settings);

      AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo_var result_campaign_config =
        new AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo();
    ...
    catch(const AdServer::CampaignSvcs_v330::CampaignServer::ImplementationException& ex)
    {
      Stream::Error ostr;
      ostr << FUN << ": AdServer::CampaignSvcs_v330::CampaignServer::"
        "ImplementationException caught: " <<
        ex.description;

      CORBACommons::throw_desc<
        CampaignSvcs_v320::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v330::CampaignServer::NotReady& ex)
    {
      throw AdServer::CampaignSvcs_v320::CampaignServer::NotReady(ex.description);
    }
  ...
  AdServer::CampaignSvcs_v320::EcpmSeq*
  CampaignServerImpl_v320::get_ecpms(
    const AdServer::CampaignSvcs_v320::TimestampInfo& request_timestamp)
    /*throw(AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v320::get_ecpms()";
      
    try
    {
      AdServer::CampaignSvcs_v330::EcpmSeq_var ecpms  =
        campaign_server_->get_ecpms(request_timestamp);
      AdServer::CampaignSvcs_v320::EcpmSeq_var result_ecpms =
        new AdServer::CampaignSvcs_v320::EcpmSeq();
    ...
    catch(const AdServer::CampaignSvcs_v330::CampaignServer::ImplementationException& e)
    {
      Stream::Error ostr;
      ostr << FUN << ": CampaignSvcs_v330::CampaignServer::"
        "ImplementationException caught: " << e.description;
      CORBACommons::throw_desc<
        CampaignSvcs_v320::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v330::CampaignServer::NotReady& )
    {
      throw AdServer::CampaignSvcs_v320::CampaignServer::NotReady();
    }
    return 0; // never reach
  }

  AdServer::CampaignSvcs_v320::BriefSimpleChannelAnswer*
  CampaignServerImpl_v320::brief_simple_channels(
  ...
  {
    throw AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException(
      "CampaignServerImpl_v320::brief_simple_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v320::SimpleChannelAnswer*
  CampaignServerImpl_v320::simple_channels(
    const AdServer::CampaignSvcs_v320::CampaignServer::GetSimpleChannelsInfo& /*settings*/)
    /*throw(AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v320::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException(
      "CampaignServerImpl_v320::simple_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v320::ExpressionChannelsInfo*
  CampaignServerImpl_v320::get_expression_channels(
    const AdServer::CampaignSvcs_v320::CampaignServer::GetExpressionChannelsInfo&)
    /*throw(AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v320::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException(
      "CampaignServerImpl_v320::get_expression_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v320::DetectorsConfig*
  CampaignServerImpl_v320::detectors(
    const AdServer::CampaignSvcs_v320::TimestampInfo& /*request_timestamp*/)
    /*throw(AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v320::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException(
      "CampaignServerImpl_v320::search_engines(): Not supported.");
  }

  AdServer::CampaignSvcs_v320::FreqCapConfigInfo*
  CampaignServerImpl_v320::freq_caps()
    /*throw(AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v320::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException(
      "CampaignServerImpl_v320::freq_caps(): Not supported.");
  }

  AdServer::CampaignSvcs_v320::StatInfo*
  CampaignServerImpl_v320::get_stat() /*throw(
    AdServer::CampaignSvcs_v320::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v320::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v320::CampaignServer::NotSupport(
      "CampaignServerImpl_v320::get_stat(): Not supported.");
  }

  void
  CampaignServerImpl_v320::update_stat() /*throw(
    AdServer::CampaignSvcs_v320::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException)*/
  {
    throw AdServer::CampaignSvcs_v320::CampaignServer::NotSupport(
      "CampaignServerImpl_v320::update_stat(): Not supported.");
  }

  CORBA::Boolean
  CampaignServerImpl_v320::need_config(
    const CORBACommons::TimestampInfo& master_stamp)
    /*throw(AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v320::need_config()";

    try
    {
      return campaign_server_->need_config(master_stamp);
    }
    catch(const AdServer::CampaignSvcs_v320::
  ...
  CampaignServerImpl_v320::get_discover_channels(
    CORBA::ULong, CORBA::ULong)
    /*throw(AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v320::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException(
      "CampaignServerImpl_v320::get_discover_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v320::CampaignServer::PassbackInfo*
  CampaignServerImpl_v320::get_tag_passback(CORBA::ULong, const char*)
    /*throw(AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v320::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException(
      "CampaignServerImpl_v320::get_tag_passback(): Not supported.");
  }

  AdServer::CampaignSvcs_v320::FraudConditionConfig*
  CampaignServerImpl_v320::fraud_conditions()
    /*throw(AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v320::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException(
      "CampaignServerImpl_v320::fraud_conditions(): Not supported.");
  }

  void
  CampaignServerImpl_v320::convert_campaigns_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const SizeMap& sizes,
    const Generics::Time& request_timestamp)
    ...
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::CampaignInfo& campaign_info =
        update_info.campaigns[i];

      if(CorbaAlgs::unpack_time(campaign_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::CampaignInfo& result_campaign_info =
        ...
        {
          const AdServer::CampaignSvcs_v330::CreativeInfo& creative_info =
            campaign_info.creatives[j];

          if(creative_info.sizes.length() > 0)
          {
            SizeMap::const_iterator size_it = sizes.find(creative_info.sizes[0].size_id);

            if(size_it != sizes.end())
            {
              AdServer::CampaignSvcs_v320::CreativeInfo& result_creative_info =
              ...
              result_creative_info.size_name = size_it->second->protocol_name;
              result_creative_info.up_expand_space = creative_info.sizes[0].up_expand_space;
              result_creative_info.right_expand_space = creative_info.sizes[0].right_expand_space;
              result_creative_info.down_expand_space = creative_info.sizes[0].down_expand_space;
              result_creative_info.left_expand_space = creative_info.sizes[0].left_expand_space;

              CorbaAlgs::copy_sequence(creative_info.categories,
                result_creative_info.categories);

              result_creative_info.tokens.length(
                creative_info.tokens.length() +
                creative_info.sizes[0].tokens.length());
              CORBA::ULong res_tok_i = 0;
              for(; res_tok_i < creative_info.tokens.length(); ++res_tok_i)
              {
                result_creative_info.tokens[res_tok_i].option_id =
                  creative_info.tokens[res_tok_i].option_id;
                result_creative_info.tokens[res_tok_i].value =
                  creative_info.tokens[res_tok_i].value;
              }

              CORBA::ULong src_tok_i = 0;
              for(; src_tok_i < creative_info.sizes[0].tokens.length();
                  ++res_tok_i, ++src_tok_i)
              {
                result_creative_info.tokens[res_tok_i].option_id =
                  creative_info.sizes[0].tokens[src_tok_i].option_id;
                result_creative_info.tokens[res_tok_i].value =
                  creative_info.sizes[0].tokens[src_tok_i].value;
              }
            }
          }
        }
  ...
  void
  CampaignServerImpl_v320::convert_accounts_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::AccountInfo& account_info =
        update_info.accounts[i];

      if(CorbaAlgs::unpack_time(account_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::AccountInfo& result_account_info =
  ...
  void
  CampaignServerImpl_v320::convert_creative_options_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::CreativeOptionInfo& option_info =
        update_info.activate_creative_options[i];

      if(CorbaAlgs::unpack_time(option_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::CreativeOptionInfo& result_option_info =
  ...
  void
  CampaignServerImpl_v320::convert_expression_channels_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v320::convert_geo_channels_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::GeoChannelInfo& channel_info =
        update_info.activate_geo_channels[ch_i];

      if(CorbaAlgs::unpack_time(channel_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::GeoChannelInfo& result_channel_info =
  ...
  void
  CampaignServerImpl_v320::convert_ecpm_seq_(
    ...
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::CampaignEcpmInfo& ecpm_info = ecpms[i];

      if(CorbaAlgs::unpack_time(ecpm_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::CampaignEcpmInfo& res_ecpm_info = result_ecpms[res_i++];
  ...
  void
  CampaignServerImpl_v320::convert_ecpms_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v320::convert_sites_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::SiteInfo& site_info = update_info.sites[i];

      if(CorbaAlgs::unpack_time(site_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::SiteInfo& result_site_info =
        ...
        // TODO: approved_creatives filling
      }
    }
  ...
  void
  CampaignServerImpl_v320::convert_sizes_(
    SizeMap& sizes,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info)
    noexcept
  {
  ...
  void
  CampaignServerImpl_v320::convert_tags_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const SizeMap& sizes,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::TagInfo& tag_info =
        update_info.tags[tag_i];

      if(CorbaAlgs::unpack_time(tag_info.timestamp) > request_timestamp &&
         tag_info.sizes.length() > 0)
      {
        SizeMap::const_iterator size_it = sizes.find(tag_info.sizes[0].size_id);

        if(size_it != sizes.end())
        {
          AdServer::CampaignSvcs_v320::TagInfo& result_tag_info =
          ...
          result_tag_info.size = size_it->second->protocol_name;
          ...
          result_tag_info.max_text_creatives = tag_info.sizes[0].max_text_creatives;
          result_tag_info.width = size_it->second->width;
          result_tag_info.height = size_it->second->height;
          ...
          {
            const AdServer::CampaignSvcs_v330::TagPricingInfo& tag_pricing_info =
              tag_info.tag_pricings[j];
            AdServer::CampaignSvcs_v320::TagPricingInfo& result_tag_pricing_info =
  ...
  void
  CampaignServerImpl_v320::convert_frequency_caps_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::FreqCapInfo& freq_cap =
        update_info.frequency_caps[i];

      if(CorbaAlgs::unpack_time(freq_cap.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::FreqCapInfo& result_freq_cap =
  ...
  void
  CampaignServerImpl_v320::convert_simple_channels_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v320::convert_behav_params_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    {
      ...
      {
        const AdServer::CampaignSvcs_v330::BehavParamInfo& bp =
          update_info.behav_params[i];

        if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
        {
          AdServer::CampaignSvcs_v320::BehavParamInfo& result_bp =
    ...
    {
      const AdServer::CampaignSvcs_v330::KeyBehavParamInfo& bp =
        update_info.key_behav_params[i];
      if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::KeyBehavParamInfo& result_bp =
  ...
  void
  CampaignServerImpl_v320::convert_colocations_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::ColocationInfo& colo_info =
        update_info.colocations[i];
      if(CorbaAlgs::unpack_time(colo_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::ColocationInfo& result_colo_info =
  ...
  void
  CampaignServerImpl_v320::convert_creative_templates_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::CreativeTemplateInfo& cr_templ_info =
        update_info.creative_templates[i];
      if(CorbaAlgs::unpack_time(cr_templ_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::CreativeTemplateInfo& result_cr_templ_info =
        ...
        {
          const AdServer::CampaignSvcs_v330::CreativeTemplateFileInfo& ctf_info =
            cr_templ_info.files[ctf_i];
          AdServer::CampaignSvcs_v320::CreativeTemplateFileInfo& result_ctf_info =
          ...
          result_ctf_info.type = static_cast<
            AdServer::CampaignSvcs_v320::CreativeTemplateType>(
              ctf_info.type);
        }
  ...
  void
  CampaignServerImpl_v320::convert_currencies_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::CurrencyInfo& currency_info =
        update_info.currencies[i];

      if(CorbaAlgs::unpack_time(currency_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::CurrencyInfo& result_currency_info =
  ...
  void
  CampaignServerImpl_v320::convert_campaign_keywords_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::CampaignKeywordInfo& keyword_info =
        update_info.campaign_keywords[i];

      if(CorbaAlgs::unpack_time(keyword_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::CampaignKeywordInfo& res_keyword_info =
  ...
  void
  CampaignServerImpl_v320::convert_creative_categories_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::CreativeCategoryInfo& category_info =
        update_info.creative_categories[i];
      if(CorbaAlgs::unpack_time(category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::CreativeCategoryInfo& res_category_info =
  ...
  void
  CampaignServerImpl_v320::convert_adv_actions_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v320::convert_category_channels_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::CategoryChannelInfo& channel_category_info =
        update_info.category_channels[cat_i];
      if(CorbaAlgs::unpack_time(channel_category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::CategoryChannelInfo& result_channel_category_info =
  ...
  void
  CampaignServerImpl_v320::convert_search_engines_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::SearchEngineInfo& s_info =
        update_info.search_engines[i];
      if(CorbaAlgs::unpack_time(s_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::SearchEngineInfo& result_s_info =
  ...
  void
  CampaignServerImpl_v320::convert_web_browsers_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::WebBrowserInfo& b_info =
        update_info.web_browsers[i];
      if(CorbaAlgs::unpack_time(b_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::WebBrowserInfo& result_b_info =
        ...
        {
          const AdServer::CampaignSvcs_v330::WebBrowserDetectorInfo& d_info =
            b_info.detectors[j];
          AdServer::CampaignSvcs_v320::WebBrowserDetectorInfo& result_d_info =
  ...
  void
  CampaignServerImpl_v320::convert_platforms_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::PlatformInfo& p_info =
        update_info.platforms[i];
      if(CorbaAlgs::unpack_time(p_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::PlatformInfo& result_p_info =
        ...
        {
          const AdServer::CampaignSvcs_v330::PlatformDetectorInfo& pd_info =
            p_info.detectors[j];
          AdServer::CampaignSvcs_v320::PlatformDetectorInfo& result_pd_info =
  ...
  void
  CampaignServerImpl_v320::convert_fraud_conditions_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::FraudConditionInfo& fraud_cond_info =
        update_info.fraud_conditions[i];
      if(CorbaAlgs::unpack_time(fraud_cond_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::FraudConditionInfo& result_fraud_cond_info =
  ...
  void
  CampaignServerImpl_v320::convert_string_dictionaries_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::WebOperationInfo& info =
        update_info.web_operations[i];
      if(CorbaAlgs::unpack_time(info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::WebOperationInfo& result_info =
  ...
  void
  CampaignServerImpl_v320::convert_app_formats_(
    AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v330::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v330::AppFormatInfo& info =
        update_info.app_formats[i];
      if(CorbaAlgs::unpack_time(info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v320::AppFormatInfo& result_info =
