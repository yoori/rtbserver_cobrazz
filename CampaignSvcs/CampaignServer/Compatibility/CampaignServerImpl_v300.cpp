...
#include "CampaignServerImpl_v300.hpp"

namespace
{
  void
  copy_price_range_seq(
    AdServer::CampaignSvcs_v291::PriceRangeSeq& tgt,
    const AdServer::CampaignSvcs_v310::PriceRangeSeq& src)
    noexcept
  {
  ...
  void
  copy_channel_expr(
    AdServer::CampaignSvcs_v291::ExpressionInfo& result_expr,
    const AdServer::CampaignSvcs_v310::ExpressionInfo& expr)
  {
  ...
  void copy_channel(
    AdServer::CampaignSvcs_v291::ExpressionChannelInfo& result_channel_info,
    const AdServer::CampaignSvcs_v310::ExpressionChannelInfo& channel_info)
  {
  ...
  copy_simple_channels(
    const AdServer::CampaignSvcs_v310::SimpleChannelKeySeq& simple_channel_seq,
    AdServer::CampaignSvcs_v291::SimpleChannelKeySeq& result_simple_channel_seq,
    const Generics::Time& request_timestamp)
  {
  ...
  void convert_bp_seq(
    AdServer::CampaignSvcs_v291::BehavParameterSeq& result,
    const AdServer::CampaignSvcs_v310::BehavParameterSeq& src)
  {
    result.length(src.length());
    
    for(CORBA::ULong bp_el_i = 0; bp_el_i < src.length(); ++bp_el_i)
    {
      const AdServer::CampaignSvcs_v310::BehavParameter& bp_el = src[bp_el_i];
      AdServer::CampaignSvcs_v291::BehavParameter& result_bp_el = result[bp_el_i];
...
namespace CampaignSvcs
{
  ...
  CampaignServerImpl_v300::CampaignServerImpl_v300(
  ...
  CampaignServerImpl_v300::~CampaignServerImpl_v300() noexcept
  {}

  void
  CampaignServerImpl_v300::convert_config_(
  ...
  void
  CampaignServerImpl_v300::convert_get_config_settings_(
  ...
  AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo*
  CampaignServerImpl_v300::get_config(
    const AdServer::CampaignSvcs_v291::CampaignGetConfigSettings& settings)
  ...
  {
    static const char* FUN = "CampaignServerImpl_v300::get_config()";

    try
    {
      AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo_var campaign_config;
      AdServer::CampaignSvcs_v310::CampaignGetConfigSettings conv_settings;

      convert_get_config_settings_(settings, conv_settings);

      campaign_config = campaign_server_->get_config(conv_settings);

      AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo_var result_campaign_config =
        new AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo();
    ...
    catch(const AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException& ex)
    {
      Stream::Error ostr;
      ostr << FUN << ": AdServer::CampaignSvcs_v310::CampaignServer::"
        "ImplementationException caught: " <<
        ex.description;

      CORBACommons::throw_desc<
        CampaignSvcs_v291::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v310::CampaignServer::NotReady& ex)
    {
      throw AdServer::CampaignSvcs_v291::CampaignServer::NotReady(ex.description);
    }
  ...
  AdServer::CampaignSvcs_v291::EcpmSeq*
  CampaignServerImpl_v300::get_ecpms(
    const AdServer::CampaignSvcs_v291::TimestampInfo& request_timestamp)
    /*throw(AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v300::get_ecpms()";
      
    try
    {
      AdServer::CampaignSvcs_v310::EcpmSeq_var ecpms  =
        campaign_server_->get_ecpms(request_timestamp);
      AdServer::CampaignSvcs_v291::EcpmSeq_var result_ecpms =
        new AdServer::CampaignSvcs_v291::EcpmSeq();
    ...
    catch(const AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException& e)
    {
      Stream::Error ostr;
      ostr << FUN << ": CampaignSvcs_v310::CampaignServer::"
        "ImplementationException caught: " << e.description;
      CORBACommons::throw_desc<
        CampaignSvcs_v291::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v310::CampaignServer::NotReady& )
    {
      throw AdServer::CampaignSvcs_v291::CampaignServer::NotReady();
    }
    return 0; // never reach
  }

  AdServer::CampaignSvcs_v291::BriefSimpleChannelAnswer*
  CampaignServerImpl_v300::brief_simple_channels(
  ...
  {
    throw AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException(
      "CampaignServerImpl_v300::brief_simple_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v291::SimpleChannelAnswer*
  CampaignServerImpl_v300::simple_channels(
    const AdServer::CampaignSvcs_v291::CampaignServer::GetSimpleChannelsInfo& /*settings*/)
    /*throw(AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v291::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException(
      "CampaignServerImpl_v300::simple_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v291::ExpressionChannelsInfo*
  CampaignServerImpl_v300::get_expression_channels(
    const AdServer::CampaignSvcs_v291::CampaignServer::GetExpressionChannelsInfo&)
    /*throw(AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v291::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException(
      "CampaignServerImpl_v300::get_expression_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v291::DetectorsConfig*
  CampaignServerImpl_v300::detectors(
    const AdServer::CampaignSvcs_v291::TimestampInfo& /*request_timestamp*/)
    /*throw(AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v291::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException(
      "CampaignServerImpl_v300::search_engines(): Not supported.");
  }

  AdServer::CampaignSvcs_v291::FreqCapConfigInfo*
  CampaignServerImpl_v300::freq_caps()
    /*throw(AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v291::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException(
      "CampaignServerImpl_v300::freq_caps(): Not supported.");
  }

  AdServer::CampaignSvcs_v291::StatInfo*
  CampaignServerImpl_v300::get_stat() /*throw(
    AdServer::CampaignSvcs_v291::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v291::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v291::CampaignServer::NotSupport(
      "CampaignServerImpl_v300::get_stat(): Not supported.");
  }

  void
  CampaignServerImpl_v300::update_stat() /*throw(
    AdServer::CampaignSvcs_v291::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException)*/
  {
    throw AdServer::CampaignSvcs_v291::CampaignServer::NotSupport(
      "CampaignServerImpl_v300::update_stat(): Not supported.");
  }

  CORBA::Boolean
  CampaignServerImpl_v300::need_config(
    const CORBACommons::TimestampInfo& master_stamp)
    /*throw(AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v300::need_config()";

    try
    {
      return campaign_server_->need_config(master_stamp);
    }
    catch(const AdServer::CampaignSvcs_v291::
  ...
  CampaignServerImpl_v300::get_discover_channels(
    CORBA::ULong, CORBA::ULong)
    /*throw(AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v291::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException(
      "CampaignServerImpl_v300::get_discover_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v291::CampaignServer::PassbackInfo*
  CampaignServerImpl_v300::get_tag_passback(CORBA::ULong)
    /*throw(AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v291::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException(
      "CampaignServerImpl_v300::get_tag_passback(): Not supported.");
  }

  AdServer::CampaignSvcs_v291::FraudConditionConfig*
  CampaignServerImpl_v300::fraud_conditions()
    /*throw(AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v291::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException(
      "CampaignServerImpl_v300::fraud_conditions(): Not supported.");
  }

  void
  CampaignServerImpl_v300::convert_campaigns_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    const
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::CampaignInfo& campaign_info =
        update_info.campaigns[i];

      if(CorbaAlgs::unpack_time(campaign_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::CampaignInfo& result_campaign_info =
        ...
        {
          const AdServer::CampaignSvcs_v310::CreativeInfo& creative_info =
            campaign_info.creatives[j];

          AdServer::CampaignSvcs_v291::CreativeInfo& result_creative_info =
  ...
  void
  CampaignServerImpl_v300::convert_accounts_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::AccountInfo& account_info =
        update_info.accounts[i];

      if(CorbaAlgs::unpack_time(account_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::AccountInfo& result_account_info =
  ...
  void
  CampaignServerImpl_v300::convert_creative_options_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::CreativeOptionInfo& option_info =
        update_info.activate_creative_options[i];

      if(CorbaAlgs::unpack_time(option_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::CreativeOptionInfo& result_option_info =
  ...
  void
  CampaignServerImpl_v300::convert_expression_channels_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v300::convert_geo_channels_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::GeoChannelInfo& channel_info =
        update_info.activate_geo_channels[ch_i];

      if(CorbaAlgs::unpack_time(channel_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::GeoChannelInfo& result_channel_info =
  ...
  void
  CampaignServerImpl_v300::convert_ecpm_seq_(
    ...
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::CampaignEcpmInfo& ecpm_info = ecpms[i];

      if(CorbaAlgs::unpack_time(ecpm_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::CampaignEcpmInfo& res_ecpm_info = result_ecpms[res_i++];
  ...
  void
  CampaignServerImpl_v300::convert_ecpms_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v300::convert_sites_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::SiteInfo& site_info = update_info.sites[i];

      if(CorbaAlgs::unpack_time(site_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::SiteInfo& result_site_info =
  ...
  void
  CampaignServerImpl_v300::convert_tags_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::TagInfo& tag_info =
        update_info.tags[tag_i];

      if(CorbaAlgs::unpack_time(tag_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::TagInfo& result_tag_info =
        ...
        result_tag_info.passback_tokens.length(tag_info.passback_tokens.length());
        for(CORBA::ULong tok_i = 0; tok_i < tag_info.passback_tokens.length(); ++tok_i)
        {
          result_tag_info.passback_tokens[tok_i].option_id = tag_info.passback_tokens[tok_i].option_id;
          result_tag_info.passback_tokens[tok_i].value = tag_info.passback_tokens[tok_i].value;
        }
        ...
        RevenueDecimal_v300 max_revenue =
          CorbaAlgs::unpack_decimal<RevenueDecimal_v300>(
            update_info.cost_limit);
        max_revenue -= RevenueDecimal_v300(false, 0, 1);
        CORBA::ULong result_tag_pricing_i = 0;
        for(CORBA::ULong j = 0; j < tag_pricing_count; ++j)
        {
          const AdServer::CampaignSvcs_v310::TagPricingInfo& tag_pricing_info =
            tag_info.tag_pricings[j];
          AdServer::CampaignSvcs_v291::TagPricingInfo& result_tag_pricing_info =
          ...
          if(CorbaAlgs::unpack_decimal<RevenueDecimal_v300>(
              tag_pricing_info.revenue_share) != RevenueDecimal_v300::ZERO)
          {
            result_tag_pricing_info.imp_revenue =
              CorbaAlgs::pack_decimal<RevenueDecimal_v300>(max_revenue);
          }
          else
          {
  ...
  void
  CampaignServerImpl_v300::convert_frequency_caps_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::FreqCapInfo& freq_cap =
        update_info.frequency_caps[i];

      if(CorbaAlgs::unpack_time(freq_cap.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::FreqCapInfo& result_freq_cap =
  ...
  void
  CampaignServerImpl_v300::convert_simple_channels_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v300::convert_behav_params_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    {
      ...
      {
        const AdServer::CampaignSvcs_v310::BehavParamInfo& bp =
          update_info.behav_params[i];

        if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
        {
          AdServer::CampaignSvcs_v291::BehavParamInfo& result_bp =
    ...
    {
      const AdServer::CampaignSvcs_v310::KeyBehavParamInfo& bp =
        update_info.key_behav_params[i];
      if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::KeyBehavParamInfo& result_bp =
  ...
  void
  CampaignServerImpl_v300::convert_colocations_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::ColocationInfo& colo_info =
        update_info.colocations[i];
      if(CorbaAlgs::unpack_time(colo_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::ColocationInfo& result_colo_info =
  ...
  void
  CampaignServerImpl_v300::convert_creative_templates_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::CreativeTemplateInfo& cr_templ_info =
        update_info.creative_templates[i];
      if(CorbaAlgs::unpack_time(cr_templ_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::CreativeTemplateInfo& result_cr_templ_info =
        ...
        {
          const AdServer::CampaignSvcs_v310::CreativeTemplateFileInfo& ctf_info =
            cr_templ_info.files[ctf_i];
          AdServer::CampaignSvcs_v291::CreativeTemplateFileInfo& result_ctf_info =
          ...
          result_ctf_info.type =
            static_cast<AdServer::CampaignSvcs_v291::CreativeTemplateType>(
              ctf_info.type);
        }
  ...
  void
  CampaignServerImpl_v300::convert_currencies_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::CurrencyInfo& currency_info =
        update_info.currencies[i];

      if(CorbaAlgs::unpack_time(currency_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::CurrencyInfo& result_currency_info =
  ...
  void
  CampaignServerImpl_v300::convert_campaign_keywords_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::CampaignKeywordInfo& keyword_info =
        update_info.campaign_keywords[i];

      if(CorbaAlgs::unpack_time(keyword_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::CampaignKeywordInfo& res_keyword_info =
  ...
  void
  CampaignServerImpl_v300::convert_creative_categories_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::CreativeCategoryInfo& category_info =
        update_info.creative_categories[i];
      if(CorbaAlgs::unpack_time(category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::CreativeCategoryInfo& res_category_info =
  ...
  void
  CampaignServerImpl_v300::convert_adv_actions_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v300::convert_category_channels_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::CategoryChannelInfo& channel_category_info =
        update_info.category_channels[cat_i];
      if(CorbaAlgs::unpack_time(channel_category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::CategoryChannelInfo& result_channel_category_info =
  ...
  void
  CampaignServerImpl_v300::convert_search_engines_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::SearchEngineInfo& s_info =
        update_info.search_engines[i];
      if(CorbaAlgs::unpack_time(s_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::SearchEngineInfo& result_s_info =
  ...
  void
  CampaignServerImpl_v300::convert_web_browsers_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::WebBrowserInfo& b_info =
        update_info.web_browsers[i];
      if(CorbaAlgs::unpack_time(b_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::WebBrowserInfo& result_b_info =
        ...
        {
          const AdServer::CampaignSvcs_v310::WebBrowserDetectorInfo& d_info =
            b_info.detectors[j];
          AdServer::CampaignSvcs_v291::WebBrowserDetectorInfo& result_d_info =
  ...
  void
  CampaignServerImpl_v300::convert_platforms_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::PlatformInfo& p_info =
        update_info.platforms[i];
      if(CorbaAlgs::unpack_time(p_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::PlatformInfo& result_p_info =
        ...
        {
          const AdServer::CampaignSvcs_v310::PlatformDetectorInfo& pd_info =
            p_info.detectors[j];
          AdServer::CampaignSvcs_v291::PlatformDetectorInfo& result_pd_info =
  ...
  void
  CampaignServerImpl_v300::convert_fraud_conditions_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::FraudConditionInfo& fraud_cond_info =
        update_info.fraud_conditions[i];
      if(CorbaAlgs::unpack_time(fraud_cond_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::FraudConditionInfo& result_fraud_cond_info =
  ...
  void
  CampaignServerImpl_v300::convert_string_dictionaries_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    StringDictionaryMap dictionaries;

    bool need_update = false;
    Generics::Time timestamp = request_timestamp;
    for(CORBA::ULong i = 0;
        i < update_info.web_operations.length(); ++i)
    {
      const AdServer::CampaignSvcs_v310::WebOperationInfo& info =
        update_info.web_operations[i];
      dictionaries[StringDictionaries::WEB_APPLICATION].insert(info.app.in());
      dictionaries[StringDictionaries::WEB_APPLICATION_SOURCE].insert(
        info.source.in());
      dictionaries[StringDictionaries::WEB_APPLICATION_OPERATION].insert(
        info.operation.in());
      Generics::Time info_timestamp = CorbaAlgs::unpack_time(info.timestamp);
      if(info_timestamp > request_timestamp)
      {
        timestamp = std::max(timestamp, info_timestamp);
        need_update = true;
      }
    }
    if(need_update)
    {
      result_update_info.string_dictionaries.length(dictionaries.size());
      CORBA::ULong res_i = 0;
      for(StringDictionaryMap::const_iterator it = dictionaries.begin();
          it != dictionaries.end(); ++it, ++res_i)
      {
        AdServer::CampaignSvcs_v291::StringDictionaryInfo& result_info =
          result_update_info.string_dictionaries[res_i];
        result_info.name << it->first;
        CorbaAlgs::fill_sequence(
          it->second.begin(), it->second.end(), result_info.values);
        result_info.timestamp = CorbaAlgs::pack_time(timestamp);
      }
    }
  }

  void
  CampaignServerImpl_v300::convert_app_formats_(
    AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v310::AppFormatInfo& info =
        update_info.app_formats[i];
      if(CorbaAlgs::unpack_time(info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v291::AppFormatInfo& result_info =
