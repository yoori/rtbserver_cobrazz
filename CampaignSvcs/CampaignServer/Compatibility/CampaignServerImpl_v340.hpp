#ifndef CAMPAIGNSVCS_CAMPAIGNSERVER_CAMPAIGNSERVERIMPL_V340_HPP
#define CAMPAIGNSVCS_CAMPAIGNSERVER_CAMPAIGNSERVERIMPL_V340_HPP
...
namespace AdServer
{
  ...
  {
    class CampaignServerImpl_v340:
      public virtual CORBACommons::ReferenceCounting::
        ServantImpl<POA_AdServer::CampaignSvcs_v340::CampaignServer>
    {
    public:
    ...
    public:
      ...
      need_config(const AdServer::CampaignSvcs_v340::TimestampInfo& master_stamp);

      virtual AdServer::CampaignSvcs_v340::CampaignConfigUpdateInfo*
      get_config(
        const AdServer::CampaignSvcs_v340::CampaignGetConfigSettings& settings);

      virtual AdServer::CampaignSvcs_v340::EcpmSeq*
      get_ecpms(
        const AdServer::CampaignSvcs_v340::TimestampInfo& request_timestamp);

      virtual AdServer::CampaignSvcs_v340::BriefSimpleChannelAnswer*
      brief_simple_channels(
        const AdServer::CampaignSvcs_v340::CampaignServer::
          GetSimpleChannelsInfo& settings);

      virtual AdServer::CampaignSvcs_v340::SimpleChannelAnswer*
      simple_channels(
      ...
      detectors(const AdServer::CampaignSvcs_v340::TimestampInfo& request_timestamp);
    ...
    protected:
      virtual
      ~CampaignServerImpl_v340() noexcept;

      typedef PortableServer::Servant_var<
        POA_AdServer::CampaignSvcs_v350::CampaignServer>
        CampaignServer_var;
    ...
    typedef ReferenceCounting::SmartPtr<CampaignServerImpl_v340>
      CampaignServerImpl_v340_var;
  }
}

#endif // CAMPAIGNSVCS_CAMPAIGNSERVER_CAMPAIGNSERVERIMPL_V340_HPP
