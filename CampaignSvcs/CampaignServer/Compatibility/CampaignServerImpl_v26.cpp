...
#include "CampaignServerImpl_v26.hpp"

namespace
{
  void
  copy_price_range_seq(
    AdServer::CampaignSvcs_v26::PriceRangeSeq& tgt,
    const AdServer::CampaignSvcs_v27::PriceRangeSeq& src)
    noexcept
  {
  ...
  void
  copy_channel_expr(
    AdServer::CampaignSvcs_v26::ExpressionInfo& result_expr,
    const AdServer::CampaignSvcs_v27::ExpressionInfo& expr)
  {
  ...
  void copy_channel(
    AdServer::CampaignSvcs_v26::ExpressionChannelInfo& result_channel_info,
    const AdServer::CampaignSvcs_v27::ExpressionChannelInfo& channel_info)
  {
  ...
  copy_simple_channels(
    const AdServer::CampaignSvcs_v27::SimpleChannelKeySeq& simple_channel_seq,
    AdServer::CampaignSvcs_v26::SimpleChannelKeySeq& result_simple_channel_seq,
    const Generics::Time& request_timestamp)
  {
    ...
    for(CORBA::ULong i = 0; i < simple_channel_seq.length(); ++i)
    {
      ...
      if(CorbaAlgs::unpack_time(simple_channel_info.timestamp) > request_timestamp)
      {
        ...
        // 2.7 => 2.6 : union page & search triggers into keyword_triggers
        result_simple_channel_info.keyword_triggers.length(
          simple_channel_info.page_triggers.length() +
          simple_channel_info.search_triggers.length());
        CORBA::ULong* end = Algs::merge_unique(
          simple_channel_info.page_triggers.get_buffer(),
          simple_channel_info.page_triggers.get_buffer() +
            simple_channel_info.page_triggers.length(),
          simple_channel_info.search_triggers.get_buffer(),
          simple_channel_info.search_triggers.get_buffer() +
            simple_channel_info.search_triggers.length(),
          &result_simple_channel_info.keyword_triggers[0],
          std::less<CORBA::ULong>(),
          Algs::FirstArg());
        result_simple_channel_info.keyword_triggers.length(
          end - &result_simple_channel_info.keyword_triggers[0]);
  ...
  void convert_bp_seq(
    AdServer::CampaignSvcs_v26::BehavParameterSeq& result,
    const AdServer::CampaignSvcs_v27::BehavParameterSeq& src)
  {
    result.length(src.length());
    
    for(CORBA::ULong bp_el_i = 0; bp_el_i < src.length(); ++bp_el_i)
    {
      const AdServer::CampaignSvcs_v27::BehavParameter& bp_el = src[bp_el_i];
      AdServer::CampaignSvcs_v26::BehavParameter& result_bp_el = result[bp_el_i];
...
namespace CampaignSvcs
{
  ...
  CampaignServerImpl_v26::CampaignServerImpl_v26(
  ...
  CampaignServerImpl_v26::~CampaignServerImpl_v26() noexcept
  {}

  void
  CampaignServerImpl_v26::convert_config_(
  ...
  void
  CampaignServerImpl_v26::convert_get_config_settings_(
  ...
  AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo*
  CampaignServerImpl_v26::get_config(
    const AdServer::CampaignSvcs_v26::CampaignGetConfigSettings& settings)
    /*throw(AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v26::CampaignServer::NotReady)*/
  {
    static const char* FUN = "CampaignServerImpl_v26::get_config()";

    try
    {
      AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo_var campaign_config;
      AdServer::CampaignSvcs_v27::CampaignGetConfigSettings conv_settings;

      convert_get_config_settings_(settings, conv_settings);

      campaign_config = campaign_server_->get_config(conv_settings);

      AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo_var result_campaign_config =
        new AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo();
    ...
    catch(const AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException& ex)
    {
      Stream::Error ostr;
      ostr << FUN << ": AdServer::CampaignSvcs_v27::CampaignServer::"
        "ImplementationException caught: " <<
        ex.description;

      CORBACommons::throw_desc<
        CampaignSvcs_v26::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v27::CampaignServer::NotReady& ex)
    {
      throw AdServer::CampaignSvcs_v26::CampaignServer::NotReady(ex.description);
    }
  ...
  AdServer::CampaignSvcs_v26::EcpmSeq*
  CampaignServerImpl_v26::get_ecpms(
    const AdServer::CampaignSvcs_v26::TimestampInfo& request_timestamp)
    /*throw(AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v26::get_ecpms()";
      
    try
    {
      AdServer::CampaignSvcs_v27::EcpmSeq_var ecpms  =
        campaign_server_->get_ecpms(request_timestamp);
      AdServer::CampaignSvcs_v26::EcpmSeq_var result_ecpms =
        new AdServer::CampaignSvcs_v26::EcpmSeq();
    ...
    catch(const AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException& e)
    {
      Stream::Error ostr;
      ostr << FUN << ": CampaignSvcs_v27::CampaignServer::"
        "ImplementationException caught: " << e.description;
      CORBACommons::throw_desc<
        CampaignSvcs_v26::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v27::CampaignServer::NotReady& )
    {
      throw AdServer::CampaignSvcs_v26::CampaignServer::NotReady();
    }
    return 0; // never reach
  }

  AdServer::CampaignSvcs_v26::SimpleChannelAnswer*
  CampaignServerImpl_v26::simple_channels(
    const AdServer::CampaignSvcs_v26::CampaignServer::GetSimpleChannelsInfo& /*settings*/)
    /*throw(AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v26::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException(
      "CampaignServerImpl_v26::simple_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v26::ExpressionChannelsInfo*
  CampaignServerImpl_v26::get_expression_channels(
    const AdServer::CampaignSvcs_v26::CampaignServer::GetExpressionChannelsInfo&)
    /*throw(AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v26::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException(
      "CampaignServerImpl_v26::get_expression_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v26::DetectorsConfig*
  CampaignServerImpl_v26::detectors(
    const AdServer::CampaignSvcs_v26::TimestampInfo& /*request_timestamp*/)
    /*throw(AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v26::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException(
      "CampaignServerImpl_v26::search_engines(): Not supported.");
  }

  AdServer::CampaignSvcs_v26::FreqCapConfigInfo*
  CampaignServerImpl_v26::freq_caps()
    /*throw(AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v26::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException(
      "CampaignServerImpl_v26::freq_caps(): Not supported.");
  }

  AdServer::CampaignSvcs_v26::StatInfo*
  CampaignServerImpl_v26::get_stat() /*throw(
    AdServer::CampaignSvcs_v26::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v26::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v26::CampaignServer::NotSupport(
      "CampaignServerImpl_v26::get_stat(): Not supported.");
  }

  void
  CampaignServerImpl_v26::update_stat() /*throw(
    AdServer::CampaignSvcs_v26::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException)*/
  {
    throw AdServer::CampaignSvcs_v26::CampaignServer::NotSupport(
      "CampaignServerImpl_v26::update_stat(): Not supported.");
  }

  CORBA::Boolean
  CampaignServerImpl_v26::need_config(
    const CORBACommons::TimestampInfo& master_stamp)
    /*throw(AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v26::need_config()";

    try
    {
      return campaign_server_->need_config(master_stamp);
    }
    catch(const AdServer::CampaignSvcs_v26::
  ...
  CampaignServerImpl_v26::get_discover_channels(
    CORBA::ULong, CORBA::ULong)
    /*throw(AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v26::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException(
      "CampaignServerImpl_v26::get_discover_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v26::CampaignServer::PassbackInfo*
  CampaignServerImpl_v26::get_tag_passback(CORBA::ULong)
    /*throw(AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v26::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException(
      "CampaignServerImpl_v26::get_tag_passback(): Not supported.");
  }

  AdServer::CampaignSvcs_v26::FraudConditionConfig*
  CampaignServerImpl_v26::fraud_conditions()
    /*throw(AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v26::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v26::CampaignServer::ImplementationException(
      "CampaignServerImpl_v26::fraud_conditions(): Not supported.");
  }

  void
  CampaignServerImpl_v26::convert_campaigns_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    const
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::CampaignInfo& campaign_info =
        update_info.campaigns[i];

      if(CorbaAlgs::unpack_time(campaign_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::CampaignInfo& result_campaign_info =
        ...
        {
          const AdServer::CampaignSvcs_v27::CreativeInfo& creative_info =
            campaign_info.creatives[j];

          AdServer::CampaignSvcs_v26::CreativeInfo& result_creative_info =
  ...
  void
  CampaignServerImpl_v26::convert_accounts_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::AccountInfo& account_info =
        update_info.accounts[i];

      if(CorbaAlgs::unpack_time(account_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::AccountInfo& result_account_info =
  ...
  void
  CampaignServerImpl_v26::convert_creative_options_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::CreativeOptionInfo& option_info =
        update_info.activate_creative_options[i];

      if(CorbaAlgs::unpack_time(option_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::CreativeOptionInfo& result_option_info =
  ...
  void
  CampaignServerImpl_v26::convert_expression_channels_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v26::convert_geo_channels_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::GeoChannelInfo& channel_info =
        update_info.activate_geo_channels[ch_i];

      if(CorbaAlgs::unpack_time(channel_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::GeoChannelInfo& result_channel_info =
  ...
  void
  CampaignServerImpl_v26::convert_ecpm_seq_(
    ...
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::CampaignEcpmInfo& ecpm_info = ecpms[i];

      if(CorbaAlgs::unpack_time(ecpm_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::CampaignEcpmInfo& res_ecpm_info = result_ecpms[res_i++];
  ...
  void
  CampaignServerImpl_v26::convert_ecpms_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v26::convert_sites_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::SiteInfo& site_info = update_info.sites[i];

      if(CorbaAlgs::unpack_time(site_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::SiteInfo& result_site_info =
  ...
  void
  CampaignServerImpl_v26::convert_tags_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::TagInfo& tag_info =
        update_info.tags[tag_i];

      if(CorbaAlgs::unpack_time(tag_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::TagInfo& result_tag_info =
        ...
        {
          const AdServer::CampaignSvcs_v27::TagPricingInfo& tag_pricing_info =
            tag_info.tag_pricings[j];
          AdServer::CampaignSvcs_v26::TagPricingInfo& result_tag_pricing_info =
  ...
  void
  CampaignServerImpl_v26::convert_frequency_caps_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::FreqCapInfo& freq_cap =
        update_info.frequency_caps[i];

      if(CorbaAlgs::unpack_time(freq_cap.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::FreqCapInfo& result_freq_cap =
  ...
  void
  CampaignServerImpl_v26::convert_simple_channels_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v26::convert_behav_params_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    {
      ...
      {
        const AdServer::CampaignSvcs_v27::BehavParamInfo& bp =
          update_info.behav_params[i];

        if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
        {
          AdServer::CampaignSvcs_v26::BehavParamInfo& result_bp =
    ...
    {
      const AdServer::CampaignSvcs_v27::KeyBehavParamInfo& bp =
        update_info.key_behav_params[i];
      if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::KeyBehavParamInfo& result_bp =
  ...
  void
  CampaignServerImpl_v26::convert_colocations_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::ColocationInfo& colo_info =
        update_info.colocations[i];
      if(CorbaAlgs::unpack_time(colo_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::ColocationInfo& result_colo_info =
  ...
  void
  CampaignServerImpl_v26::convert_creative_templates_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::CreativeTemplateInfo& cr_templ_info =
        update_info.creative_templates[i];
      if(CorbaAlgs::unpack_time(cr_templ_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::CreativeTemplateInfo& result_cr_templ_info =
        ...
        {
          const AdServer::CampaignSvcs_v27::CreativeTemplateFileInfo& ctf_info =
            cr_templ_info.files[ctf_i];
          AdServer::CampaignSvcs_v26::CreativeTemplateFileInfo& result_ctf_info =
          ...
          result_ctf_info.type =
            static_cast<AdServer::CampaignSvcs_v26::CreativeTemplateType>(
              ctf_info.type);
        }
      }
    }
  ...
  void
  CampaignServerImpl_v26::convert_currencies_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::CurrencyInfo& currency_info =
        update_info.currencies[i];

      if(CorbaAlgs::unpack_time(currency_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::CurrencyInfo& result_currency_info =
  ...
  void
  CampaignServerImpl_v26::convert_campaign_keywords_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::CampaignKeywordInfo& keyword_info =
        update_info.campaign_keywords[i];

      if(CorbaAlgs::unpack_time(keyword_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::CampaignKeywordInfo& res_keyword_info =
  ...
  void
  CampaignServerImpl_v26::convert_creative_categories_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::CreativeCategoryInfo& category_info =
        update_info.creative_categories[i];
      if(CorbaAlgs::unpack_time(category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::CreativeCategoryInfo& res_category_info =
  ...
  void
  CampaignServerImpl_v26::convert_adv_actions_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v26::convert_keyword_ecpms_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v26::convert_category_channels_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::CategoryChannelInfo& channel_category_info =
        update_info.category_channels[cat_i];
      if(CorbaAlgs::unpack_time(channel_category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::CategoryChannelInfo& result_channel_category_info =
  ...
  void
  CampaignServerImpl_v26::convert_margin_rules_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::MarginRuleInfo& margin_rule_info =
        update_info.margin_rules[m_i];
      if(CorbaAlgs::unpack_time(margin_rule_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::MarginRuleInfo& result_margin_rule_info =
  ...
  void
  CampaignServerImpl_v26::convert_search_engines_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::SearchEngineInfo& s_info =
        update_info.search_engines[i];
      if(CorbaAlgs::unpack_time(s_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::SearchEngineInfo& result_s_info =
  ...
  void
  CampaignServerImpl_v26::convert_web_browsers_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::WebBrowserInfo& b_info =
        update_info.web_browsers[i];
      if(CorbaAlgs::unpack_time(b_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::WebBrowserInfo& result_b_info =
        ...
        {
          const AdServer::CampaignSvcs_v27::WebBrowserDetectorInfo& d_info =
            b_info.detectors[j];
          AdServer::CampaignSvcs_v26::WebBrowserDetectorInfo& result_d_info =
  ...
  void
  CampaignServerImpl_v26::convert_platforms_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::PlatformInfo& p_info =
        update_info.platforms[i];
      if(CorbaAlgs::unpack_time(p_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::PlatformInfo& result_p_info =
        ...
        {
          const AdServer::CampaignSvcs_v27::PlatformDetectorInfo& pd_info =
            p_info.detectors[j];
          AdServer::CampaignSvcs_v26::PlatformDetectorInfo& result_pd_info =
  ...
  void
  CampaignServerImpl_v26::convert_fraud_conditions_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::FraudConditionInfo& fraud_cond_info =
        update_info.fraud_conditions[i];
      if(CorbaAlgs::unpack_time(fraud_cond_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::FraudConditionInfo& result_fraud_cond_info =
  ...
  void
  CampaignServerImpl_v26::convert_string_dictionaries_(
    AdServer::CampaignSvcs_v26::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v27::StringDictionaryInfo& info =
        update_info.string_dictionaries[i];
      if(CorbaAlgs::unpack_time(info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v26::StringDictionaryInfo& result_info =
