...
#include "CampaignServerImpl_v310.hpp"

namespace
{
  void
  copy_price_range_seq(
    AdServer::CampaignSvcs_v310::PriceRangeSeq& tgt,
    const AdServer::CampaignSvcs_v320::PriceRangeSeq& src)
    noexcept
  {
  ...
  void
  copy_channel_expr(
    AdServer::CampaignSvcs_v310::ExpressionInfo& result_expr,
    const AdServer::CampaignSvcs_v320::ExpressionInfo& expr)
  {
  ...
  void copy_channel(
    AdServer::CampaignSvcs_v310::ExpressionChannelInfo& result_channel_info,
    const AdServer::CampaignSvcs_v320::ExpressionChannelInfo& channel_info)
  {
  ...
  copy_simple_channels(
    const AdServer::CampaignSvcs_v320::SimpleChannelKeySeq& simple_channel_seq,
    AdServer::CampaignSvcs_v310::SimpleChannelKeySeq& result_simple_channel_seq,
    const Generics::Time& request_timestamp)
  {
  ...
  void convert_bp_seq(
    AdServer::CampaignSvcs_v310::BehavParameterSeq& result,
    const AdServer::CampaignSvcs_v320::BehavParameterSeq& src)
  {
    result.length(src.length());
    
    for(CORBA::ULong bp_el_i = 0; bp_el_i < src.length(); ++bp_el_i)
    {
      const AdServer::CampaignSvcs_v320::BehavParameter& bp_el = src[bp_el_i];
      AdServer::CampaignSvcs_v310::BehavParameter& result_bp_el = result[bp_el_i];
...
namespace CampaignSvcs
{
  ...
  CampaignServerImpl_v310::CampaignServerImpl_v310(
    Logging::Logger* logger,
    POA_AdServer::CampaignSvcs_v320::CampaignServer* campaign_server)
  ...
  CampaignServerImpl_v310::~CampaignServerImpl_v310() noexcept
  {}

  void
  CampaignServerImpl_v310::convert_config_(
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const Generics::Time& request_timestamp)
  ...
  void
  CampaignServerImpl_v310::convert_get_config_settings_(
    const AdServer::CampaignSvcs_v310::CampaignGetConfigSettings& settings,
    AdServer::CampaignSvcs_v320::CampaignGetConfigSettings& result_settings)
    /*throw(Exception, eh::Exception)*/
  {
  ...
  AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo*
  CampaignServerImpl_v310::get_config(
    const AdServer::CampaignSvcs_v310::CampaignGetConfigSettings& settings)
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v310::CampaignServer::NotReady)*/
  {
    static const char* FUN = "CampaignServerImpl_v310::get_config()";

    try
    {
      AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo_var campaign_config;
      AdServer::CampaignSvcs_v320::CampaignGetConfigSettings conv_settings;

      convert_get_config_settings_(settings, conv_settings);

      campaign_config = campaign_server_->get_config(conv_settings);

      AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo_var result_campaign_config =
        new AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo();
    ...
    catch(const AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException& ex)
    {
      Stream::Error ostr;
      ostr << FUN << ": AdServer::CampaignSvcs_v320::CampaignServer::"
        "ImplementationException caught: " <<
        ex.description;

      CORBACommons::throw_desc<
        CampaignSvcs_v310::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v320::CampaignServer::NotReady& ex)
    {
      throw AdServer::CampaignSvcs_v310::CampaignServer::NotReady(ex.description);
    }
  ...
  AdServer::CampaignSvcs_v310::EcpmSeq*
  CampaignServerImpl_v310::get_ecpms(
    const AdServer::CampaignSvcs_v310::TimestampInfo& request_timestamp)
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v310::get_ecpms()";
      
    try
    {
      AdServer::CampaignSvcs_v320::EcpmSeq_var ecpms  =
        campaign_server_->get_ecpms(request_timestamp);
      AdServer::CampaignSvcs_v310::EcpmSeq_var result_ecpms =
        new AdServer::CampaignSvcs_v310::EcpmSeq();
    ...
    catch(const AdServer::CampaignSvcs_v320::CampaignServer::ImplementationException& e)
    {
      Stream::Error ostr;
      ostr << FUN << ": CampaignSvcs_v320::CampaignServer::"
        "ImplementationException caught: " << e.description;
      CORBACommons::throw_desc<
        CampaignSvcs_v310::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v320::CampaignServer::NotReady& )
    {
      throw AdServer::CampaignSvcs_v310::CampaignServer::NotReady();
    }
    return 0; // never reach
  }

  AdServer::CampaignSvcs_v310::BriefSimpleChannelAnswer*
  CampaignServerImpl_v310::brief_simple_channels(
    const AdServer::CampaignSvcs_v310::CampaignServer::
    GetSimpleChannelsInfo& /*settings*/)
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v310::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException(
      "CampaignServerImpl_v310::brief_simple_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v310::SimpleChannelAnswer*
  CampaignServerImpl_v310::simple_channels(
    const AdServer::CampaignSvcs_v310::CampaignServer::GetSimpleChannelsInfo& /*settings*/)
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v310::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException(
      "CampaignServerImpl_v310::simple_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v310::ExpressionChannelsInfo*
  CampaignServerImpl_v310::get_expression_channels(
    const AdServer::CampaignSvcs_v310::CampaignServer::GetExpressionChannelsInfo&)
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v310::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException(
      "CampaignServerImpl_v310::get_expression_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v310::DetectorsConfig*
  CampaignServerImpl_v310::detectors(
    const AdServer::CampaignSvcs_v310::TimestampInfo& /*request_timestamp*/)
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v310::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException(
      "CampaignServerImpl_v310::search_engines(): Not supported.");
  }

  AdServer::CampaignSvcs_v310::FreqCapConfigInfo*
  CampaignServerImpl_v310::freq_caps()
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v310::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException(
      "CampaignServerImpl_v310::freq_caps(): Not supported.");
  }

  AdServer::CampaignSvcs_v310::StatInfo*
  CampaignServerImpl_v310::get_stat() /*throw(
    AdServer::CampaignSvcs_v310::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v310::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v310::CampaignServer::NotSupport(
      "CampaignServerImpl_v310::get_stat(): Not supported.");
  }

  void
  CampaignServerImpl_v310::update_stat() /*throw(
    AdServer::CampaignSvcs_v310::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException)*/
  {
    throw AdServer::CampaignSvcs_v310::CampaignServer::NotSupport(
      "CampaignServerImpl_v310::update_stat(): Not supported.");
  }

  CORBA::Boolean
  CampaignServerImpl_v310::need_config(
    const CORBACommons::TimestampInfo& master_stamp)
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v310::need_config()";

    try
    {
      return campaign_server_->need_config(master_stamp);
    }
    catch(const AdServer::CampaignSvcs_v310::
  ...
  AdServer::CampaignSvcs_v310::DiscoverSourceInfo*
  CampaignServerImpl_v310::get_discover_channels(
    CORBA::ULong, CORBA::ULong)
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v310::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException(
      "CampaignServerImpl_v310::get_discover_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v310::CampaignServer::PassbackInfo*
  CampaignServerImpl_v310::get_tag_passback(CORBA::ULong, const char*)
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v310::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException(
      "CampaignServerImpl_v310::get_tag_passback(): Not supported.");
  }

  AdServer::CampaignSvcs_v310::FraudConditionConfig*
  CampaignServerImpl_v310::fraud_conditions()
    /*throw(AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v310::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v310::CampaignServer::ImplementationException(
      "CampaignServerImpl_v310::fraud_conditions(): Not supported.");
  }

  void
  CampaignServerImpl_v310::convert_campaigns_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    const
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::CampaignInfo& campaign_info =
        update_info.campaigns[i];

      if(CorbaAlgs::unpack_time(campaign_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::CampaignInfo& result_campaign_info =
        ...
        {
          const AdServer::CampaignSvcs_v320::CreativeInfo& creative_info =
            campaign_info.creatives[j];

          AdServer::CampaignSvcs_v310::CreativeInfo& result_creative_info =
  ...
  void
  CampaignServerImpl_v310::convert_accounts_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::AccountInfo& account_info =
        update_info.accounts[i];

      if(CorbaAlgs::unpack_time(account_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::AccountInfo& result_account_info =
  ...
  void
  CampaignServerImpl_v310::convert_creative_options_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::CreativeOptionInfo& option_info =
        update_info.activate_creative_options[i];

      if(CorbaAlgs::unpack_time(option_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::CreativeOptionInfo& result_option_info =
  ...
  void
  CampaignServerImpl_v310::convert_expression_channels_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v310::convert_geo_channels_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::GeoChannelInfo& channel_info =
        update_info.activate_geo_channels[ch_i];

      if(CorbaAlgs::unpack_time(channel_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::GeoChannelInfo& result_channel_info =
  ...
  void
  CampaignServerImpl_v310::convert_ecpm_seq_(
    AdServer::CampaignSvcs_v310::EcpmSeq& result_ecpms,
    const AdServer::CampaignSvcs_v320::EcpmSeq& ecpms,
    const Generics::Time& request_timestamp)
    noexcept
  {
    /* fill ecpms */
    ...
    {
      const AdServer::CampaignSvcs_v320::CampaignEcpmInfo& ecpm_info = ecpms[i];

      if(CorbaAlgs::unpack_time(ecpm_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::CampaignEcpmInfo& res_ecpm_info = result_ecpms[res_i++];
  ...
  void
  CampaignServerImpl_v310::convert_ecpms_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v310::convert_sites_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::SiteInfo& site_info = update_info.sites[i];

      if(CorbaAlgs::unpack_time(site_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::SiteInfo& result_site_info =
  ...
  void
  CampaignServerImpl_v310::convert_tags_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::TagInfo& tag_info =
        update_info.tags[tag_i];

      if(CorbaAlgs::unpack_time(tag_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::TagInfo& result_tag_info =
        ...
        {
          const AdServer::CampaignSvcs_v320::TagPricingInfo& tag_pricing_info =
            tag_info.tag_pricings[j];
          AdServer::CampaignSvcs_v310::TagPricingInfo& result_tag_pricing_info =
  ...
  void
  CampaignServerImpl_v310::convert_frequency_caps_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::FreqCapInfo& freq_cap =
        update_info.frequency_caps[i];

      if(CorbaAlgs::unpack_time(freq_cap.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::FreqCapInfo& result_freq_cap =
  ...
  void
  CampaignServerImpl_v310::convert_simple_channels_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v310::convert_behav_params_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    {
      ...
      {
        const AdServer::CampaignSvcs_v320::BehavParamInfo& bp =
          update_info.behav_params[i];

        if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
        {
          AdServer::CampaignSvcs_v310::BehavParamInfo& result_bp =
    ...
    {
      const AdServer::CampaignSvcs_v320::KeyBehavParamInfo& bp =
        update_info.key_behav_params[i];
      if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::KeyBehavParamInfo& result_bp =
  ...
  void
  CampaignServerImpl_v310::convert_colocations_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::ColocationInfo& colo_info =
        update_info.colocations[i];
      if(CorbaAlgs::unpack_time(colo_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::ColocationInfo& result_colo_info =
  ...
  void
  CampaignServerImpl_v310::convert_creative_templates_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::CreativeTemplateInfo& cr_templ_info =
        update_info.creative_templates[i];
      if(CorbaAlgs::unpack_time(cr_templ_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::CreativeTemplateInfo& result_cr_templ_info =
        ...
        {
          const AdServer::CampaignSvcs_v320::CreativeTemplateFileInfo& ctf_info =
            cr_templ_info.files[ctf_i];
          AdServer::CampaignSvcs_v310::CreativeTemplateFileInfo& result_ctf_info =
          ...
          result_ctf_info.type =
            static_cast<AdServer::CampaignSvcs_v310::CreativeTemplateType>(
              ctf_info.type);
        }
  ...
  void
  CampaignServerImpl_v310::convert_currencies_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::CurrencyInfo& currency_info =
        update_info.currencies[i];

      if(CorbaAlgs::unpack_time(currency_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::CurrencyInfo& result_currency_info =
  ...
  void
  CampaignServerImpl_v310::convert_campaign_keywords_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::CampaignKeywordInfo& keyword_info =
        update_info.campaign_keywords[i];

      if(CorbaAlgs::unpack_time(keyword_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::CampaignKeywordInfo& res_keyword_info =
  ...
  void
  CampaignServerImpl_v310::convert_creative_categories_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::CreativeCategoryInfo& category_info =
        update_info.creative_categories[i];
      if(CorbaAlgs::unpack_time(category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::CreativeCategoryInfo& res_category_info =
  ...
  void
  CampaignServerImpl_v310::convert_adv_actions_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v310::convert_category_channels_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::CategoryChannelInfo& channel_category_info =
        update_info.category_channels[cat_i];
      if(CorbaAlgs::unpack_time(channel_category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::CategoryChannelInfo& result_channel_category_info =
  ...
  void
  CampaignServerImpl_v310::convert_search_engines_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::SearchEngineInfo& s_info =
        update_info.search_engines[i];
      if(CorbaAlgs::unpack_time(s_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::SearchEngineInfo& result_s_info =
  ...
  void
  CampaignServerImpl_v310::convert_web_browsers_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::WebBrowserInfo& b_info =
        update_info.web_browsers[i];
      if(CorbaAlgs::unpack_time(b_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::WebBrowserInfo& result_b_info =
        ...
        {
          const AdServer::CampaignSvcs_v320::WebBrowserDetectorInfo& d_info =
            b_info.detectors[j];
          AdServer::CampaignSvcs_v310::WebBrowserDetectorInfo& result_d_info =
  ...
  void
  CampaignServerImpl_v310::convert_platforms_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::PlatformInfo& p_info =
        update_info.platforms[i];
      if(CorbaAlgs::unpack_time(p_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::PlatformInfo& result_p_info =
        ...
        {
          const AdServer::CampaignSvcs_v320::PlatformDetectorInfo& pd_info =
            p_info.detectors[j];
          AdServer::CampaignSvcs_v310::PlatformDetectorInfo& result_pd_info =
  ...
  void
  CampaignServerImpl_v310::convert_fraud_conditions_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::FraudConditionInfo& fraud_cond_info =
        update_info.fraud_conditions[i];
      if(CorbaAlgs::unpack_time(fraud_cond_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::FraudConditionInfo& result_fraud_cond_info =
  ...
  void
  CampaignServerImpl_v310::convert_string_dictionaries_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::WebOperationInfo& info =
        update_info.web_operations[i];
      if(CorbaAlgs::unpack_time(info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::WebOperationInfo& result_info =
  ...
  void
  CampaignServerImpl_v310::convert_app_formats_(
    AdServer::CampaignSvcs_v310::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v320::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v320::AppFormatInfo& info =
        update_info.app_formats[i];
      if(CorbaAlgs::unpack_time(info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v310::AppFormatInfo& result_info =
