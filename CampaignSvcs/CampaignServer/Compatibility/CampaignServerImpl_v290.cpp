...
#include "CampaignServerImpl_v290.hpp"

namespace
{
  void
  copy_price_range_seq(
    AdServer::CampaignSvcs_v290::PriceRangeSeq& tgt,
    const AdServer::CampaignSvcs_v291::PriceRangeSeq& src)
    noexcept
  {
  ...
  void
  copy_channel_expr(
    AdServer::CampaignSvcs_v290::ExpressionInfo& result_expr,
    const AdServer::CampaignSvcs_v291::ExpressionInfo& expr)
  {
  ...
  void copy_channel(
    AdServer::CampaignSvcs_v290::ExpressionChannelInfo& result_channel_info,
    const AdServer::CampaignSvcs_v291::ExpressionChannelInfo& channel_info)
  {
  ...
  copy_simple_channels(
    const AdServer::CampaignSvcs_v291::SimpleChannelKeySeq& simple_channel_seq,
    AdServer::CampaignSvcs_v290::SimpleChannelKeySeq& result_simple_channel_seq,
    const Generics::Time& request_timestamp)
  {
  ...
  void convert_bp_seq(
    AdServer::CampaignSvcs_v290::BehavParameterSeq& result,
    const AdServer::CampaignSvcs_v291::BehavParameterSeq& src)
  {
    result.length(src.length());
    
    for(CORBA::ULong bp_el_i = 0; bp_el_i < src.length(); ++bp_el_i)
    {
      const AdServer::CampaignSvcs_v291::BehavParameter& bp_el = src[bp_el_i];
      AdServer::CampaignSvcs_v290::BehavParameter& result_bp_el = result[bp_el_i];
...
namespace CampaignSvcs
{
  ...
  CampaignServerImpl_v290::CampaignServerImpl_v290(
    Logging::Logger* logger,
    POA_AdServer::CampaignSvcs_v291::CampaignServer* campaign_server)
  ...
  CampaignServerImpl_v290::~CampaignServerImpl_v290() noexcept
  {}

  void
  CampaignServerImpl_v290::convert_config_(
    ...
    /*throw(Exception, eh::Exception)*/
  {
    ...
    convert_currencies_(result_update_info, currencies, update_info, request_timestamp);

    convert_accounts_(result_update_info, accounts, update_info, request_timestamp);

    convert_creative_options_(result_update_info, update_info, request_timestamp);

    convert_campaigns_(result_update_info, ccgs, random_mode_ccgs, update_info, request_timestamp);

    convert_expression_channels_(result_update_info, update_info, request_timestamp);

    convert_ecpms_(result_update_info,
      update_info,
      currencies,
      accounts,
      ccgs,
  ...
  void
  CampaignServerImpl_v290::convert_get_config_settings_(
    const AdServer::CampaignSvcs_v290::CampaignGetConfigSettings& settings,
    AdServer::CampaignSvcs_v291::CampaignGetConfigSettings& result_settings)
    /*throw(Exception, eh::Exception)*/
  {
  ...
  AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo*
  CampaignServerImpl_v290::get_config(
    const AdServer::CampaignSvcs_v290::CampaignGetConfigSettings& settings)
    /*throw(AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v290::CampaignServer::NotReady)*/
  {
    static const char* FUN = "CampaignServerImpl_v290::get_config()";

    try
    {
      AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo_var campaign_config;
      AdServer::CampaignSvcs_v291::CampaignGetConfigSettings conv_settings;

      convert_get_config_settings_(settings, conv_settings);

      campaign_config = campaign_server_->get_config(conv_settings);

      AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo_var result_campaign_config =
        new AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo();
    ...
    catch(const AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException& ex)
    {
      Stream::Error ostr;
      ostr << FUN << ": AdServer::CampaignSvcs_v291::CampaignServer::"
        "ImplementationException caught: " <<
        ex.description;

      CORBACommons::throw_desc<
        CampaignSvcs_v290::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v291::CampaignServer::NotReady& ex)
    {
      throw AdServer::CampaignSvcs_v290::CampaignServer::NotReady(ex.description);
    }
  ...
  AdServer::CampaignSvcs_v290::EcpmSeq*
  CampaignServerImpl_v290::get_ecpms(
    const AdServer::CampaignSvcs_v290::TimestampInfo& /*request_timestamp*/)
    /*throw(AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v290::get_ecpms()";
      
    try
    {
      AdServer::CampaignSvcs_v290::EcpmSeq_var result_ecpms =
        new AdServer::CampaignSvcs_v290::EcpmSeq();
    ...
    catch(const AdServer::CampaignSvcs_v291::CampaignServer::ImplementationException& e)
    {
      Stream::Error ostr;
      ostr << FUN << ": CampaignSvcs_v291::CampaignServer::"
        "ImplementationException caught: " << e.description;
      CORBACommons::throw_desc<
        CampaignSvcs_v290::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v291::CampaignServer::NotReady& )
    {
      throw AdServer::CampaignSvcs_v290::CampaignServer::NotReady();
    }
    return 0; // never reach
  }

  AdServer::CampaignSvcs_v290::SimpleChannelAnswer*
  CampaignServerImpl_v290::simple_channels(
    const AdServer::CampaignSvcs_v290::CampaignServer::GetSimpleChannelsInfo& /*settings*/)
    /*throw(AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v290::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException(
      "CampaignServerImpl_v290::simple_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v290::ExpressionChannelsInfo*
  CampaignServerImpl_v290::get_expression_channels(
    const AdServer::CampaignSvcs_v290::CampaignServer::GetExpressionChannelsInfo&)
    /*throw(AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v290::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException(
      "CampaignServerImpl_v290::get_expression_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v290::DetectorsConfig*
  CampaignServerImpl_v290::detectors(
    const AdServer::CampaignSvcs_v290::TimestampInfo& /*request_timestamp*/)
    /*throw(AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v290::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException(
      "CampaignServerImpl_v290::search_engines(): Not supported.");
  }

  AdServer::CampaignSvcs_v290::FreqCapConfigInfo*
  CampaignServerImpl_v290::freq_caps()
    /*throw(AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v290::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException(
      "CampaignServerImpl_v290::freq_caps(): Not supported.");
  }

  AdServer::CampaignSvcs_v290::StatInfo*
  CampaignServerImpl_v290::get_stat() /*throw(
    AdServer::CampaignSvcs_v290::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v290::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v290::CampaignServer::NotSupport(
      "CampaignServerImpl_v290::get_stat(): Not supported.");
  }

  void
  CampaignServerImpl_v290::update_stat() /*throw(
    AdServer::CampaignSvcs_v290::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException)*/
  {
    throw AdServer::CampaignSvcs_v290::CampaignServer::NotSupport(
      "CampaignServerImpl_v290::update_stat(): Not supported.");
  }

  CORBA::Boolean
  CampaignServerImpl_v290::need_config(
    const CORBACommons::TimestampInfo& master_stamp)
    /*throw(AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v290::need_config()";

    try
    {
      return campaign_server_->need_config(master_stamp);
    }
    catch(const AdServer::CampaignSvcs_v290::
  ...
  AdServer::CampaignSvcs_v290::DiscoverSourceInfo*
  CampaignServerImpl_v290::get_discover_channels(
    CORBA::ULong, CORBA::ULong)
    /*throw(AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v290::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException(
      "CampaignServerImpl_v290::get_discover_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v290::CampaignServer::PassbackInfo*
  CampaignServerImpl_v290::get_tag_passback(CORBA::ULong)
    /*throw(AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v290::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException(
      "CampaignServerImpl_v290::get_tag_passback(): Not supported.");
  }

  AdServer::CampaignSvcs_v290::FraudConditionConfig*
  CampaignServerImpl_v290::fraud_conditions()
    /*throw(AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v290::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v290::CampaignServer::ImplementationException(
      "CampaignServerImpl_v290::fraud_conditions(): Not supported.");
  }

  void
  CampaignServerImpl_v290::convert_campaigns_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    CampaignMap& ccgs,
    CampaignMap& random_mode_ccgs,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    ...
    noexcept
  {
    ...
    result_update_info.deleted_campaigns.length(camp_len);

    CORBA::ULong res_i = 0;
    CORBA::ULong del_res_i = 0;
    for (CORBA::ULong i = 0; i < camp_len; ++i)
    {
      const AdServer::CampaignSvcs_v291::CampaignInfo& campaign_info =
        update_info.campaigns[i];

      ccgs.insert(std::make_pair(
        campaign_info.campaign_id, &campaign_info));

      if(campaign_info.mode == 0) // CM_RANDOM
      {
        random_mode_ccgs.insert(std::make_pair(
          campaign_info.campaign_id, &campaign_info));
      }

      if(CorbaAlgs::unpack_time(campaign_info.timestamp) > request_timestamp)
      {
        // campaigns with defined min_uid_age can't be shown in old clusters
        if(CorbaAlgs::unpack_time(campaign_info.min_uid_age) == Generics::Time::ZERO &&
           campaign_info.seq_set_rotate_imps == 0)
        {
          AdServer::CampaignSvcs_v290::CampaignInfo& result_campaign_info =
          ...
          {
            const AdServer::CampaignSvcs_v291::CreativeInfo& creative_info =
              campaign_info.creatives[j];

            AdServer::CampaignSvcs_v290::CreativeInfo& result_creative_info =
        ...
        {
          result_update_info.deleted_campaigns[del_res_i].id =
            campaign_info.campaign_id;
          result_update_info.deleted_campaigns[del_res_i].timestamp =
            campaign_info.timestamp;
          ++del_res_i;
        }
      }
    }
    ...
    result_update_info.deleted_campaigns.length(del_res_i);
  ...
  void
  CampaignServerImpl_v290::convert_accounts_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    AccountMap& accounts,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::AccountInfo& account_info =
        update_info.accounts[i];

      accounts.insert(std::make_pair(account_info.account_id, &account_info));

      if(CorbaAlgs::unpack_time(account_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::AccountInfo& result_account_info =
  ...
  void
  CampaignServerImpl_v290::convert_creative_options_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::CreativeOptionInfo& option_info =
        update_info.activate_creative_options[i];

      if(CorbaAlgs::unpack_time(option_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::CreativeOptionInfo& result_option_info =
  ...
  void
  CampaignServerImpl_v290::convert_expression_channels_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v290::convert_geo_channels_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::GeoChannelInfo& channel_info =
        update_info.activate_geo_channels[ch_i];

      if(CorbaAlgs::unpack_time(channel_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::GeoChannelInfo& result_channel_info =
  ...
  void
  CampaignServerImpl_v290::convert_ecpm_seq_(
    AdServer::CampaignSvcs_v290::EcpmSeq& result_ecpms,
    const AdServer::CampaignSvcs_v291::EcpmSeq& ecpms,
    const CurrencyMap& currencies,
    const AccountMap& accounts,
    const CampaignMap& ccgs,
    const CampaignMap& random_mode_ccgs,
    const Generics::Time& request_timestamp)
    noexcept
  {
    /* fill ecpms */
    ...
    {
      const AdServer::CampaignSvcs_v291::CampaignEcpmInfo& ecpm_info = ecpms[i];

      CampaignMap::const_iterator cmp_it = ccgs.find(ecpm_info.ccg_id);

      if(cmp_it != ccgs.end() &&
         (CorbaAlgs::unpack_time(ecpm_info.timestamp) > request_timestamp ||
          CorbaAlgs::unpack_time(cmp_it->second->timestamp) > request_timestamp))
      {
        AdServer::CampaignSvcs_v290::CampaignEcpmInfo& res_ecpm_info = result_ecpms[res_i++];
        res_ecpm_info.ccg_id = ecpm_info.ccg_id;
        res_ecpm_info.timestamp = CorbaAlgs::pack_time(
          std::max(
            CorbaAlgs::unpack_time(ecpm_info.timestamp),
            CorbaAlgs::unpack_time(cmp_it->second->timestamp)));

        if(random_mode_ccgs.find(ecpm_info.ccg_id) != random_mode_ccgs.end())
        {
          typedef Generics::SimpleDecimal<uint64_t, 18, 8> RevenueDecimal_v300;

          RevenueDecimal_v300 click_revenue =
            CorbaAlgs::unpack_decimal<RevenueDecimal_v300>(cmp_it->second->click_revenue);

          if(click_revenue != RevenueDecimal_v300::ZERO)
          {
            AccountMap::const_iterator acc_it = accounts.find(cmp_it->second->account_id);
            if(acc_it != accounts.end())
            {
              CurrencyMap::const_iterator cur_it = currencies.find(acc_it->second->currency_id);
              if(cur_it != currencies.end())
              {
                res_ecpm_info.ecpm = CorbaAlgs::pack_decimal(
                  RevenueDecimal_v300::div(
                    RevenueDecimal_v300::mul(
                      click_revenue,
                      RevenueDecimal_v300(false, 1000, 0),
                      Generics::DMR_FLOOR),
                    CorbaAlgs::unpack_decimal<RevenueDecimal_v300>(
                      cur_it->second->rate)));
                res_ecpm_info.ctr = CorbaAlgs::pack_decimal(
                  RevenueDecimal_v300(false, 1, 0));
  ...
  void
  CampaignServerImpl_v290::convert_ecpms_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const CurrencyMap& currencies,
    const AccountMap& accounts,
  ...
  void
  CampaignServerImpl_v290::convert_sites_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::SiteInfo& site_info = update_info.sites[i];

      if(CorbaAlgs::unpack_time(site_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::SiteInfo& result_site_info =
  ...
  void
  CampaignServerImpl_v290::convert_tags_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::TagInfo& tag_info =
        update_info.tags[tag_i];

      if(CorbaAlgs::unpack_time(tag_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::TagInfo& result_tag_info =
        ...
        result_tag_info.tokens.length(tag_info.tokens.length());

        for(CORBA::ULong tok_i = 0; tok_i < tag_info.tokens.length(); ++tok_i)
        {
          result_tag_info.tokens[tok_i].option_id = tag_info.tokens[tok_i].option_id;
          result_tag_info.tokens[tok_i].value = tag_info.tokens[tok_i].value;
        }
        ...
        {
          const AdServer::CampaignSvcs_v291::TagPricingInfo& tag_pricing_info =
            tag_info.tag_pricings[j];
          AdServer::CampaignSvcs_v290::TagPricingInfo& result_tag_pricing_info =
  ...
  void
  CampaignServerImpl_v290::convert_frequency_caps_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::FreqCapInfo& freq_cap =
        update_info.frequency_caps[i];

      if(CorbaAlgs::unpack_time(freq_cap.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::FreqCapInfo& result_freq_cap =
  ...
  void
  CampaignServerImpl_v290::convert_simple_channels_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v290::convert_behav_params_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    {
      ...
      {
        const AdServer::CampaignSvcs_v291::BehavParamInfo& bp =
          update_info.behav_params[i];

        if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
        {
          AdServer::CampaignSvcs_v290::BehavParamInfo& result_bp =
    ...
    {
      const AdServer::CampaignSvcs_v291::KeyBehavParamInfo& bp =
        update_info.key_behav_params[i];
      if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::KeyBehavParamInfo& result_bp =
  ...
  void
  CampaignServerImpl_v290::convert_colocations_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::ColocationInfo& colo_info =
        update_info.colocations[i];
      if(CorbaAlgs::unpack_time(colo_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::ColocationInfo& result_colo_info =
  ...
  void
  CampaignServerImpl_v290::convert_creative_templates_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::CreativeTemplateInfo& cr_templ_info =
        update_info.creative_templates[i];
      if(CorbaAlgs::unpack_time(cr_templ_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::CreativeTemplateInfo& result_cr_templ_info =
        ...
        {
          const AdServer::CampaignSvcs_v291::CreativeTemplateFileInfo& ctf_info =
            cr_templ_info.files[ctf_i];
          AdServer::CampaignSvcs_v290::CreativeTemplateFileInfo& result_ctf_info =
          ...
          result_ctf_info.type =
            static_cast<AdServer::CampaignSvcs_v290::CreativeTemplateType>(
              ctf_info.type);
        }

        result_cr_templ_info.tokens.length(cr_templ_info.tokens.length());
        for(CORBA::ULong i = 0; i < cr_templ_info.tokens.length(); ++i)
        {
          result_cr_templ_info.tokens[i].option_id = cr_templ_info.tokens[i].option_id;
          result_cr_templ_info.tokens[i].value = cr_templ_info.tokens[i].value;
        }
      }
    }
  ...
  void
  CampaignServerImpl_v290::convert_currencies_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    CurrencyMap& currencies,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::CurrencyInfo& currency_info =
        update_info.currencies[i];

      currencies.insert(std::make_pair(currency_info.currency_id, &currency_info));

      if(CorbaAlgs::unpack_time(currency_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::CurrencyInfo& result_currency_info =
  ...
  void
  CampaignServerImpl_v290::convert_campaign_keywords_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::CampaignKeywordInfo& keyword_info =
        update_info.campaign_keywords[i];

      if(CorbaAlgs::unpack_time(keyword_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::CampaignKeywordInfo& res_keyword_info =
  ...
  void
  CampaignServerImpl_v290::convert_creative_categories_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::CreativeCategoryInfo& category_info =
        update_info.creative_categories[i];
      if(CorbaAlgs::unpack_time(category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::CreativeCategoryInfo& res_category_info =
  ...
  void
  CampaignServerImpl_v290::convert_adv_actions_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v290::convert_category_channels_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::CategoryChannelInfo& channel_category_info =
        update_info.category_channels[cat_i];
      if(CorbaAlgs::unpack_time(channel_category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::CategoryChannelInfo& result_channel_category_info =
  ...
  void
  CampaignServerImpl_v290::convert_search_engines_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::SearchEngineInfo& s_info =
        update_info.search_engines[i];
      if(CorbaAlgs::unpack_time(s_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::SearchEngineInfo& result_s_info =
  ...
  void
  CampaignServerImpl_v290::convert_web_browsers_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::WebBrowserInfo& b_info =
        update_info.web_browsers[i];
      if(CorbaAlgs::unpack_time(b_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::WebBrowserInfo& result_b_info =
        ...
        {
          const AdServer::CampaignSvcs_v291::WebBrowserDetectorInfo& d_info =
            b_info.detectors[j];
          AdServer::CampaignSvcs_v290::WebBrowserDetectorInfo& result_d_info =
  ...
  void
  CampaignServerImpl_v290::convert_platforms_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::PlatformInfo& p_info =
        update_info.platforms[i];
      if(CorbaAlgs::unpack_time(p_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::PlatformInfo& result_p_info =
        ...
        {
          const AdServer::CampaignSvcs_v291::PlatformDetectorInfo& pd_info =
            p_info.detectors[j];
          AdServer::CampaignSvcs_v290::PlatformDetectorInfo& result_pd_info =
  ...
  void
  CampaignServerImpl_v290::convert_fraud_conditions_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::FraudConditionInfo& fraud_cond_info =
        update_info.fraud_conditions[i];
      if(CorbaAlgs::unpack_time(fraud_cond_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::FraudConditionInfo& result_fraud_cond_info =
  ...
  void
  CampaignServerImpl_v290::convert_string_dictionaries_(
    AdServer::CampaignSvcs_v290::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v291::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v291::StringDictionaryInfo& info =
        update_info.string_dictionaries[i];
      if(CorbaAlgs::unpack_time(info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v290::StringDictionaryInfo& result_info =
