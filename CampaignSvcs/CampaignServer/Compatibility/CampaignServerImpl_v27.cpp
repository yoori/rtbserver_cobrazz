...
#include "CampaignServerImpl_v27.hpp"

namespace
{
  void
  copy_price_range_seq(
    AdServer::CampaignSvcs_v27::PriceRangeSeq& tgt,
    const AdServer::CampaignSvcs_v28::PriceRangeSeq& src)
    noexcept
  {
  ...
  void
  copy_channel_expr(
    AdServer::CampaignSvcs_v27::ExpressionInfo& result_expr,
    const AdServer::CampaignSvcs_v28::ExpressionInfo& expr)
  {
  ...
  void copy_channel(
    AdServer::CampaignSvcs_v27::ExpressionChannelInfo& result_channel_info,
    const AdServer::CampaignSvcs_v28::ExpressionChannelInfo& channel_info)
  {
  ...
  copy_simple_channels(
    const AdServer::CampaignSvcs_v28::SimpleChannelKeySeq& simple_channel_seq,
    AdServer::CampaignSvcs_v27::SimpleChannelKeySeq& result_simple_channel_seq,
    const Generics::Time& request_timestamp)
  {
  ...
  void convert_bp_seq(
    AdServer::CampaignSvcs_v27::BehavParameterSeq& result,
    const AdServer::CampaignSvcs_v28::BehavParameterSeq& src)
  {
    result.length(src.length());
    
    for(CORBA::ULong bp_el_i = 0; bp_el_i < src.length(); ++bp_el_i)
    {
      const AdServer::CampaignSvcs_v28::BehavParameter& bp_el = src[bp_el_i];
      AdServer::CampaignSvcs_v27::BehavParameter& result_bp_el = result[bp_el_i];
...
namespace CampaignSvcs
{
  ...
  CampaignServerImpl_v27::CampaignServerImpl_v27(
    Logging::Logger* logger,
    POA_AdServer::CampaignSvcs_v28::CampaignServer* campaign_server)
  ...
  CampaignServerImpl_v27::~CampaignServerImpl_v27() noexcept
  {}

  void
  CampaignServerImpl_v27::convert_config_(
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const Generics::Time& request_timestamp)
    /*throw(Exception, eh::Exception)*/
  {
    ...
    convert_keyword_ecpms_(result_update_info, update_info, request_timestamp);
  ...
  void
  CampaignServerImpl_v27::convert_get_config_settings_(
    const AdServer::CampaignSvcs_v27::CampaignGetConfigSettings& settings,
    AdServer::CampaignSvcs_v28::CampaignGetConfigSettings& result_settings)
    /*throw(Exception, eh::Exception)*/
  {
  ...
  AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo*
  CampaignServerImpl_v27::get_config(
    const AdServer::CampaignSvcs_v27::CampaignGetConfigSettings& settings)
    /*throw(AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v27::CampaignServer::NotReady)*/
  {
    static const char* FUN = "CampaignServerImpl_v27::get_config()";

    try
    {
      AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo_var campaign_config;
      AdServer::CampaignSvcs_v28::CampaignGetConfigSettings conv_settings;

      convert_get_config_settings_(settings, conv_settings);

      campaign_config = campaign_server_->get_config(conv_settings);

      AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo_var result_campaign_config =
        new AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo();
    ...
    catch(const AdServer::CampaignSvcs_v28::CampaignServer::ImplementationException& ex)
    {
      Stream::Error ostr;
      ostr << FUN << ": AdServer::CampaignSvcs_v28::CampaignServer::"
        "ImplementationException caught: " <<
        ex.description;

      CORBACommons::throw_desc<
        CampaignSvcs_v27::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v28::CampaignServer::NotReady& ex)
    {
      throw AdServer::CampaignSvcs_v27::CampaignServer::NotReady(ex.description);
    }
  ...
  AdServer::CampaignSvcs_v27::EcpmSeq*
  CampaignServerImpl_v27::get_ecpms(
    const AdServer::CampaignSvcs_v27::TimestampInfo& request_timestamp)
    /*throw(AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v27::get_ecpms()";
      
    try
    {
      AdServer::CampaignSvcs_v28::EcpmSeq_var ecpms  =
        campaign_server_->get_ecpms(request_timestamp);
      AdServer::CampaignSvcs_v27::EcpmSeq_var result_ecpms =
        new AdServer::CampaignSvcs_v27::EcpmSeq();
    ...
    catch(const AdServer::CampaignSvcs_v28::CampaignServer::ImplementationException& e)
    {
      Stream::Error ostr;
      ostr << FUN << ": CampaignSvcs_v28::CampaignServer::"
        "ImplementationException caught: " << e.description;
      CORBACommons::throw_desc<
        CampaignSvcs_v27::CampaignServer::ImplementationException>(
          ostr.str());
    }
    catch(const AdServer::CampaignSvcs_v28::CampaignServer::NotReady& )
    {
      throw AdServer::CampaignSvcs_v27::CampaignServer::NotReady();
    }
    return 0; // never reach
  }

  AdServer::CampaignSvcs_v27::SimpleChannelAnswer*
  CampaignServerImpl_v27::simple_channels(
    const AdServer::CampaignSvcs_v27::CampaignServer::GetSimpleChannelsInfo& /*settings*/)
    /*throw(AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v27::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException(
      "CampaignServerImpl_v27::simple_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v27::ExpressionChannelsInfo*
  CampaignServerImpl_v27::get_expression_channels(
    const AdServer::CampaignSvcs_v27::CampaignServer::GetExpressionChannelsInfo&)
    /*throw(AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v27::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException(
      "CampaignServerImpl_v27::get_expression_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v27::DetectorsConfig*
  CampaignServerImpl_v27::detectors(
    const AdServer::CampaignSvcs_v27::TimestampInfo& /*request_timestamp*/)
    /*throw(AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v27::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException(
      "CampaignServerImpl_v27::search_engines(): Not supported.");
  }

  AdServer::CampaignSvcs_v27::FreqCapConfigInfo*
  CampaignServerImpl_v27::freq_caps()
    /*throw(AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v27::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException(
      "CampaignServerImpl_v27::freq_caps(): Not supported.");
  }

  AdServer::CampaignSvcs_v27::StatInfo*
  CampaignServerImpl_v27::get_stat() /*throw(
    AdServer::CampaignSvcs_v27::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v27::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v27::CampaignServer::NotSupport(
      "CampaignServerImpl_v27::get_stat(): Not supported.");
  }

  void
  CampaignServerImpl_v27::update_stat() /*throw(
    AdServer::CampaignSvcs_v27::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException)*/
  {
    throw AdServer::CampaignSvcs_v27::CampaignServer::NotSupport(
      "CampaignServerImpl_v27::update_stat(): Not supported.");
  }

  CORBA::Boolean
  CampaignServerImpl_v27::need_config(
    const CORBACommons::TimestampInfo& master_stamp)
    /*throw(AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException)*/
  {
    static const char* FUN = "CampaignServerImpl_v27::need_config()";

    try
    {
      return campaign_server_->need_config(master_stamp);
    }
    catch(const AdServer::CampaignSvcs_v27::
  ...
  AdServer::CampaignSvcs_v27::DiscoverSourceInfo*
  CampaignServerImpl_v27::get_discover_channels(
    CORBA::ULong, CORBA::ULong)
    /*throw(AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v27::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException(
      "CampaignServerImpl_v27::get_discover_channels(): Not supported.");
  }

  AdServer::CampaignSvcs_v27::CampaignServer::PassbackInfo*
  CampaignServerImpl_v27::get_tag_passback(CORBA::ULong)
    /*throw(AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v27::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException(
      "CampaignServerImpl_v27::get_tag_passback(): Not supported.");
  }

  AdServer::CampaignSvcs_v27::FraudConditionConfig*
  CampaignServerImpl_v27::fraud_conditions()
    /*throw(AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v27::CampaignServer::NotReady)*/
  {
    throw AdServer::CampaignSvcs_v27::CampaignServer::ImplementationException(
      "CampaignServerImpl_v27::fraud_conditions(): Not supported.");
  }

  void
  CampaignServerImpl_v27::convert_campaigns_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    const
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::CampaignInfo& campaign_info =
        update_info.campaigns[i];

      if(CorbaAlgs::unpack_time(campaign_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::CampaignInfo& result_campaign_info =
        ...
        result_campaign_info.campaign_type = campaign_info.campaign_type;
        ...
        {
          const AdServer::CampaignSvcs_v28::CreativeInfo& creative_info =
            campaign_info.creatives[j];

          AdServer::CampaignSvcs_v27::CreativeInfo& result_creative_info =
  ...
  void
  CampaignServerImpl_v27::convert_accounts_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::AccountInfo& account_info =
        update_info.accounts[i];

      if(CorbaAlgs::unpack_time(account_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::AccountInfo& result_account_info =
  ...
  void
  CampaignServerImpl_v27::convert_creative_options_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::CreativeOptionInfo& option_info =
        update_info.activate_creative_options[i];

      if(CorbaAlgs::unpack_time(option_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::CreativeOptionInfo& result_option_info =
  ...
  void
  CampaignServerImpl_v27::convert_expression_channels_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v27::convert_geo_channels_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::GeoChannelInfo& channel_info =
        update_info.activate_geo_channels[ch_i];

      if(CorbaAlgs::unpack_time(channel_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::GeoChannelInfo& result_channel_info =
  ...
  void
  CampaignServerImpl_v27::convert_ecpm_seq_(
    AdServer::CampaignSvcs_v27::EcpmSeq& result_ecpms,
    const AdServer::CampaignSvcs_v28::EcpmSeq& ecpms,
    const Generics::Time& request_timestamp)
    noexcept
  {
    /* fill ecpms */
    ...
    {
      const AdServer::CampaignSvcs_v28::CampaignEcpmInfo& ecpm_info = ecpms[i];

      if(CorbaAlgs::unpack_time(ecpm_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::CampaignEcpmInfo& res_ecpm_info = result_ecpms[res_i++];
  ...
  void
  CampaignServerImpl_v27::convert_ecpms_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v27::convert_sites_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::SiteInfo& site_info = update_info.sites[i];

      if(CorbaAlgs::unpack_time(site_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::SiteInfo& result_site_info =
  ...
  void
  CampaignServerImpl_v27::convert_tags_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::TagInfo& tag_info =
        update_info.tags[tag_i];

      if(CorbaAlgs::unpack_time(tag_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::TagInfo& result_tag_info =
        ...
        {
          const AdServer::CampaignSvcs_v28::TagPricingInfo& tag_pricing_info =
            tag_info.tag_pricings[j];
          AdServer::CampaignSvcs_v27::TagPricingInfo& result_tag_pricing_info =
            result_tag_info.tag_pricings[j];
  ...
  void
  CampaignServerImpl_v27::convert_frequency_caps_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::FreqCapInfo& freq_cap =
        update_info.frequency_caps[i];

      if(CorbaAlgs::unpack_time(freq_cap.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::FreqCapInfo& result_freq_cap =
  ...
  void
  CampaignServerImpl_v27::convert_simple_channels_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v27::convert_behav_params_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    {
      ...
      {
        const AdServer::CampaignSvcs_v28::BehavParamInfo& bp =
          update_info.behav_params[i];

        if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
        {
          AdServer::CampaignSvcs_v27::BehavParamInfo& result_bp =
    ...
    {
      const AdServer::CampaignSvcs_v28::KeyBehavParamInfo& bp =
        update_info.key_behav_params[i];
      if(CorbaAlgs::unpack_time(bp.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::KeyBehavParamInfo& result_bp =
  ...
  void
  CampaignServerImpl_v27::convert_colocations_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::ColocationInfo& colo_info =
        update_info.colocations[i];
      if(CorbaAlgs::unpack_time(colo_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::ColocationInfo& result_colo_info =
  ...
  void
  CampaignServerImpl_v27::convert_creative_templates_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::CreativeTemplateInfo& cr_templ_info =
        update_info.creative_templates[i];
      if(CorbaAlgs::unpack_time(cr_templ_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::CreativeTemplateInfo& result_cr_templ_info =
        ...
        {
          const AdServer::CampaignSvcs_v28::CreativeTemplateFileInfo& ctf_info =
            cr_templ_info.files[ctf_i];
          AdServer::CampaignSvcs_v27::CreativeTemplateFileInfo& result_ctf_info =
          ...
          result_ctf_info.type =
            static_cast<AdServer::CampaignSvcs_v27::CreativeTemplateType>(
              ctf_info.type);
        }
      }
    }
  ...
  void
  CampaignServerImpl_v27::convert_currencies_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::CurrencyInfo& currency_info =
        update_info.currencies[i];

      if(CorbaAlgs::unpack_time(currency_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::CurrencyInfo& result_currency_info =
  ...
  void
  CampaignServerImpl_v27::convert_campaign_keywords_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::CampaignKeywordInfo& keyword_info =
        update_info.campaign_keywords[i];

      if(CorbaAlgs::unpack_time(keyword_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::CampaignKeywordInfo& res_keyword_info =
          result_update_info.campaign_keywords[res_i++];

        res_keyword_info.ccg_keyword_id = keyword_info.ccg_keyword_id;
        res_keyword_info.keyword_id = keyword_info.keyword_id;
        res_keyword_info.ccg_id = keyword_info.ccg_id;
        res_keyword_info.max_cpc = keyword_info.max_cpc;
        res_keyword_info.ecpm = keyword_info.ecpm;
        res_keyword_info.ctr = keyword_info.ctr;
  ...
  void
  CampaignServerImpl_v27::convert_creative_categories_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::CreativeCategoryInfo& category_info =
        update_info.creative_categories[i];
      if(CorbaAlgs::unpack_time(category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::CreativeCategoryInfo& res_category_info =
  ...
  void
  CampaignServerImpl_v27::convert_adv_actions_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  ...
  void
  CampaignServerImpl_v27::convert_keyword_ecpms_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    /* fill keyword ecpms */
    result_update_info.keyword_ecpms.length(
      update_info.keyword_ecpms.length());

    CORBA::ULong res_i = 0;
    for(CORBA::ULong i = 0; i < update_info.keyword_ecpms.length(); ++i)
    {
      if(CorbaAlgs::unpack_time(update_info.keyword_ecpms[i].timestamp) > request_timestamp)
      {
        result_update_info.keyword_ecpms[res_i].ccg_id =
          update_info.keyword_ecpms[i].ccg_id;
        result_update_info.keyword_ecpms[res_i].ecpm =
          update_info.keyword_ecpms[i].ecpm;
        result_update_info.keyword_ecpms[res_i].ctr =
          update_info.keyword_ecpms[i].ctr;
        result_update_info.keyword_ecpms[res_i].timestamp =
          update_info.keyword_ecpms[i].timestamp;
        ++res_i;
      }
    }
    
    result_update_info.keyword_ecpms.length(res_i);

    copy_deleted_sequence(
      update_info.deleted_keyword_ecpms,
      result_update_info.deleted_keyword_ecpms,
      request_timestamp);
  }
  
  void
  CampaignServerImpl_v27::convert_category_channels_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::CategoryChannelInfo& channel_category_info =
        update_info.category_channels[cat_i];
      if(CorbaAlgs::unpack_time(channel_category_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::CategoryChannelInfo& result_channel_category_info =
  ...
  void
  CampaignServerImpl_v27::convert_margin_rules_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::MarginRuleInfo& margin_rule_info =
        update_info.margin_rules[m_i];
      if(CorbaAlgs::unpack_time(margin_rule_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::MarginRuleInfo& result_margin_rule_info =
  ...
  void
  CampaignServerImpl_v27::convert_search_engines_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::SearchEngineInfo& s_info =
        update_info.search_engines[i];
      if(CorbaAlgs::unpack_time(s_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::SearchEngineInfo& result_s_info =
          result_update_info.search_engines[res_i++];
        std::ostringstream ostr;
        ostr << s_info.id;
        result_s_info.name = ostr.str().c_str();
    ...
    {
      std::ostringstream ostr;
      ostr << update_info.deleted_search_engines[i].id;
      result_update_info.deleted_search_engines[i].id = ostr.str().c_str();
  ...
  void
  CampaignServerImpl_v27::convert_web_browsers_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::WebBrowserInfo& b_info =
        update_info.web_browsers[i];
      if(CorbaAlgs::unpack_time(b_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::WebBrowserInfo& result_b_info =
        ...
        {
          const AdServer::CampaignSvcs_v28::WebBrowserDetectorInfo& d_info =
            b_info.detectors[j];
          AdServer::CampaignSvcs_v27::WebBrowserDetectorInfo& result_d_info =
  ...
  void
  CampaignServerImpl_v27::convert_platforms_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::PlatformInfo& p_info =
        update_info.platforms[i];
      if(CorbaAlgs::unpack_time(p_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::PlatformInfo& result_p_info =
        ...
        {
          const AdServer::CampaignSvcs_v28::PlatformDetectorInfo& pd_info =
            p_info.detectors[j];
          AdServer::CampaignSvcs_v27::PlatformDetectorInfo& result_pd_info =
  ...
  void
  CampaignServerImpl_v27::convert_fraud_conditions_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::FraudConditionInfo& fraud_cond_info =
        update_info.fraud_conditions[i];
      if(CorbaAlgs::unpack_time(fraud_cond_info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::FraudConditionInfo& result_fraud_cond_info =
  ...
  void
  CampaignServerImpl_v27::convert_string_dictionaries_(
    AdServer::CampaignSvcs_v27::CampaignConfigUpdateInfo& result_update_info,
    const AdServer::CampaignSvcs_v28::CampaignConfigUpdateInfo& update_info,
    const Generics::Time& request_timestamp)
    noexcept
  {
    ...
    {
      const AdServer::CampaignSvcs_v28::StringDictionaryInfo& info =
        update_info.string_dictionaries[i];
      if(CorbaAlgs::unpack_time(info.timestamp) > request_timestamp)
      {
        AdServer::CampaignSvcs_v27::StringDictionaryInfo& result_info =
