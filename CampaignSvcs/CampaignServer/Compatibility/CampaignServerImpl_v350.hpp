...
namespace AdServer::CampaignSvcs
{
  ...
  public:
    ...
    get_config(const AdServer::CampaignSvcs_v350::CampaignGetConfigSettings& settings);

    virtual AdServer::CampaignSvcs_v350::EcpmSeq*
    get_ecpms(const AdServer::CampaignSvcs_v350::TimestampInfo& request_timestamp);
