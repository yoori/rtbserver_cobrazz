...
namespace AdServer::CampaignSvcs
{
  ...
  public:
    ...
    virtual CampaignConfigUpdateInfo* get_config(const CampaignGetConfigSettings& settings)
      /*throw(AdServer::CampaignSvcs::CampaignServer::ImplementationException,
        AdServer::CampaignSvcs::CampaignServer::NotReady)*/;

    virtual CORBA::Boolean need_config(const TimestampInfo& req_timestamp)
      /*throw(AdServer::CampaignSvcs::CampaignServer::ImplementationException)*/;

    virtual EcpmSeq* get_ecpms(const TimestampInfo& request_timestamp)
      /*throw(AdServer::CampaignSvcs::CampaignServer::ImplementationException)*/;
    ...
    simple_channels(const AdServer::CampaignSvcs::CampaignServer::GetSimpleChannelsInfo& settings)
      /*throw(AdServer::CampaignSvcs::CampaignServer::ImplementationException,
        AdServer::CampaignSvcs::CampaignServer::NotReady)*/;
  ...
  protected:
    ...
    {
    public:
      FlushLogsTask(CampaignServerBaseImpl* server, Generics::TaskRunner* task_runner)
        /*throw(eh::Exception)*/;
    ...
    {
    public:
      UpdateConfigTaskMessage(CampaignServerBaseImpl* server, Generics::TaskRunner* task_runner)
        /*throw(eh::Exception)*/;
    ...
    {
    public:
      UpdateBillStatTask(CampaignServerBaseImpl* server, Generics::TaskRunner* task_runner)
        /*throw(eh::Exception)*/;
  ...
  protected:
    ...
    void
    fill_active_campaign_ids_(CampaignIdSeq& campaign_ids, const CampaignMap::ActiveMap& campaigns)
      /*throw(Exception)*/;
...
namespace AdServer::CampaignSvcs
{
    ...
    noexcept
  {
    ...
    for (typename SourceType::const_iterator it = src.begin(); it != src.end(); ++it)
    {
      if (it->first % portions_number == portion && ts_op(it->second) > request_timestamp)
      {
        ++result;
      }
    }
