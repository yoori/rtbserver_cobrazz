...
namespace AdServer::CampaignSvcs
{
  ...
  public:
    ...
    using WeightedCampaignKeywordList = Generics::MonoList<WeightedCampaignKeyword>;

    typedef std::unique_ptr<WeightedCampaignKeywordList>
      WeightedCampaignKeywordListPtr;

    using WeightedCampaignKeywordPtrArray = Generics::MonoVector<WeightedCampaignKeyword*>;

    using WeightedCampaignKeywordGroupList = Generics::MonoList<WeightedCampaignKeywordPtrArray>;
  ...
  protected:
    using CPCKeywordMap = Generics::MonoMap<RevenueDecimal, WeightedCampaignKeywordList>;

    using WeightedCampaignList = Generics::MonoList<WeightedCampaignPtr>;

    using ExpRevWeightedCampaignKeywordMap =
      Generics::MonoMultiMap<RevenueDecimal, WeightedCampaignKeywordPtrArray>;

    using IdWeightedCampaignKeywordMap =
      Generics::MonoMap<unsigned long, WeightedCampaignKeywordPtrArray>;

    struct IdWeightedCampaignKeywordMaps
    {
      explicit IdWeightedCampaignKeywordMaps(Generics::MonoAllocatorArena* arena)
        : account_campaigns(Generics::mono_allocator<
            IdWeightedCampaignKeywordMap::value_type>(arena)),
          advertiser_campaigns(Generics::mono_allocator<
            IdWeightedCampaignKeywordMap::value_type>(arena)),
          ccg_campaigns(Generics::mono_allocator<IdWeightedCampaignKeywordMap::value_type>(arena))
      {}
  ...
  protected:
    ...
    static
    RevenueDecimal
    campaign_ecpm_expected_value_(const WeightedCampaignList& campaign_candidates)
      noexcept;
    ...
    const Creative*
    select_display_creative_(CampaignIndex::ConstCreativePtrList& available_creatives) const
      /*throw(eh::Exception)*/;
    ...
    static RevenueDecimal
    default_campaign_ecpm_(const Tag* tag, const Campaign* campaign)
      noexcept;
