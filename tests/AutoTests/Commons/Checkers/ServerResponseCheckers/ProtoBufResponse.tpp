...
namespace AutoTest::ProtoBuf
{
  ...
  template <typename ProtoBufChecker, typename T, typename Getter>
  FieldChecker<ProtoBufChecker, T, Getter>::FieldChecker(const FieldChecker& other) :
    Checker(),
  ...
  template <typename ProtoBufChecker, typename T, typename Getter>
  bool
  FieldChecker<ProtoBufChecker, T, Getter>::check(bool throw_error)
    /*throw(eh::Exception)*/
  {
    T got;
  ...
  template <typename ProtoBufChecker, typename Getter>
  bool
  FieldExistChecker<ProtoBufChecker, Getter>::check(bool throw_error)
    /*throw(eh::Exception)*/
  {
    bool got_exist = static_cast<bool>(((checker_.ad()).*getter_)());
    if (exist_ ^ got_exist)
    {
      if (throw_error)
      {
  ...
  AdChecker<Tag>::AdChecker(const AdClient& client, const Expected& expected, size_t creative_num) :
  ...
  template<typename Tag>
  AdChecker<Tag>::AdChecker(const AdChecker& other) :
    Checker(),
  ...
  template<typename Tag>
  bool
  AdChecker<Tag>::check(bool throw_error)
  ...
  template<typename T>
  bool
  AutoTest::TypeTraits< google::protobuf::RepeatedPtrField<T> >::equal(
    const SeqType& exp,
    const SeqType& got)
  {
  ...
  template<typename T>
  std::string
  AutoTest::TypeTraits<google::protobuf::RepeatedPtrField<T> >::to_string(const SeqType& val)
  {
  ...
  template<typename T>
  bool
  AutoTest::TypeTraits< google::protobuf::RepeatedField<T> >::equal(
    const SeqType& exp,
    const SeqType& got)
  {
    return equal_seq(exp, got);
  ...
  template<typename T>
  std::string
  AutoTest::TypeTraits<google::protobuf::RepeatedField<T> >::to_string(const SeqType& val)
  {
    return seq_to_str(val);
  }
