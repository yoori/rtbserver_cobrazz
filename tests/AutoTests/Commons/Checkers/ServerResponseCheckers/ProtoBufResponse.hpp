...
namespace AutoTest::ProtoBuf
{
  ...
  public:
     ...
     */
    FieldChecker(ProtoBufChecker& checker, const T& exp, Getter getter);
     ...
     */
    FieldChecker(const FieldChecker& other);
  ...
  public:
     ...
     */
    FieldExistChecker(ProtoBufChecker& checker, bool exist, Getter getter);
  ...
  public:
     ...
     */
    AdChecker(const AdClient& client, const Expected& expected, size_t creative_num);

    /**
     * @brief Copy constructor.
     */
    AdChecker(const AdChecker& other);
...
namespace AutoTest
{
  ...
  struct TypeTraits< google::protobuf::RepeatedPtrField<T> >
  {
    ...
    static
    bool
    equal(const SeqType& exp, const SeqType& got);
