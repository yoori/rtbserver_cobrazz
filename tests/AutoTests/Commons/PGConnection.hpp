...
namespace AutoTest::PQ
{
  ...
  public:
     ...
     */
    AutoTest::DBC::IQuery*
    get_query (const std::string& statement);
  ...
  */
  ...
  public:
     ...
     */
    void
    set(const AutoTest::DBC::TextField& value);
     ...
     */
    void
    null(const Generics::Time& value);

    /**
     * @brief Set long(text) parameter to null.
     */
    void
    null(const AutoTest::DBC::TextField& value);
  ...
  protected:
    ...
    void
    set_as_string_(Oid oid, unsigned long size, const ValueType& val);
     ...
     */
    void
    set_string_(Oid oid, unsigned long size, const std::string& val);
  ...
  */
  ...
  public:
     ...
     */
    void
    throw_exception(const std::string& message);
  ...
  */
  ...
  public:
     ...
     */
    void
    get(AutoTest::DBC::TextField& value);
