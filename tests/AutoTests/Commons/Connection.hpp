...
namespace AutoTest::DBC
{
  ...
  */
  ...
  public:
     ...
     */
    virtual IQuery*
    get_query(const std::string& statement) = 0;
  };
  ...
  */
  ...
  public:
     ...
     */
    static IConn*
    open_ora(const std::string& user, const std::string& pswd, const std::string& db);
     ...
     */
    IQuery*
    query(const std::string& statement);
    ...
    template<typename T>
    bool
    ask(const std::string& statement, T& value);
    ...
    bool
    ask(const std::string& statement, const Arg1& arg1, T& value);
    ...
    bool
    ask(const std::string& statement, const Arg1& arg1, const Arg2& arg2, T& value);
  ...
  */
  ...
  public:
     ...
     * @param error message
     */
    virtual void throw_exception(const std::string& message) = 0;
  ...
  */
  ...
  public:
     ...
     */
    T&
    set(const Generics::ExtendedTime& value);
     ...
     */
    T&
    null(const Generics::ExtendedTime& value);
  ...
  */
  ...
  public:
     ...
     */
    virtual void
    get(Generics::ExtendedTime& value) = 0;
  ...
  */
  ...
  public:
     ...
     */
    Result&
    get(Generics::ExtendedTime& value);
