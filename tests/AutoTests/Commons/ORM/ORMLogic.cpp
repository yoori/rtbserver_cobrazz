...
namespace AutoTest::ORM
{
  ...
  ExpressionChannel::ExpressionChannel (DB::IConn& connection) :
    PQ::Channel(connection)
  {
    type              = "E"; //expression
    channel_namespace = "A";
  ...
  ExpressionChannel::ExpressionChannel (DB::IConn& connection, const ORMInt::value_type& id) :
  ...
  CategoryChannel::CategoryChannel (DB::IConn& connection) :
    PQ::Channel(connection)
  {
    type              = "C"; //category
    channel_namespace = "C";
  ...
  CategoryChannel::CategoryChannel (DB::IConn& connection, const ORMInt::value_type& id) :
    PQ::Channel(connection, id)
  { }

  // class TriggerChannel

  TriggerChannel::TriggerChannel (DB::IConn& connection) :
    PQ::Channeltrigger(connection),
    channel_(connection)
  { }

  TriggerChannel::TriggerChannel (DB::IConn& connection, const ORMInt::value_type& id) :
    PQ::Channeltrigger(connection, id),
    channel_(connection)
  { }

  TriggerChannel::TriggerChannel(const TriggerChannel& from) :
    PQ::Channeltrigger(from),
    channel_(from.channel_)
  { }

  TriggerChannel&
  TriggerChannel::operator=(const TriggerChannel& from)
  {
  ...
  {
    return
      PQ::Channeltrigger::select() && channel_.select(channel_id.value());
  }

  bool TriggerChannel::select (const ORMInt::value_type& id)
  {
    return PQ::Channeltrigger::select(id) && channel_.select(channel_id.value());
  }

  bool
  TriggerChannel::update(bool set_defaults)
  {
  ...
  bool
  TriggerChannel::delet (const ORMInt::value_type& id)
  {
    select(id);
  ...
  BehavioralChannel::BehavioralChannel (DB::IConn& connection) :
    PQ::Channel(connection),
    params(connection)
  {
    type              = "B";
  ...
  BehavioralChannel::BehavioralChannel (DB::IConn& connection, const ORMInt::value_type& id) :
    PQ::Channel(connection, id),
    params(connection)
  {
    type              = "B";
  ...
  BehavioralChannel::BehavioralChannel (const BehavioralChannel& from) :
    PQ::Channel(from),
    params(from.params)
  { }
  ...
  {
    return PQ::Channel::select() && params.select_channel(id());
  }

  bool BehavioralChannel::select (const ORMInt::value_type& id)
  {
    return PQ::Channel::select(id) && params.select_channel(id);
  }

  bool BehavioralChannel::update (bool set_defaults)
  {
    return PQ::Channel::update(set_defaults) || params.update_channel(id(), set_defaults);
  }

  bool BehavioralChannel::update (const ORMInt::value_type& id, bool set_defaults)
  {
    return PQ::Channel::update(id, set_defaults) || params.update_channel(id, set_defaults);
  }

  bool BehavioralChannel::insert (bool set_defaults)
  {
    return PQ::Channel::insert(set_defaults) && params.insert_channel(id(), set_defaults);
  }
  ...
  {
    return PQ::Channel::select_name(name) && params.select_channel(id());
  }

  bool BehavioralChannel::insert_name (const std::string& name, bool set_defaults)
  {
  ...
  DiscoverChannel::DiscoverChannel (DB::IConn& connection):
    BehavioralChannel(connection)
  { }

  DiscoverChannel::DiscoverChannel (DB::IConn& connection, const ORMInt::value_type& id) :
  ...
  bool
  DiscoverChannel::delet(const ORMInt::value_type& id)
  {
    id_ = id;
    delet_stats_();
  ...
  void DiscoverChannel::delet_stats_()
  {
    ...
    {
      DB::Query  query(
        conn.get_query("DELETE FROM DISCOVERCHANNELSTATE " "WHERE CHANNEL_ID = :i1"));
      query  << id_;
  ...
  SearchChannel::SearchChannel (DB::IConn& connection)
    : BehavioralChannel(connection)
  {
    status           = "A";
    qa_status        = "A";
  ...
  PageChannel::PageChannel (DB::IConn& connection)
    : BehavioralChannel(connection)
  {
    status           = "A";
    qa_status        = "A";
  ...
  PageChannel::PageChannel (DB::IConn& connection, const ORMInt::value_type& id)
    : BehavioralChannel(connection, id)
  { }
  ...
  RatedTagPricing::RatedTagPricing(DB::IConn& connection, const ORMInt::value_type& id):
  ...
  {
    return
      PQ::TagPricing::update(set_defaults) && rate.update(set_defaults);
  }
  ...
  bool RatedTagPricing::delet()
  {
    site_rate.null();
    return
      PQ::TagPricing::update(false) && rate.delet() && TagPricing::delet();
  }
  ...
  RatedColocation::RatedColocation(DB::IConn& connection):
    Colocation(connection),
    rate(connection)
  {}


  RatedColocation::RatedColocation(const RatedColocation& from):
    Colocation(from),
    rate(from.rate)
  {}
  ...
  RatedColocation::RatedColocation(DB::IConn& connection, const ORMInt::value_type& id):
  ...
  {
    return PQ::Colocation::select() && (colo_rate.is_null() || rate.select(colo_rate.value()));
  }

  bool
  RatedColocation::update(bool set_defaults)
  {
    return PQ::Colocation::update(set_defaults) && rate.update(set_defaults);
  }
  ...
  RatedColocation::delet()
  {
    ...
    {
      colo_rate.null();
      return PQ::Colocation::update(false) && rate.delet() && PQ::Colocation::delet();
    }
    else
    {
  ...
  RatedCampaignCreativeGroup::RatedCampaignCreativeGroup(const RatedCampaignCreativeGroup& from):
  ...
  {
    return
      PQ::CampaignCreativeGroup::update(set_defaults) && rate.update(set_defaults);
  }
