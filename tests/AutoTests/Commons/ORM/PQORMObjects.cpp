...
namespace AutoTest::ORM::PQ
{
  ...
  Account::Account (DB::IConn& connection, const ORMInt::value_type& account_id)
  ...
  Accountaddress::Accountaddress (DB::IConn& connection, const ORMInt::value_type& address_id)
  ...
  Accountrole::Accountrole (DB::IConn& connection, const ORMInt::value_type& account_role_id)
  ...
  Accounttype::Accounttype (DB::IConn& connection, const ORMInt::value_type& account_type_id)
  ...
  Action::Action (DB::IConn& connection, const ORMInt::value_type& action_id)
  ...
  Appformat::Appformat (DB::IConn& connection, const ORMInt::value_type& app_format_id)
  ...
  bool BehavioralParameters::select_channel (const ORMInt::value_type& channel)
  {
    ...
    if (result.next())
    {
      result >> behav_params_list_id
             >> last_updated
             >> minimum_visits
             >> time_from >> time_to >> trigger_type >> version >> weight >> behav_params_id_;
      return true;
    }
    return false;
  }
  ...
  Campaign::Campaign (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  CampaignCreative::CampaignCreative (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  CampaignCreativeGroup::CampaignCreativeGroup (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  CCGKeyword::CCGKeyword (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  CCGRate::CCGRate (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  Channel::Channel (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  bool Channel::has_name (const ORMString::value_type& name)
  {
    Unused(name);
    this->name = name;
    DB::Query query(conn.get_query("SELECT " "channel_id " "FROM channel " "WHERE name = :i1"));
    query.set(name);
    DB::Result result(query.ask());
    if (result.next())
    {
  ...
  bool Channel::select_name (const ORMString::value_type& name)
  {
    ...
    if (result.next())
    {
      result >> account
             ...
             >> status_change_date
             >> superseded_by_channel_id
             >> trigger_type >> triggers_status >> triggers_version >> version >> visibility >> id_;
      return true;
    }
    return false;
  }
  ...
  Channelrate::Channelrate (DB::IConn& connection, const ORMInt::value_type& channel_rate_id)
  ...
  Colocation::Colocation (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  bool Colocation::has_name (const ORMString::value_type& name)
  {
    Unused(name);
    this->name = name;
    DB::Query query(conn.get_query("SELECT " "colo_id " "FROM colocation " "WHERE name = :i1"));
    query.set(name);
    DB::Result result(query.ask());
    if (result.next())
    {
  ...
  bool Colocation::select_name (const ORMString::value_type& name)
  {
    ...
    if (result.next())
    {
      result >> account >> colo_rate >> last_updated >> optout_serving >> status >> version >> id_;
      return true;
    }
    return false;
  }
  ...
  ColocationRate::ColocationRate (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  Colostats::Colostats (DB::IConn& connection, const ORMInt::value_type& colo_id)
  ...
  Country::Country (DB::IConn& connection, const ORMString::value_type& country_code)
  ...
  Creative::Creative (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  CreativeCategory::CreativeCategory (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  Creativesize::Creativesize (DB::IConn& connection, const ORMInt::value_type& size_id)
  ...
  Currency::Currency (DB::IConn& connection, const ORMInt::value_type& currency_id)
  ...
  CurrencyExchange::CurrencyExchange (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  Feed::Feed (DB::IConn& connection, const ORMInt::value_type& feed_id)
  ...
  Feedstate::Feedstate (DB::IConn& connection, const ORMInt::value_type& feed_id)
    :ORMObject<postgres_connection>(connection), feed_id_(feed_id)
  {}
  ...
  FreqCap::FreqCap (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  SearchEngine::SearchEngine (DB::IConn& connection, const ORMInt::value_type& search_engine_id)
  ...
  Site::Site (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  Sitecategory::Sitecategory (DB::IConn& connection, const ORMInt::value_type& site_category_id)
  ...
  SiteRate::SiteRate (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  Sizetype::Sizetype (DB::IConn& connection, const ORMInt::value_type& size_type_id)
  ...
  TagPricing::TagPricing (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  Tags::Tags (DB::IConn& connection, const ORMInt::value_type& id)
    :ORMObject<postgres_connection>(connection), id_(id)
  {}
  ...
  Template::Template (DB::IConn& connection, const ORMInt::value_type& template_id)
  ...
  Templatefile::Templatefile (DB::IConn& connection, const ORMInt::value_type& template_file_id)
  ...
  Triggers::Triggers (DB::IConn& connection, const ORMInt::value_type& trigger_id)
  ...
  WDTag::WDTag (DB::IConn& connection, const ORMInt::value_type& wdtag_id)
