...
namespace AutoTest::ORM
{
  ...
  public:
     ...
     * @param value
     */
    explicit ORMString(const std::string& value);
     ...
     * @param other ORM value
     */
    ORMString(const ORMString& from);
  ...
  public:
     ...
     */
    explicit ORMText(const std::string& value);
  ...
  public:
     ...
     * @param date value
     */
    explicit ORMDate(const value_type& value);
     ...
     */
    ORMDate&
    operator=(const ::AutoTest::Time& value);
  ...
  public:
     ...
     */
    explicit ORMTimestamp(const value_type& value);
  ...
  public:
     ...
     * @param connection
     */
    explicit ORMObject(DB::IConn& connection);

    /**
     * @brief Copy constructor.
     */
    ORMObject(const ORMObject& obj);
     ...
     */
    virtual
    void log_in(Logger&, unsigned long = Logging::Logger::INFO);
     ...
     */
    void
    log(unsigned long severity = Logging::Logger::INFO);
  };
  ...
  public:
     ...
     * @param entity type.
     */
    Restorer(EntityType entity_type);
  ...
  public:
     ...
     * @param entity id.
     */
    ORMRestorer(DB::IConn& conn, unsigned long id);
     ...
     * @param entity.
     */
    ORMRestorer(const Entity& entity);
  ...
  public:
     ...
     */
    bool
    execute(AutoTest::DBC::IConn& connection, AutoTest::DBC::IQuery& query);
   ...
   */
  int
  get_display_status_id(DB::IConn& conn, const char* object, DisplayStatus status);
