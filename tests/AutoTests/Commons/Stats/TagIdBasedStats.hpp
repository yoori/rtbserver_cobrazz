    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const int& tag_id, const int& exclude_colo);
      };
      ...
      TagIdBasedStats (const int& tag_id, const int& exclude_colo);
      TagIdBasedStats ();
      Key& key ();
      Key& key (const Key& value);
      Key& key (const int& tag_id, const int& exclude_colo);
...
namespace AutoTest::ORM
{
  ...
  inline
  TagIdBasedStats::TagIdBasedStats (const int& tag_id, const int& exclude_colo)
    :Base("TagIdBasedStats")
  {
    key_ = Key (tag_id, exclude_colo);
  }
  inline
  ...
  inline
  TagIdBasedStats::Key::Key (const int& tag_id, const int& exclude_colo)
    :tag_id_(tag_id)
  {
    tag_id_used_ = true;
    tag_id_null_ = false;
  ...
  inline
  TagIdBasedStats::Key&
  TagIdBasedStats::key (const int& tag_id, const int& exclude_colo)
  {
    key_ = Key (tag_id, exclude_colo);
    return key_;
  }
