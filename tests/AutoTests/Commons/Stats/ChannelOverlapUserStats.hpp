    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const int& channel1, const int& channel2, const AutoTest::Time& sdate);
      };
      ...
      Key& key (const int& channel1, const int& channel2, const AutoTest::Time& sdate);
...
namespace AutoTest::ORM
{
  ...
  ChannelOverlapUserStats::ChannelOverlapUserStats (
    ...
    :Base("ChannelOverlapUserStats")
  {
    key_ = Key (channel1, channel2, sdate);
  }
  inline
