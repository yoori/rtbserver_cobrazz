    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const int& channel_id, const int& colo_id, const AutoTest::Time& sdate);
      };
      ...
      Key& key (const int& channel_id, const int& colo_id, const AutoTest::Time& sdate);
...
namespace AutoTest::ORM
{
  ...
  ChannelInventoryStats::ChannelInventoryStats (
    ...
    :Base("ChannelInventoryStats")
  {
    key_ = Key (channel_id, colo_id, sdate);
  }
  inline
