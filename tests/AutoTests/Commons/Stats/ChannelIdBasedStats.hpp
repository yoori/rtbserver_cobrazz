    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const int& channel_id, const int& exclude_colo);
      };
      ...
      ChannelIdBasedStats (const int& channel_id, const int& exclude_colo);
      ChannelIdBasedStats ();
      Key& key ();
      Key& key (const Key& value);
      Key& key (const int& channel_id, const int& exclude_colo);
...
namespace AutoTest::ORM
{
  ...
  inline
  ChannelIdBasedStats::ChannelIdBasedStats (const int& channel_id, const int& exclude_colo)
    :Base("ChannelIdBasedStats")
  {
    key_ = Key (channel_id, exclude_colo);
  }
  inline
  ...
  inline
  ChannelIdBasedStats::Key::Key (const int& channel_id, const int& exclude_colo)
  ...
  inline
  ChannelIdBasedStats::Key&
  ChannelIdBasedStats::key (const int& channel_id, const int& exclude_colo)
  {
    key_ = Key (channel_id, exclude_colo);
    return key_;
  }
