    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const AutoTest::Time& pub_sdate, const int& tag_id, const double& cpm);
      };
      ...
      PublisherInventory (const AutoTest::Time& pub_sdate, const int& tag_id, const double& cpm);
      PublisherInventory ();
      Key& key ();
      Key& key (const Key& value);
      Key& key (const AutoTest::Time& pub_sdate, const int& tag_id, const double& cpm);
...
namespace AutoTest::ORM
{
  ...
  inline
  PublisherInventory::Key&
  PublisherInventory::key (const AutoTest::Time& pub_sdate, const int& tag_id, const double& cpm)
  {
    key_ = Key (pub_sdate, tag_id, cpm);
    return key_;
  }
