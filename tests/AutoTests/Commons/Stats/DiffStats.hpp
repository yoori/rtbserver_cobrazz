...
namespace AutoTest::ORM
{
  ...
  public:
     ...
     */
    DiffStats(const char* description);
    ...
    static void print_diff(std::ostream& out, const stats_diff_type& diff);

    static void print_diff(std::ostream& out, const Diffs& values);
    ...
    void print_diff(std::ostream& out, const Diffs& diff, const DiffStats<T, Count>& real) const;
  };
}
