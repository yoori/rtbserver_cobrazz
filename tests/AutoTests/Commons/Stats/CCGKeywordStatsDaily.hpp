    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const AutoTest::Time& adv_sdate, const int& ccg_keyword_id, const int& cc_id);
      };
      ...
      Key& key (const AutoTest::Time& adv_sdate, const int& ccg_keyword_id, const int& cc_id);
...
namespace AutoTest::ORM
{
  ...
  CCGKeywordStatsDaily::CCGKeywordStatsDaily (
    ...
    :Base("CCGKeywordStatsDaily")
  {
    key_ = Key (adv_sdate, ccg_keyword_id, cc_id);
  }
  inline
