    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const int& site_id, const int& exclude_colo);
      };
      ...
      SiteIdBasedStats (const int& site_id, const int& exclude_colo);
      SiteIdBasedStats ();
      Key& key ();
      Key& key (const Key& value);
      Key& key (const int& site_id, const int& exclude_colo);
...
namespace AutoTest::ORM
{
  ...
  inline
  SiteIdBasedStats::SiteIdBasedStats (const int& site_id, const int& exclude_colo)
    :Base("SiteIdBasedStats")
  {
    key_ = Key (site_id, exclude_colo);
  }
  inline
  ...
  inline
  SiteIdBasedStats::Key::Key (const int& site_id, const int& exclude_colo)
    :site_id_(site_id)
  {
    site_id_used_ = true;
    site_id_null_ = false;
  ...
  inline
  SiteIdBasedStats::Key&
  SiteIdBasedStats::key (const int& site_id, const int& exclude_colo)
  {
    key_ = Key (site_id, exclude_colo);
    return key_;
  }
