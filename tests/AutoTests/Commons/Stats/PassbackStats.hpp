    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const AutoTest::Time& sdate, const int& tag_id, const int& colo_id);
      };
      stats_value_type requests () const;
      void print_idname (std::ostream& out) const;

      PassbackStats (const Key& value);
      PassbackStats (const AutoTest::Time& sdate, const int& tag_id, const int& colo_id);
      PassbackStats ();
      Key& key ();
      Key& key (const Key& value);
      Key& key (const AutoTest::Time& sdate, const int& tag_id, const int& colo_id);
...
namespace AutoTest::ORM
{
  ...
  inline
  PassbackStats::PassbackStats (const AutoTest::Time& sdate, const int& tag_id, const int& colo_id)
    :Base("PassbackStats")
  {
    key_ = Key (sdate, tag_id, colo_id);
  }
  inline
  ...
  inline
  PassbackStats::Key::Key (const AutoTest::Time& sdate, const int& tag_id, const int& colo_id)
  ...
  inline
  PassbackStats::Key&
  PassbackStats::key (const AutoTest::Time& sdate, const int& tag_id, const int& colo_id)
  {
    key_ = Key (sdate, tag_id, colo_id);
    return key_;
  }
