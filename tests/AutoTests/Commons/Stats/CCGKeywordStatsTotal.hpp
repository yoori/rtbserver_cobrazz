    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const int& ccg_keyword_id, const int& cc_id);
      };
      ...
      CCGKeywordStatsTotal (const int& ccg_keyword_id, const int& cc_id);
      CCGKeywordStatsTotal ();
      Key& key ();
      Key& key (const Key& value);
      Key& key (const int& ccg_keyword_id, const int& cc_id);
...
namespace AutoTest::ORM
{
  ...
  inline
  CCGKeywordStatsTotal::CCGKeywordStatsTotal (const int& ccg_keyword_id, const int& cc_id)
    :Base("CCGKeywordStatsTotal")
  {
    key_ = Key (ccg_keyword_id, cc_id);
  }
  inline
  ...
  inline
  CCGKeywordStatsTotal::Key::Key (const int& ccg_keyword_id, const int& cc_id)
  ...
  inline
  CCGKeywordStatsTotal::Key&
  CCGKeywordStatsTotal::key (const int& ccg_keyword_id, const int& cc_id)
  {
    key_ = Key (ccg_keyword_id, cc_id);
    return key_;
  }
