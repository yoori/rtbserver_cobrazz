    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const AutoTest::Time& adv_sdate, const int& colo_id, const int& ccg_id);
      };
      stats_value_type auctions_lost () const;
      void print_idname (std::ostream& out) const;

      CcgAuctionStatsDaily (const Key& value);
      CcgAuctionStatsDaily (const AutoTest::Time& adv_sdate, const int& colo_id, const int& ccg_id);
      CcgAuctionStatsDaily ();
      Key& key ();
      Key& key (const Key& value);
      Key& key (const AutoTest::Time& adv_sdate, const int& colo_id, const int& ccg_id);
...
namespace AutoTest::ORM
{
  ...
  CcgAuctionStatsDaily::CcgAuctionStatsDaily (
    ...
    :Base("CcgAuctionStatsDaily")
  {
    key_ = Key (adv_sdate, colo_id, ccg_id);
  }
  inline
  ...
  inline
  CcgAuctionStatsDaily::Key&
  CcgAuctionStatsDaily::key (const AutoTest::Time& adv_sdate, const int& colo_id, const int& ccg_id)
  {
    key_ = Key (adv_sdate, colo_id, ccg_id);
    return key_;
  }
