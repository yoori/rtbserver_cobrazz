    ...
    public:
      class Key
      {
        ...
        public:
          ...
          Key ();
          Key (const int& channel_id, const AutoTest::Time& last_use);
      };
      ...
      ChannelPerformance (const int& channel_id, const AutoTest::Time& last_use);
      ChannelPerformance ();
      Key& key ();
      Key& key (const Key& value);
      Key& key (const int& channel_id, const AutoTest::Time& last_use);
...
namespace AutoTest::ORM
{
  ...
  inline
  ChannelPerformance::ChannelPerformance (const int& channel_id, const AutoTest::Time& last_use)
    :Base("ChannelPerformance")
  {
    key_ = Key (channel_id, last_use);
  }
  inline
  ...
  inline
  ChannelPerformance::Key::Key (const int& channel_id, const AutoTest::Time& last_use)
  ...
  inline
  ChannelPerformance::Key&
  ChannelPerformance::key (const int& channel_id, const AutoTest::Time& last_use)
  {
    key_ = Key (channel_id, last_use);
    return key_;
  }
