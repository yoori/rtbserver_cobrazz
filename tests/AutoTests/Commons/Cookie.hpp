...
namespace AutoTest::Cookie
{
  ...
  public:
     ...
     */
    UnitCookieList(const UnitCookieList& src, const std::string& domain)
      /*throw(eh::Exception)*/;
     ...
     */
    bool
    find_value(const std::string& name, std::string& value) const
      /*throw(eh::Exception)*/;
     ...
     */
    bool
    find_cookie(const std::string& name, HTTP::CookieDef& cookie)
      /*throw(eh::Exception)*/;
