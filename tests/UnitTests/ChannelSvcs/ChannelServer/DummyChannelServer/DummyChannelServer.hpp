...
{
  typedef AdServer::ChannelSvcs::ChannelUpdate_var ChannelCurrent;
}

namespace AdServer::UnitTests
{
  class DummyChannelServer:
    public virtual ReferenceCounting::ServantImpl
  ...
  public:
    ...
    void update_triggers(
      ...
      OBV_AdServer::ChannelSvcs::ChannelLoadSession::UpdateData_out
      /*throw(AdServer::ChannelSvcs::ImplementationException)*/;
  ...
  private:
    ...
    {
    public:
      FinishTask(DummyChannelServer* server_impl, Generics::TaskRunner* task_runner) noexcept;
