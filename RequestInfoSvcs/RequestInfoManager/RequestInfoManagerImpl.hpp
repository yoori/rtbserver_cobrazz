...
namespace AdServer::RequestInfoSvcs
{
  ...
  */
  ...
  public:
    ...
    AdServer::Commons::Awaitable<Generics::ConstSmartMemBuf_var>
    co_get_user_campaign_reach_profile(AdServer::Commons::UserId user_id);
    ...
    AdServer::Commons::Awaitable<Generics::ConstSmartMemBuf_var>
    co_get_user_fraud_protection_profile(AdServer::Commons::UserId user_id);

    AdServer::Commons::Awaitable<Generics::ConstSmartMemBuf_var>
    co_get_user_site_reach_profile(AdServer::Commons::UserId user_id);

    AdServer::Commons::Awaitable<Generics::ConstSmartMemBuf_var>
    co_get_user_tag_request_group_profile(AdServer::Commons::UserId user_id);
  ...
  private:
    ...
    void
    init_(const xsd::AdServer::Configuration::InLogsType& lp_config, InLogs& in_logs)
      noexcept;
...
namespace AdServer::RequestInfoSvcs
{
    ...
    noexcept
  {
    return user_campaign_reach_loaded &&
      ...
      passback_loaded &&
      user_site_reach_loaded && user_tag_request_merge_loaded && billing_processor_loaded;
  }
  ...
  RequestInfoManagerImpl::LoadTask::execute()
    noexcept
  {
    request_info_manager_impl_->load_data_(load_data_state_, data_loaded_, load_data_);
  }
