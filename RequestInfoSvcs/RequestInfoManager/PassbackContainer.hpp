...
namespace AdServer::RequestInfoSvcs
{
  ...
  using PassbackProcessor_var = ReferenceCounting::SmartPtr<PassbackProcessor>;
    ...
    public AdServer::Commons::RequestId
  {
    ...
    RequestIdTransactionHashAdapter(const AdServer::Commons::RequestId& request_id)
  ...
  using PassbackContainer_var = ReferenceCounting::SmartPtr<PassbackContainer>;
}
...
namespace AdServer::RequestInfoSvcs
{
  ...
  inline
  bool
  PassbackProcessor::PassbackInfo::operator==(const PassbackInfo& right) const
  {
  ...
  inline
  std::ostream&
  PassbackProcessor::PassbackInfo::print(std::ostream& ostr, const char* prefix) const
  {
