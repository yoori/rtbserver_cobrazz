...
namespace AdServer::RequestInfoSvcs
{
  ...
  public:
    ...
    void
    request_container_processor(RequestContainerProcessor* request_container_processor)
      noexcept;
  ...
  private:
    ...
    using UserActionInfoMap_var = ReferenceCounting::SmartPtr<UserActionInfoMap>;
    ...
    using DelegateCustomActionInfoList = std::list<DelegateCustomActionInfo>;
  ...
  using UserActionInfoContainer_var = ReferenceCounting::SmartPtr<UserActionInfoContainer>;
