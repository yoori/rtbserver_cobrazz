...
namespace AdServer::RequestInfoSvcs
{
  ...
  struct RequestInfo
  {
    ...
    struct RevenueSys: public Revenue
    {
      ...
      convert_impression(const RevenueDecimal& currency_rate)
        const /*throw(Exception, RevenueDecimal::Overflow)*/
      {
        return RevenueDecimal::mul(sys_impression(), currency_rate, Generics::DMR_CEIL);
      }
      ...
      convert_click(const RevenueDecimal& currency_rate)
        const /*throw(Exception, RevenueDecimal::Overflow)*/
      {
        return RevenueDecimal::mul(sys_click(), currency_rate, Generics::DMR_CEIL);
      }
      ...
      convert_action(const RevenueDecimal& currency_rate)
        const /*throw(Exception, RevenueDecimal::Overflow)*/
      {
        return RevenueDecimal::mul(sys_action(), currency_rate, Generics::DMR_CEIL);
      }
  ...
  */
  ...
  struct AdvCustomActionInfo
  {
    ...
    std::ostream& print(std::ostream& ostr, const char* space = "") const noexcept;
  };
    ...
    public virtual ReferenceCounting::Interface
  {
    ...
    {
      ProcessingState(RequestInfo::RequestState state_val = RequestInfo::RS_NORMAL)
        : state(state_val)
      {}
    ...
    co_process_request(const RequestInfo&, const ProcessingState&);
    ...
    virtual AdServer::Commons::Awaitable<void>
    co_process_action(const RequestInfo&);

    virtual void
    process_custom_action(const RequestInfo&, const AdvCustomActionInfo&)
      /*throw(Exception)*/
    {};
    ...
    public virtual ReferenceCounting::Interface
  {
    ...
    virtual void process_custom_action(const AdvExActionInfo& adv_action_info)
      /*throw(Exception)*/ = 0;

    virtual AdServer::Commons::Awaitable<void>
    co_process_custom_action(const AdvExActionInfo& adv_action_info);
    ...
    public virtual ReferenceCounting::Interface
  {
    ...
    virtual void process_click(const ClickInfo& click_info)
      /*throw(Exception)*/ = 0;

    virtual AdServer::Commons::Awaitable<void>
    co_process_click(const ClickInfo& click_info);
...
namespace AdServer::RequestInfoSvcs
{
  ...
  RequestActionProcessor::co_process_request(
    const RequestInfo& request_info,
    const ProcessingState& processing_state)
  {
    process_request(request_info, processing_state);
    co_return;
  }

  inline AdServer::Commons::Awaitable<void>
  RequestActionProcessor::co_process_impression(
    const RequestInfo& request_info,
    const ImpressionInfo& impression_info,
    const ProcessingState& processing_state)
  {
    process_impression(request_info, impression_info, processing_state);
    co_return;
  }

  inline AdServer::Commons::Awaitable<void>
  RequestActionProcessor::co_process_click(
    const RequestInfo& request_info,
    const ProcessingState& processing_state)
  {
    process_click(request_info, processing_state);
    co_return;
  }

  inline AdServer::Commons::Awaitable<void>
  RequestActionProcessor::co_process_action(const RequestInfo& request_info)
  {
    process_action(request_info);
    co_return;
  }

  inline AdServer::Commons::Awaitable<void>
  RequestActionProcessor::co_process_custom_action(
    const RequestInfo& request_info,
    const AdvCustomActionInfo& adv_custom_action_info)
  {
    process_custom_action(request_info, adv_custom_action_info);
    co_return;
  }
  ...
  inline AdServer::Commons::Awaitable<void>
  RequestContainerProcessor::co_process_request(const RequestInfo& request_info)
  {
  ...
  inline AdServer::Commons::Awaitable<void>
  RequestContainerProcessor::co_process_impression(const ImpressionInfo& impression_info)
  {
  ...
  inline AdServer::Commons::Awaitable<void>
  RequestContainerProcessor::co_process_action(
    ActionType action_type,
    const Generics::Time& time,
    const AdServer::Commons::RequestId& request_id)
  {
    process_action(action_type, time, request_id);
    co_return;
  }

  inline AdServer::Commons::Awaitable<void>
  RequestContainerProcessor::co_process_custom_action(
    const AdServer::Commons::RequestId& request_id,
    const AdvCustomActionInfo& adv_custom_action_info)
  {
    process_custom_action(request_id, adv_custom_action_info);
    co_return;
  }
  ...
  inline AdServer::Commons::Awaitable<void>
  AdvActionProcessor::co_process_adv_action(const AdvActionInfo& adv_action_info)
  {
    process_adv_action(adv_action_info);
    co_return;
  }

  inline AdServer::Commons::Awaitable<void>
  AdvActionProcessor::co_process_custom_action(const AdvExActionInfo& adv_action_info)
  {
    process_custom_action(adv_action_info);
    co_return;
  }

  inline AdServer::Commons::Awaitable<void>
  UnmergedClickProcessor::co_process_click(const ClickInfo& click_info)
  {
    process_click(click_info);
    co_return;
  }
  ...
  inline
  RequestInfo::RequestInfo(const AdServer::Commons::RequestId& req_id) noexcept
    : request_id(req_id),
      fraud(RS_NORMAL),
      test_request(false),
      walled_garden(false),
  ...
  RequestInfo::Revenue::operator*=(const RevenueDecimal& mul)
    /*throw(RevenueDecimal::Overflow)*/
  {
    impression = RevenueDecimal::mul(impression, mul, Generics::DMR_FLOOR);
  ...
  inline
  std::ostream&
  RequestInfo::Revenue::print(std::ostream& out, const char* space) const
    noexcept
  {
    out << space << "rate_id: " << rate_id << std::endl <<
      space << "impression: " << impression << std::endl <<
      space << "click: " << click << std::endl << space << "action: " << action << std::endl;
  ...
  inline
  std::ostream&
  RequestInfo::RevenueSys::print(std::ostream& out, const char* space) const
    noexcept
  {
  ...
  inline
  std::ostream&
  RequestInfo::print_request_state(std::ostream& out, RequestState request_state)
    noexcept
  {
  ...
  inline
  std::ostream&
  RequestInfo::print(std::ostream& out, const char* space) const
    noexcept
  {
    std::string add_space(space);
    add_space += " ";

    out << space << "request_id: " << request_id << std::endl << space << "fraud: ";
    ...
    out << space << "num_shown: " << num_shown << std::endl <<
      ...
      space << "country: " << country << std::endl << space << "channels: ";
    ...
    out << std::endl <<
      ...
      space << "referer_hash: " << referer_hash << std::endl << space << "geo_channels: ";
    Algs::print(out, geo_channels.begin(), geo_channels.end());
    out << std::endl << space << "user_channels: ";
    ...
    out << std::endl <<
      ...
      space << "ctr: " << ctr << std::endl << space << "model_ctrs: ";
  ...
  PubRevenue::operator==(const PubRevenue& right)
    const
  {
    return revenue_type == right.revenue_type && impression == right.impression;
  }

  inline std::ostream&
  ImpressionInfo::print(std::ostream& out, const char* space) const
    noexcept
  {
    out << space << "request_id: " << request_id << std::endl <<
      space << "time: " << time.gm_ft() << std::endl <<
      space << "verify_impression: " << verify_impression << std::endl <<
      space << "user_id: " << user_id << std::endl << space << "pub_revenue: ";
    if (pub_revenue.present())
    {
      out << "revenue_type=" << pub_revenue->revenue_type << ", imp=" << pub_revenue->impression;
    }
    else
    {
      out << "none";
  ...
  inline std::ostream&
  AdvCustomActionInfo::print(std::ostream& out, const char* space) const
    noexcept
  {
    out << space << "time: " << time.get_gm_time() << std::endl <<
      ...
      space << "order_id: " << order_id << std::endl << space << "action_value: " << action_value;
    return out;
  }

  /* AdvActionProcessor::AdvActionInfo */
  inline
  std::ostream& AdvActionProcessor::AdvActionInfo::print(std::ostream& out, const char* space) const
    noexcept
  {
    out << space << "time: " << time.get_gm_time() << std::endl <<
      space << "ccg_id: " << ccg_id << std::endl << space << "user_id: " << user_id << std::endl;
    ...
    noexcept
  {
    out << space << "time: " << time.get_gm_time() << std::endl <<
      ...
      space << "action_request_id: " << action_request_id << std::endl <<
      space << "user_id: " << user_id << std::endl <<
      space << "referer: " << referer << std::endl << space << "ccg_ids: ";
  ...
  inline
  std::ostream& UnmergedClickProcessor::ClickInfo::print(std::ostream& out, const char* space) const
    noexcept
  {
    out << space << "time: " << time.get_gm_time() << std::endl <<
