...
namespace RequestInfoSvcs
{
  ...
  RequestOperationLoader::co_read_impression_(
    ...
    /*throw(Exception)*/
  {
    static const char* FUN = "RequestOperationLoader::co_read_impression_()";
  ...
  RequestOperationLoader::co_read_action_(
    ...
    /*throw(Exception)*/
  {
    static const char* FUN = "RequestOperationLoader::co_read_action_()";
  ...
  Commons::Awaitable<void>
  RequestOperationLoader::co_read_request_action_(
    ProfilingCommons::FileReader& file_reader,
    Generics::MemBuf& membuf)
    /*throw(Exception)*/
  {
    static const char* FUN = "RequestOperationLoader::co_read_request_action_()";
