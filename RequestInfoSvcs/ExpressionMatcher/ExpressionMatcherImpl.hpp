...
namespace AdServer::RequestInfoSvcs
{
  ...
  public:
    ...
    co_get_inventory_profile(AdServer::Commons::UserId user_id);

    AdServer::Commons::Awaitable<Generics::ConstSmartMemBuf_var>
    co_get_user_trigger_match_profile(AdServer::Commons::UserId user_id, bool temporary_user);

    AdServer::Commons::Awaitable<Generics::ConstSmartMemBuf_var>
    co_get_request_trigger_match_profile(AdServer::Commons::RequestId request_id);
  ...
  protected:
    ...
    {
    public:
      TaskBase(ExpressionMatcherImpl* expression_matcher_impl, Generics::TaskRunner* task_runner)
        noexcept;
  ...
  private:
    ...
    void
    daily_check_users_(bool set_next_task, DailyCheckState* state) noexcept;
    ...
    fill_level_map_traits_(const xsd::AdServer::Configuration::LevelChunksConfigType& chunks_config)
      noexcept;
