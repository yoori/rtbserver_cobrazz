...
namespace AdServer::RequestInfoSvcs
{
  namespace
  {
    const ExpressionMatcherStatsImpl::Key OPTIN_USER("processedMatches-OptInUser-Count");
    const ExpressionMatcherStatsImpl::Key TEMPORARY_USER("processedMatches-temporaryUser-Count");
    const ExpressionMatcherStatsImpl::Key NOT_OPTIN_USER("processedMatches-nonOptInUser-Count");
