...
#include <xsd/UserInfoSvcs/UserInfoController2Config.hpp>

#include "UserInfoControllerGrpc.pb.h"

namespace AdServer::UserInfoSvcs
{
  class UserInfoController2Impl:
  ...
  protected:
    ~UserInfoController2Impl() noexcept override;
  ...
  using UserInfoController2Impl_var =
    ReferenceCounting::SmartPtr<UserInfoController2Impl>;
}

namespace AdServer::UserInfoSvcs
{
  class UserInfoController2Impl::InitUserInfoManagerSourceTask: public TaskBase
  {
  public:
  ...
  private:
    ...
    UserInfoController2Impl* controller_;
  };

  class UserInfoController2Impl::CheckUserInfoManagerStateTask: public TaskBase
  {
  public:
