...
namespace
{
  ...
  namespace Aspect
  {
    const char USER_INFO_CONTROLLER[] = "UserInfoController2";
  }
...
{
  UserInfoController2Impl::UserInfoController2Impl(
  ...
  UserInfoController2Impl::~UserInfoController2Impl() noexcept = default;

  void
  UserInfoController2Impl::fill_session_description(
    SessionDescription& response) const
  {
    ...
    {
      throw NotReady("UserInfoController2 isn't ready");
    }
  ...
  void
  UserInfoController2Impl::fill_refs_()
  {
  ...
  bool
  UserInfoController2Impl::get_user_info_manager_sources_(
  ...
  void
  UserInfoController2Impl::init_user_info_manager_state_() noexcept
  {
    try
    {
      UserInfoConfig_var user_info_config;
  ...
  void
  UserInfoController2Impl::check_user_info_manager_state_() noexcept
  {
    try
    {
      UserInfoConfig_var user_info_config;
  ...
  void
  UserInfoController2Impl::check_source_consistency_(
