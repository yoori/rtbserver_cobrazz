...
namespace
{
  ...
  const char USAGE[] =
    "\nUsage: \nUserBindAdmin2 <command> <command arguments>\n\n"
    "UserBindAdmin2 print-bind-request <bind request id> "
      "-r[--reference=]<user_bind_controller2_grpc_endpoint>|"
      "<user_bind_server_grpc_endpoint>\n"
    "UserBindAdmin2 add-user-id <external id> <user id> "
      "-r[--reference=]<grpc endpoint>\n"
    "UserBindAdmin2 get-user-id <external id> "
      "-r[--reference=]<grpc endpoint>\n\n";
