...
namespace
{
  ...
  namespace Aspect
  {
    const char USER_BIND_CONTROLLER[] = "UserBindController2";
  }
...
{
  UserBindController2Impl::UserBindController2Impl(
  ...
  UserBindController2Impl::~UserBindController2Impl() noexcept = default;

  void
  UserBindController2Impl::fill_session_description(
    SessionDescription& response) const
  {
    ...
    {
      throw NotReady("UserBindController2 isn't ready");
    }
  ...
  void
  UserBindController2Impl::fill_refs_()
  {
  ...
  bool
  UserBindController2Impl::get_user_bind_server_sources_(
  ...
  void
  UserBindController2Impl::init_user_bind_state_() noexcept
  {
    try
    {
      UserBindConfig_var user_bind_config;
  ...
  void
  UserBindController2Impl::check_user_bind_state_() noexcept
  {
    try
    {
      UserBindConfig_var user_bind_config;
  ...
  void
  UserBindController2Impl::check_source_consistency_(
