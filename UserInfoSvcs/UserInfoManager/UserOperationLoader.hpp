...
namespace AdServer::UserInfoSvcs
{
  ...
  protected:
    ...
    void read_match_operation_(Generics::SmartMemBuf* smart_mem_buf)
      /*throw(eh::Exception)*/;

    void read_merge_operation_(Generics::SmartMemBuf* smart_mem_buf)
      /*throw(eh::Exception)*/;

    void read_fc_update_operation_(Generics::SmartMemBuf* smart_mem_buf)
      /*throw(eh::Exception)*/;

    void read_fc_confirm_operation_(Generics::SmartMemBuf* smart_mem_buf)
      /*throw(eh::Exception)*/;
