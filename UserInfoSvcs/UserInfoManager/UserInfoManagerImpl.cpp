...
namespace UserInfoSvcs
{
      ...
      AdServer::UserInfoSvcs::UserInfoManager::ChunkNotFound)*/
  {
    ...
    metrics_raii ___tmp(composite_metrics_provider_,"UserInfoManagerImpl::get_user_profile",std::map<std::string,std::string>());
    try
    {
      UserInfoContainerAccessor user_info_container = get_user_info_container_();
      ...
      AdServer::UserInfoSvcs::UserInfoManager::ChunkNotFound)*/
  {
    ...
    metrics_raii ___tmp(composite_metrics_provider_,"UserInfoManagerImpl::match",std::map<std::string,std::string>());
    try
    {
