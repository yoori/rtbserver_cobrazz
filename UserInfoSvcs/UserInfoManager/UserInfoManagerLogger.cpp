...
namespace AdServer::UserInfoSvcs
{
  ...
  public:
    ...
    void
    process_history_optimization(const HistoryOptimizationInfo& ho_info)
      /*throw(Exception)*/;
  ...
  unsigned long
  UserInfoManagerLogger::HistoryOptimizationStatLogger::power2align_(unsigned long value)
  {
    ...
    /*throw(Exception)*/
  {
    ...
    try
    {
      ...
      {
        history_optimization_stat_logger_ = new HistoryOptimizationStatLogger(flush_traits);
  ...
  void
  UserInfoManagerLogger::process_history_optimization(const HistoryOptimizationInfo& ho_info)
    /*throw(Exception)*/
  {
    static const char* FUN = "UserInfoManagerLogger::process_history_optimization";
    try
    {
      history_optimization_stat_logger_->process_history_optimization(ho_info);
    }
