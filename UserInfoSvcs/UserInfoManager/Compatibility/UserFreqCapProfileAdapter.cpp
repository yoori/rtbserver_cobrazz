...
namespace AdServer::UserInfoSvcs_v340::UserInfoSvcsTarget
{
  using namespace ::AdServer::UserInfoSvcs;
}

namespace AdServer::UserInfoSvcs_v340
{
  void
  convert_to_v351(Generics::MemBuf& membuf)
  {
    UserInfoSvcsTarget::UserFreqCapProfileWriter profile_writer;
    profile_writer.version() = UserInfoSvcsTarget::CURRENT_FREQ_CAP_PROFILE_VERSION;
...
namespace AdServer::UserInfoSvcs_v291::UserInfoSvcsTarget
{
  using namespace ::AdServer::UserInfoSvcs_v340;
}

namespace AdServer::UserInfoSvcs_v291
{
  void
...
namespace AdServer::UserInfoSvcs_v290::UserInfoSvcsTarget
{
  using namespace ::AdServer::UserInfoSvcs_v330;
}

namespace AdServer::UserInfoSvcs_v290
{
  void
  convert_to_v291(Generics::MemBuf& membuf)
  {
    ...
    AdServer::UserInfoSvcs_v290::ProfileReader profile_reader(membuf.data(), membuf.size());
...
namespace AdServer::UserInfoSvcs
{
  ...
  UserFreqCapProfileAdapter::operator()(Generics::SmartMemBuf* mem_buf)
    /*throw(eh::Exception)*/
  {
    ...
    UserFreqCapProfileVersionReader version_reader(mem_buf->membuf().data(), version_head_size);
