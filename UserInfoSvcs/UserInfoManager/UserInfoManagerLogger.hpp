...
namespace AdServer::UserInfoSvcs
{
  ...
  public:
    ...
    UserInfoManagerLogger(const AdServer::LogProcessing::LogFlushTraits& flush_traits)
      /*throw(Exception)*/;

    virtual ~UserInfoManagerLogger() noexcept;

    void process_history_optimization(const HistoryOptimizationInfo& request_info)
      /*throw(Exception)*/;
