...
namespace AdServer::ProfilingCommons
{
  ...
  struct StringSerializer
  {
    ...
    {
      key = Generics::StringHashAdapter(std::string(static_cast<const char*>(buf), buf_size));
    }
...
namespace AdServer::ProfilingCommons
{
  ...
  inline
  UuidPackHashAdapter::UuidPackHashAdapter(const Generics::Uuid& init)
    : Generics::Uuid(init)
  {}
  ...
  inline
  void
  UuidAccessor::load(const void* buf, unsigned int size, Generics::Uuid& key)
    /*throw(eh::Exception)*/
  {
  ...
  inline
  void
  UuidAccessor::load(const void* buf, unsigned int size, UuidPackHashAdapter& key)
    /*throw(eh::Exception)*/
  {
    Generics::Uuid id;
    load(buf, size, id);
  ...
  inline
  void
  UuidAccessor::save(const Generics::Uuid& key, void* buf, unsigned int size)
    /*throw(eh::Exception)*/
  {
    if (key.size() > size)
    {
    ...
    ::memcpy(static_cast<char*>(buf), &*key.begin(), key.size());
  }

  inline
  void
  UuidAccessor::read(Generics::Uuid& key, const void* buf, unsigned long size)
    /*throw(eh::Exception)*/
  {
    load(buf, size, key);
  }
  ...
  inline
  void
  UuidAccessor::write(void* buf, unsigned long size, const Generics::Uuid& key)
    /*throw(eh::Exception)*/
  {
    if (key.size() > size)
    {
