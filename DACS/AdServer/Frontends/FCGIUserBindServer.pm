...
my $pid_file = "\${workspace_root}/run/FCGIUserBindServer.pid";
...
sub start
{
  ...
  my $command =
    "mkdir -p \${log_root}/FCGIUserBindServer \${workspace_root}/run && " .
    ...
    "setsid -f \${VALGRIND_PREFIX} FCGIServer " .
      ...
      " > \${workspace_root}/${AdServer::Path::OUT_FILE_BASE}FCGIUserBindServer.out 2>&1 < /dev/null";
