package AdServer::ChannelSvcs::ChannelController2;

use strict;
use AdServer::Functions;
use AdServer::Path;

my $pid_file = "\${workspace_root}/run/ChannelController2.pid";
...
sub start
{
  ...
  my $command =
   "mkdir -p \${log_root}/ChannelController2 \${workspace_root}/run && " .
   "rm -f $pid_file && " .
   "{ ".
