  ...
  export config_root=/opt/foros/server/etc/moscow-nb-adsat-central/adproxycluster-1
  ...
  export PERL5LIB=$PERL5LIB:$config_root/moscow-nb-adsat-central/adproxycluster-1/DACS
