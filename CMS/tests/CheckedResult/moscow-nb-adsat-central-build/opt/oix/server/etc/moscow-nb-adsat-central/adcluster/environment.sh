  ...
  config_root=/opt/foros/server/etc/moscow-nb-adsat-central/adcluster
  ...
  ZENOSS_DIR=/opt/zenoss/lib/foros/moscow-nb-adsat-central
  export ZENOSS_DIR
  ...
  PERL5LIB=$PERL5LIB:$config_root/moscow-nb-adsat-central/adcluster/DACS
