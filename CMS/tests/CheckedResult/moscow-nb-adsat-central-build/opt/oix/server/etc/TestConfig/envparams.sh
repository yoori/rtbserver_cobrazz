...
export tested_port=80

export tested_host=a.foros-nbadsat.net
...
export adserver_host=adsc-nbadsat0
export server_start_prefix="true"

export colocation_name=moscow-nb-adsat-central

export nb_hosts="adsc-nbadsat0 adsc-nbadsat1 adsp-nbadsat0 adsp-nbadsat1"
