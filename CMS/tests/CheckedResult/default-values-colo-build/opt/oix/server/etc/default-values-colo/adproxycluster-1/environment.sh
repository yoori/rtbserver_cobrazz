  ...
  export config_root=/opt/foros/server/etc/default-values-colo/adproxycluster-1
  ...
  export PERL5LIB=$PERL5LIB:$config_root/default-values-colo/adproxycluster-1/DACS
