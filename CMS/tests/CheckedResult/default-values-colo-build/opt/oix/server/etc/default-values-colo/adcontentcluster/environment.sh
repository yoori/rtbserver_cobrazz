  ...
  config_root=/opt/foros/server/etc/default-values-colo/adcontentcluster
  ...
  ZENOSS_DIR=/opt/zenoss/lib/foros/default-values-colo
  export ZENOSS_DIR
  ...
  PERL5LIB=$PERL5LIB:$config_root/default-values-colo/adcontentcluster/DACS
