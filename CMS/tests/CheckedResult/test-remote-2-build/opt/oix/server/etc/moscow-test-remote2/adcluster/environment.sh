  ...
  adserver_ssh_identity=/home/aduser/.ssh/adkey.moscow-test-remote2-2.0.0.0-cms20120702130103
  export adserver_ssh_identity

  server_root=/opt/foros/server
  server_bin_root=/opt/foros/server
  mib_root=/opt/foros/server/mibs
  config_root=/opt/foros/server/etc/moscow-test-remote2/adcluster
  ...
  PERL5LIB=$PERL5LIB:$config_root/moscow-test-remote2/adcluster/DACS
