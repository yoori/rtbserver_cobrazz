  ...
  adserver_ssh_identity=/home/aduser/.ssh/adkey.moscow-test-remote1-2.0.0.0-cms20120702130306
  export adserver_ssh_identity

  server_root=/opt/foros/server
  server_bin_root=/opt/foros/server
  mib_root=/opt/foros/server/mibs
  config_root=/opt/foros/server/etc/moscow-test-remote1/adcluster
  ...
  ZENOSS_DIR=/opt/zenoss/lib/foros/moscow-test-remote1
  export ZENOSS_DIR
  ...
  PERL5LIB=$PERL5LIB:$config_root/moscow-test-remote1/adcluster/DACS
