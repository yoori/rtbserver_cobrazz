  ...
  export server_bin_root=/home/jurij_kuznecov/projects/foros/server/trunk
  export config_root=/home/jurij_kuznecov/projects/foros/run/trunk/pbe-etc/devel/adproxycluster-1
  export data_root=/opt/foros/server/var/www
  export current_config_dir=$config_root/CurrentEnv
  export workspace_root=/home/jurij_kuznecov/projects/foros/run/trunk/pbe-var
  ...
  export PERL5LIB=$PERL5LIB:$config_root/devel/adproxycluster-1/DACS
