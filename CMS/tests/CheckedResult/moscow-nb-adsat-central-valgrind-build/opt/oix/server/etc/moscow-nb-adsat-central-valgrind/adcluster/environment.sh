  ...
  mib_root=/opt/foros/server/mibs
  config_root=/opt/foros/server/etc/moscow-nb-adsat-central-valgrind/adcluster
  ...
  ZENOSS_DIR=/opt/zenoss/lib/foros/moscow-nb-adsat-central-valgrind
  export ZENOSS_DIR
  ...
  export TNS_ADMIN
    ...
    VALGRIND_PREFIX="valgrind --tool=memcheck --leak-check=full --leak-resolution=high --trace-children=yes --suppressions=/opt/foros/server/data/oix-server.supp"
  ...
  PERL5LIB=$PERL5LIB:$config_root/moscow-nb-adsat-central-valgrind/adcluster/DACS
