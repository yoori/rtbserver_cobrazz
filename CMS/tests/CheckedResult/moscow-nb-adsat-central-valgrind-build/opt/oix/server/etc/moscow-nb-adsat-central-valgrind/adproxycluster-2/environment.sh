  ...
  export config_root=/opt/foros/server/etc/moscow-nb-adsat-central-valgrind/adproxycluster-2
  ...
  export PERL5LIB=$PERL5LIB:$config_root/moscow-nb-adsat-central-valgrind/adproxycluster-2/DACS
