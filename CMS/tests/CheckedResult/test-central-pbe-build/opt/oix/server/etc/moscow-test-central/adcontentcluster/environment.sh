  ...
  adserver_ssh_identity=/home/aduser/.ssh/adkey.moscow-test-central-2.0.0.0-cms20120629140323
  export adserver_ssh_identity

  server_root=/opt/foros/server
  server_bin_root=/opt/foros/server
  mib_root=/opt/foros/server/mibs
  config_root=/opt/foros/server/etc/moscow-test-central/adcontentcluster
  ...
  ZENOSS_DIR=/opt/zenoss/lib/foros/moscow-test-central
  export ZENOSS_DIR
  ...
  PERL5LIB=$PERL5LIB:$config_root/moscow-test-central/adcontentcluster/DACS
