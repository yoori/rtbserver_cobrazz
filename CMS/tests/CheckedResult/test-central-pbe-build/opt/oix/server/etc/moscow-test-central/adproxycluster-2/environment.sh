  ...
  export config_root=/opt/foros/server/etc/moscow-test-central/adproxycluster-2
  ...
  export PERL5LIB=$PERL5LIB:$config_root/moscow-test-central/adproxycluster-2/DACS
