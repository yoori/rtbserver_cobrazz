  ...
  export adserver_ssh_identity=/home/aduser/.ssh/adkey.moscow-test-central-2.0.0.0-cms20120629140323

  export server_root=/opt/foros/server
  export server_bin_root=/opt/foros/server
  export config_root=/opt/foros/server/etc/moscow-test-central/adproxycluster-1
  ...
  export PERL5LIB=$PERL5LIB:$config_root/moscow-test-central/adproxycluster-1/DACS
