  ...
  config_root=/opt/foros/server/etc/channel-groups/adcluster
  ...
  ZENOSS_DIR=/opt/zenoss/lib/foros/channel-groups
  export ZENOSS_DIR
  ...
  PERL5LIB=$PERL5LIB:$config_root/channel-groups/adcluster/DACS
