  ...
  export config_root=/opt/foros/server/etc/verify/adproxycluster-1
  export data_root=/opt/foros/server/var/www
  export current_config_dir=$config_root/CurrentEnv
  export workspace_root=/opt/foros/server/var/AdProxyCluster
  ...
  export PERL5LIB=$PERL5LIB:$config_root/verify/adproxycluster-1/DACS
