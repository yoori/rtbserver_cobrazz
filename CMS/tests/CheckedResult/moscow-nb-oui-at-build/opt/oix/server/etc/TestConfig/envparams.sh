...
export tested_host=a.foros-nbouiat.net
...
export db_user=BS_NIGHTLY_BUILDS_OIX_AUTO
...
export adserver_host=ads-nbouiat
export server_start_prefix="true"

export colocation_name=moscow-nb-oui-at

export nb_hosts="ads-nbouiat"
