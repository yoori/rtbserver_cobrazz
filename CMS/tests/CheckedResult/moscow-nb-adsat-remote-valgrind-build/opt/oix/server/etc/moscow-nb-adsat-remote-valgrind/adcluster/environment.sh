  ...
  config_root=/opt/foros/server/etc/moscow-nb-adsat-remote-valgrind/adcluster
  ...
  PERL5LIB=$PERL5LIB:$config_root/moscow-nb-adsat-remote-valgrind/adcluster/DACS
