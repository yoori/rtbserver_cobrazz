...

{
  ...
  "check_roots": [
    ...
    "<xsl:value-of
      select="concat($workspace-root, '/log/Predictor/ResearchLogs/ResearchPostImpression')"/>",
    "<xsl:value-of select="concat($workspace-root, '/log/Predictor/ResearchLogs/ResearchPostClick')"/>",
