...
function(add_xsd _target _xsdfile target_dir)
  ...
  set(FINDXSD_TARGET ${_target}_gen)
  add_custom_target(${FINDXSD_TARGET} DEPENDS ${OUTPUTCPP} ${OUTPUTHPP})
  ...
  add_dependencies(${_target} ${FINDXSD_TARGET})
  target_compile_definitions(${_target} INTERFACE -DXSD_CXX11)
