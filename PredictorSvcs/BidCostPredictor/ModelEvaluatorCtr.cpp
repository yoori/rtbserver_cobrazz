  ...
  ModelCtr& model)
{
  ...
  for (; it != it_end; ++it)
  {
    ...
    const auto it_creative_catigories = cc_id_to_categories.find(cc_id);
    const auto& creative_catigories = it_creative_catigories == std::end(cc_id_to_categories) ?
      empty_creative_category_ids : it_creative_catigories->second;
    auto it_category = creative_catigories.begin();
    ...
    if (total_imps >= trust_imps_)
    {
      ...
      (*url == "?" || it_category == std::end(creative_catigories)))
    {
    ...
    do
    {
      ...
      if (it_category != std::end(creative_catigories))
      {
    ...
    while (it_category != std::end(creative_catigories));
  }
