#ifndef BIDDINGFRONTENDGRPC_JSONPARAMPROCESSOR_HPP
#define BIDDINGFRONTENDGRPC_JSONPARAMPROCESSOR_HPP
...
namespace AdServer::Bidding::Grpc
{
  ...
  struct JsonAdSlotProcessingContext
  {
    ...
    protected:
      ~Banner() noexcept override = default;
    };
...
#endif /*BIDDINGFRONTENDGRPC_JSONPARAMPROCESSOR_HPP*/
