...
namespace Request
{
  namespace Context
  {
    const std::string PUBLISHER_ACCOUNT_ID = "aid";
    const std::string PUBLISHER_SITE_ID = "sid";
    const std::string RANDOM = "random";
    const std::string FLAG = "f";
    const std::string FORMAT = "format";
    const std::string LOCATION_NAME = "loc.name";

    namespace Grpc
    {
      const std::string SOURCE_ID = "src";
    }
  }

  namespace Debug
  {
    const std::string EXPECTED_CCG = "debug.ccg";
    const std::string CURRENT_TIME = "debug.time";
    const std::string ADSLOTS_SIZE = "debug.size";
    const std::string AD_SLOT = "debug.adslot";
  ...
  namespace OpenRtb
  {
    ...
    const std::string MAX_PROCESSING_TIME = "tmax";
    const std::string IMP = "imp";
    const std::string BADV = "badv"; // ?
    const std::string SITE = "site";
    const std::string APP = "app";
    const std::string CURRENCY = "cur";
    const std::string DEVICE = "device";
    const std::string USER = "user";
    const std::string BLOCKED_CATEGORIES = "bcat";
    const std::string EXT = "ext";
    const std::string EXT_TEST = "is_test";
    const std::string EXT_SECURE = "secure";
    const std::string EXT_UDI = "udi";
    const std::string EXT_GAID = "gaid";
    const std::string EXT_IDFA = "idfa";
    const std::string TEST = "test";
    const std::string PUBLISHER = "publisher";

    const std::string IMP_ID = "id";
    const std::string IMP_MIN_CPM_PRICE = "bidfloor";
    const std::string IMP_MIN_CPM_PRICE_CURRENCY_CODE = "bidfloorcur";
    const std::string IMP_SECURE = "secure";

    // ext
    const std::string IMP_EXT = "ext";
    const std::string IMP_EXT_TYPE = "type";

    // banner
    const std::string IMP_BANNER = "banner";
    const std::string IMP_BANNERS = "banners";
    const std::string IMP_BANNER_POS = "pos";
    const std::string IMP_BANNER_BLOCKED_CATEGORIES = "battr";
    const std::string IMP_BANNER_EXT_BLOCKED_CATEGORIES = "bcont";
    const std::string IMP_BANNER_EXT_MATCHING_AD = "matching_ad_id";
    const std::string IMP_BANNER_FORMAT = "format";

    const std::string IMP_BANNER_WIDTH = "w";
    const std::string IMP_BANNER_HEIGHT = "h";
    const std::string IMP_BANNER_EXT = "ext";
    const std::string IMP_BANNER_EXT_TYPE = "type";
    const std::string IMP_BANNER_EXT_FORMAT = "fmt";
    const std::string IMP_BANNER_EXT_OVERLAY = "overlay";
    const std::string IMP_BANNER_EXT_HPOS = "hpos";

    // video
    const std::string IMP_VIDEO = "video";
    const std::string IMP_VIDEO_WIDTH = "w";
    const std::string IMP_VIDEO_HEIGHT = "h";
    const std::string IMP_VIDEO_POS = "pos";
    const std::string IMP_VIDEO_BLOCKED_CATEGORIES = "battr";
    const std::string IMP_VIDEO_MIMES = "mimes";
    const std::string IMP_VIDEO_MINDURATION = "minduration";
    const std::string IMP_VIDEO_MAXDURATION = "maxduration";
    const std::string IMP_VIDEO_PROTOCOL = "protocol";
    const std::string IMP_VIDEO_PROTOCOLS = "protocols";
    const std::string IMP_VIDEO_PLAYBACKMETHOD = "playbackmethod";
    const std::string IMP_VIDEO_STARTDELAY = "startdelay";
    const std::string IMP_VIDEO_LINEARITY = "linearity";
    const std::string IMP_VIDEO_EXT = "ext";
    ...
    const std::string SITE_NAME = "name";
    const std::string SITE_ID = "id";
    const std::string SITE_EXT = "ext";
    const std::string SITE_EXT_SECURE = "ssl_enabled";
    const std::string SITE_EXT_PUID1 = "puid1";
    const std::string SITE_EXT_PUID2 = "puid2";
    const std::string SITE_KEYWORDS = "keywords";
    const std::string SITE_PAGECAT = "pagecat";
    const std::string SITE_SECTIONCAT = "sectioncat";
    const std::string SITE_CAT = "cat";
    const std::string SITE_SEARCH = "search";
    const std::string SITE_REF = "ref";
    const std::string SITE_REFERER = "referer";
    const std::string SITE_REREFERER = "rereferer";

    const std::string APP_ID = "id";
    const std::string APP_NAME = "name";
    const std::string APP_BUNDLE = "bundle";
    const std::string APP_DOMAIN = "domain";
    const std::string APP_STORE_URL = "storeurl";
    const std::string APP_KEYWORDS = "keywords";
    const std::string APP_PAGECAT = "pagecat";
    const std::string APP_SECTIONCAT = "sectioncat";
    const std::string APP_CAT = "cat";

    // content
    const std::string CONTENT = "content";
    const std::string CONTENT_KEYWORDS = "keywords";
    const std::string CONTENT_TITLE = "title";
    const std::string CONTENT_SERIES = "series";
    const std::string CONTENT_SEASON = "season";
    const std::string CONTENT_CAT = "cat";

    // device
    const std::string DEVICE_IP = "ip";
    const std::string DEVICE_IPv6 = "ipv6";
    const std::string DEVICE_USER_AGENT = "ua";
    const std::string DEVICE_USER_DATA = "userdata";
    const std::string DEVICE_IFA = "ifa";
    const std::string DEVICE_DIDMD5 = "didmd5";
    const std::string DEVICE_DIDSHA1 = "didsha1";
    const std::string DEVICE_DPIDMD5 = "dpidmd5";
    const std::string DEVICE_DPISHA1 = "dpisha1";
    const std::string DEVICE_MACSHA1 = "macsha1";
    const std::string DEVICE_MACMD5 = "macmd5";
    const std::string DEVICE_LANGUAGE = "language";
    const std::string DEVICE_CARRIER = "carrier";
    const std::string DEVICE_GEO = "geo";
    const std::string DEVICE_GEO_COUNTRY = "country";
    const std::string DEVICE_GEO_REGION = "region";
    const std::string DEVICE_GEO_CITY = "city";
    const std::string DEVICE_DEVICETYPE = "devicetype";

    // regs
    const std::string REGS = "regs";
    const std::string REGS_COPPA = "coppa";
    
    // pmp
    const std::string PMP = "pmp";
    const std::string PMP_PRIVATE_AUCTION = "private_auction";
    const std::string PMP_DEALS = "deals";
    const std::string PMP_DEAL_ID = "id";
    const std::string PMP_DEAL_CPM_PRICE = "bidfloor";
    const std::string PMP_DEAL_CURRENCY_CODE = "bidfloorcur";

    // user
    const std::string USER_ID = "id";
    const std::string BUYER_ID = "buyeruid";
    const std::string BUYER_ID2 = "buyerid";
    const std::string USER_YOB = "yob";
    const std::string USER_GENDER = "gender";
    const std::string USER_KEYWORDS = "keywords";

    const std::string USER_DATA = "data";
    const std::string USER_DATA_SEGMENT = "segment";
    const std::string USER_SEGMENT_ID = "id";
    const std::string USER_SEGMENT_NAME = "name";
    const std::string USER_SEGMENT_VALUE = "value";

    // user.ext
    const std::string USER_EXT = "ext"; // user.ext
    const std::string USER_EXT_EIDS = "eids"; // user.ext.eids
    const std::string USER_EXT_EIDS_SOURCE = "source"; // user.ext.eids*.source
    const std::string USER_EXT_EIDS_UIDS = "uids"; // user.ext.eids*.uids -> JsonUserEidUidParamProcessor
    const std::string USER_EXT_EIDS_UIDS_ID = "id"; // user.ext.eids*.uids*.id
    const std::string USER_EXT_EIDS_UIDS_STABLEID = "stableid"; // user.ext.eids*.uids*.stableid

    // publisher
    const std::string PUBLISHER_NAME = "name";
    const std::string PUBLISHER_ID = "id";
    const std::string PUBLISHER_CAT = "cat";

    // producer
    const std::string PRODUCER = "producer";
    const std::string PRODUCER_NAME = "name";

    // ext
    const std::string EXT_CATEGORY = "category";

    // ADSC-10919
    const std::string DEFAULT_BIDFLOORCUR_CURRENCY = "usd";

    const std::string VIDEO_PLACEMENT_NONE = "none";
    ...
    {
      String::SubString("videotypeunskip"),
      String::SubString("videotypeskip")
    };

    const String::SubString VIDEO_REWARDS[] =
    {
      String::SubString("videotypenonward"),
      String::SubString("videotypereward")
    };

    const unsigned long VIDEO_PLAYBACKMETHOD_SOUND_ON(1);
    const unsigned long VIDEO_PLAYBACKMETHOD_SOUND_OFF(2);
    const String::SubString VIDEO_SOUND_ON("soundon");
    const String::SubString VIDEO_SOUND_OFF("soundoff");

    const String::SubString VIDEO_PLACEMENTS_STREAM_NAMES[] =
    {
      String::SubString(""),
      String::SubString("videotypeinstream"),
      String::SubString("videotypebanner"),
      String::SubString("videotypearticle"),
      String::SubString("videotypefeed"),
      String::SubString("videotypeinterstitial")
    };
    ...
    const String::SubString VIDEO_TYPE_OUT_STREAM_NAME("videotypeoutstream");

    const long VIDEO_START_DELAY_TYPE_PRE(0);
    const long VIDEO_START_DELAY_TYPE_POST(-2);
    const String::SubString VIDEO_TYPE_PRE("videotypepre");
    const String::SubString VIDEO_TYPE_MID("videotypemid");
    const String::SubString VIDEO_TYPE_POST("videotypepost");
    ...
    const std::string NATIVE_REQUEST = "request";
    const std::string NATIVE_VER = "ver";
    const std::string NATIVE_PLACEMENT = "plcmttype";
    ...
    const std::string NATIVE_ASSET_IMAGE = "img";
    const std::string NATIVE_ASSET_VIDEO = "video";
    const std::string NATIVE_ASSET_TITLE_LEN = "len";
    const std::string NATIVE_ASSET_DATA_TYPE = "type";
    const std::string NATIVE_ASSET_DATA_LEN = "len";
    const std::string NATIVE_ASSET_IMAGE_TYPE = "type";
    const std::string NATIVE_ASSET_IMAGE_WIDTH = "w";
    const std::string NATIVE_ASSET_IMAGE_HEIGHT = "h";
    const std::string NATIVE_ASSET_IMAGE_WMIN = "wmin";
    const std::string NATIVE_ASSET_IMAGE_HMIN = "hmin";
    const std::string NATIVE_ASSET_IMAGE_MIMES = "mimes";
    const std::string NATIVE_ASSET_VIDEO_MIMES = "mimes";
    const std::string NATIVE_ASSET_VIDEO_PROTOCOLS = "protocols";
    const std::string NATIVE_ASSET_VIDEO_MIN_DURATION = "minduration";
    const std::string NATIVE_ASSET_VIDEO_MAX_DURATION = "maxduration";

    const std::string NATIVE_DATA_ASSET_TOKENS[] =
    {
    ...
    const std::string NATIVE_IMAGE_ASSET_TOKENS[] =
    {
  ...
  namespace AppNexus
  {
    const std::string REQUEST = "bid_request";

    const std::string REQUEST_DEBUGREQUESTED = "debug_requested";
    const std::string REQUEST_TEST = "test";
    const std::string REQUEST_TAGS = "tags";
    const std::string REQUEST_BIDINFO = "bid_info";
    const std::string REQUEST_MEMBERS = "members";

    const std::string REQUEST_TAG_ID = "id";
    const std::string REQUEST_TAG_SIZES = "sizes";
    const std::string REQUEST_TAG_AUCTIONID = "auction_id_64";
    const std::string REQUEST_TAG_MINCPMPRICE = "reserve_price";
    const std::string REQUEST_TAG_CREATIVEFORMATS = "creative_formats";
    const std::string REQUEST_TAG_ALLOWEDMEDIATYPES = "allowed_media_types";
    const std::string REQUEST_TAG_ALLOWEDMEDIASUBTYPES = "allowed_media_subtypes";
    const std::string REQUEST_TAG_PREDICTED_VIEW_RATE = "predicted_view_rate";
    const std::string REQUEST_TAG_POS = "position";
    const std::string REQUEST_TAG_SITE_ID = "site_id";
    const std::string REQUEST_TAG_INVENTORY_SOURCE_ID = "inventory_source_id";

    const std::string REQUEST_BIDINFO_USERID = "user_id_64";
    const std::string REQUEST_BIDINFO_IP = "ip_address";
    const std::string REQUEST_BIDINFO_USERAGENT = "user_agent";
    const std::string REQUEST_BIDINFO_URL = "url";
    const std::string REQUEST_BIDINFO_GENDER = "gender";
    const std::string REQUEST_BIDINFO_AGE = "age";
    const std::string REQUEST_BIDINFO_APPID = "app_id";
    const std::string REQUEST_BIDINFO_SELLING_MEMBER_ID = "selling_member_id";
    const std::string REQUEST_BIDINFO_NO_FLASH = "no_flash";

    const std::string REQUEST_MEMBERS_ID = "id";

    const std::string USER = "user";
    const std::string USER_AGE = "age";
    const std::string USER_GENDER = "gender";
    const std::string INVENTORY_AUDITS = "inventory_audits";
    const std::string CONTENT_CATEGORIES = "content_categories";
  }
}
...
namespace AdServer::Bidding::Grpc
{
  namespace Google
  {
    const std::string APPLICATION = "google";
    const std::string APPLICATION_VERSION = "1";
    const std::string APP_FORMAT = "html";
    ...
    const std::string CREATIVETYPE_FLASH_STR("34");
  ...
  {
    // AppNexus
    const std::string APPNEXUS_APP_FORMAT = "js";
    const std::string APPNEXUS_APPLICATION = "appnexus";
    const std::string APPNEXUS_APPLICATION_VERSION = "1";

    // Openrtb
    const std::string OPENRTB_APPLICATION = "openrtb";
    const std::string OPENRTB_APPLICATION_VERSION = "1";
    const std::string OPENRTB_APP_FORMAT = "html";
    const std::string OPENRTB_VAST_APP_FORMAT = "vast";
    const std::string OPENRTB_NATIVE_APP_FORMAT = "native";
    const std::string VAST_PROTOCOL_SIZE = "vast";
    ...
    typedef AdServer::Bidding::Grpc::JsonAdSlotProcessingContext::Native Native;
    ...
    void fill_token(
      FrontendCommons::GrpcCampaignManagerPool::NativeDataToken&,
      const NativeData&)
    {
    }

    void fill_token(
      FrontendCommons::GrpcCampaignManagerPool::NativeImageToken& res_token,
    ...
    fill_asset_tokens(
      ...
      const std::string(&dict)[DictSize],
      long AssetSeq::value_type::* type_field)
    {
      res_seq.reserve(assets.size());
      for (const auto& asset : assets)
      {
        const long asset_type = asset.*type_field;
        ...
        else
        {
          ...
          {
            res_seq.emplace_back(dict[asset_type], asset.required);
            auto& element = res_seq.back();
            fill_token(element, asset);
          }
        }
      }
    ...
    fill_video_size(
      ...
      FrontendCommons::GrpcCampaignManagerPool::AdSlotInfo& ad_slot_request,
      unsigned long width,
      unsigned long height)
    {
      std::string oss;
  ...
  public:
    ...
    virtual void
    process(
      FrontendCommons::GrpcCampaignManagerPool::RequestParams&
        request_params,
  ...
  protected:
    ~JsonAssetProcessor() noexcept override = default;
    ...
    /*throw(InvalidParamException, Exception)*/
  {
    ...
    {
      auto& ad_slot_request = request_params.ad_slots[slot_i];
      ...
      ad_slot_request.exclude_categories.reserve(
      ...
      if(slot_is_video && !video_passback)
      {
        if(bid_request.has_video())
        {
          ...
          {
            ad_slot_request.exclude_categories.emplace_back(CreativeCategory::VPAID1);
            ad_slot_request.exclude_categories.emplace_back(CreativeCategory::VPAID2);
          }
        }
        else
        {
      ...
      {
        ad_slot_request.exclude_categories.emplace_back(Google::CREATIVETYPE_FLASH_STR);
      }
          ...
          cat_i < adslot.excluded_sensitive_category_size(); ++cat_i)
      {
        ...
        if(len > 0)
        {
          ad_slot_request.exclude_categories.emplace_back(std::string_view(cat_str, len));
        }
      }
      ...
      if(slot_is_video)
      {
        ...
        ad_slot_request.sizes.emplace_back(VAST_PROTOCOL_SIZE);
        ...
        if(bid_request.has_video())
        {
          ...
          kw_fmt.add_dict_keyword(
            ...
            video.has_placement() ?
              get_value_from_seq(
                Bidding::Grpc::Google::VIDEO_PLACEMENTS,
                  video.placement()):
      ...
      else
      {
        ...
        {
          ad_slot_request.sizes.emplace_back(size_it->second);
        }
        else if (!request_info.default_debug_size.empty())
        {
          ad_slot_request.sizes.emplace_back(request_info.default_debug_size);
        }
        else if (adslot.width_size())
        {
          ...
          else
          {
            ...
            ad_slot_request.sizes.emplace_back(
              oss.str().data(),
              oss.str().size());
          }
        }
      ...
      if(test_value_in_set(excluded_attributes, Google::NON_SECURE) &&
        request_params.common_info.creative_instantiate_type.empty())
      {
        request_params.common_info.creative_instantiate_type.append(
    ...
    // fill creative_instantiate_type if was not filled by fill_by_referer_
    if(request_params.common_info.creative_instantiate_type.empty())
    {
      request_params.common_info.creative_instantiate_type.append(
        FrontendCommons::UNSECURE_INSTANTIATE_TYPE.text().data(),
        FrontendCommons::UNSECURE_INSTANTIATE_TYPE.text().size());
    }
    ...
    noexcept
  {
    ...
    if(source_it != sources_.end())
    {
      ...
      {
        request_params.publisher_account_ids.emplace_back(*(source_it->second.default_account_id));
      }
    ...
    /*throw(InvalidParamException, Exception)*/
  {
          ...
          debug_sizes.empty() && default_debug_size.empty()))
      {
        ...
        if (!parse_request_error_flag && slot_it->video)
        {
         // ADSC-10919
          ...
          if (std::find(
              ...
              != slot_it->video_playbackmethods->end())
          {
            kw_fmt.add_dict_keyword(String::SubString(), Request::OpenRtb::VIDEO_SOUND_ON, false);
          }
          if (std::find(
                slot_it->video_playbackmethods->begin(),
                slot_it->video_playbackmethods->end(),
              ...
              != slot_it->video_playbackmethods->end())
          {
            kw_fmt.add_dict_keyword(String::SubString(), Request::OpenRtb::VIDEO_SOUND_OFF, false);
          }
        }
	    ...
	    false);
          ...
          if (std::find(
              ...
              != Request::OpenRtb::VIDEO_PLACEMENTS_OUT_STREAM_INDEXES.end())
          {
              kw_fmt.add_dict_keyword(String::SubString(), Request::OpenRtb::VIDEO_TYPE_OUT_STREAM_NAME, false);
          }
        }
        ...
        if (!slot_it->video_start_delay.empty())
        {
          ...
          {
              kw_fmt.add_dict_keyword(String::SubString(), Request::OpenRtb::VIDEO_TYPE_PRE, false);
          }
          else if (*slot_it->video_start_delay > Request::OpenRtb::VIDEO_START_DELAY_TYPE_PRE)
          {
              kw_fmt.add_dict_keyword(String::SubString(), Request::OpenRtb::VIDEO_TYPE_MID, false);
          }
          else if (*slot_it->video_start_delay == Request::OpenRtb::VIDEO_START_DELAY_TYPE_POST)
          {
              kw_fmt.add_dict_keyword(String::SubString(), Request::OpenRtb::VIDEO_TYPE_POST, false);
          }
        }
        ...
        auto& ad_slot_request = request_params.ad_slots.back();
        ...
        ad_slot_request.exclude_categories.reserve(
          context.exclude_categories.size());
        ad_slot_request.exclude_categories.insert(
          std::end(ad_slot_request.exclude_categories),
          std::begin(context.exclude_categories),
          std::end(context.exclude_categories));

        if(!request_info.skip_ext_category &&
          !context.required_category.empty() &&
          context.required_category != "0")
        {
          ad_slot_request.required_categories.emplace_back(
            context.required_category);
        }
            ...
            debug_sizes.empty() && default_debug_size.empty()))
        {
          ...
          if(serve_video)
          {
            ...
            excluded_api_categories.reserve(2);
            ...
            else
            {
              ...
              {
                excluded_api_categories.emplace_back(CreativeCategory::VPAID1);
              }

              if(slot_it->video_api->find(2) == slot_it->video_api->end())
              {
                excluded_api_categories.emplace_back(CreativeCategory::VPAID2);
              }
            }

            ad_slot_request.exclude_categories.reserve(
              ad_slot_request.exclude_categories.size()
                + excluded_api_categories.size()
                + slot_it->video_exclude_categories.size());

            ad_slot_request.exclude_categories.insert(
              std::end(ad_slot_request.exclude_categories),
              std::begin(excluded_api_categories),
              std::end(excluded_api_categories));

            ad_slot_request.exclude_categories.insert(
              std::end(ad_slot_request.exclude_categories),
              std::begin(slot_it->video_exclude_categories),
              std::end(slot_it->video_exclude_categories));
          }

          ad_slot_request.passback = request_info.filter_request || !serve_video;
          if(slot_it->video_max_duration.present())
          {
            ad_slot_request.video_max_duration = static_cast<std::int32_t>(
        ...
        else if (slot_it->native)
        {
          ...
          else if(serve_native)
          {
            ...
            else if(main_image_found)
            {
              ...
              ad_slot_request.sizes.emplace_back(oss.str().data(), oss.str().size());
            }
            else
            {
              ad_slot_request.sizes.emplace_back(NATIVE_TEXT_SIZE);
            }
          }
        ...
        else // banners not empty here
        {
          ...
          ad_slot_request.sizes.reserve(banner_format_count);
          for(auto banner_it = slot_it->banners.rbegin();
              banner_it != slot_it->banners.rend(); ++banner_it)
          {
            ...
            ad_slot_request.exclude_categories.reserve(
              ad_slot_request.exclude_categories.size()
                + banner.exclude_categories.size());
            ad_slot_request.exclude_categories.insert(
              std::end(ad_slot_request.exclude_categories),
              std::begin(banner.exclude_categories),
              std::end(banner.exclude_categories));
            ...
            if(!skip_sizes)
            {
                  ...
                  banner_format_it != banner.formats.end(); ++banner_format_it)
              {
                ...
                {
                  ad_slot_request.sizes.emplace_back(RM_SIZE);
                ...
                {
                  ad_slot_request.sizes.emplace_back(POPUP_SIZE);
                  slot_it->size_banner.insert(std::make_pair(
                    POPUP_SIZE,
                    JsonAdSlotProcessingContext::BannerFormatHolder(*banner_it, *banner_format_it)));
                }
                ...
                {
                  ad_slot_request.sizes.emplace_back(RM_DTO_SIZE);
                  slot_it->size_banner.insert(std::make_pair(
                    RM_DTO_SIZE,
                    JsonAdSlotProcessingContext::BannerFormatHolder(*banner_it, *banner_format_it)));
                }
                ...
                {
                  ad_slot_request.sizes.emplace_back(RM_RICH_SIZE);
                  slot_it->size_banner.insert(std::make_pair(
                    RM_RICH_SIZE,
                    JsonAdSlotProcessingContext::BannerFormatHolder(*banner_it, *banner_format_it)));
                }
                else if(!banner_format.width.empty() && !banner_format.height.empty())
                {
                  ...
                  ad_slot_request.sizes.emplace_back(res_size);
                  slot_it->size_banner.insert(std::make_pair(
                    res_size,
                    JsonAdSlotProcessingContext::BannerFormatHolder(*banner_it, *banner_format_it)));
                }
        ...
        if(!context.currencies.empty())
        {
          ad_slot_request.currency_codes.reserve(context.currencies.size());
          ad_slot_request.currency_codes.insert(
            std::end(ad_slot_request.currency_codes),
            std::begin(context.currencies),
            std::end(context.currencies));
        }
        else if(!slot_it->min_cpm_price_currency_code.empty())
        {
          ad_slot_request.currency_codes.emplace_back(
            slot_it->min_cpm_price_currency_code);
        }
        ...
        {
          ad_slot_request.tokens.emplace_back(
            "SSP_VIDEO_PLACEMENT",
    ...
    if(!context.puid1.empty() || !context.puid2.empty())
    {
      ...
      request_params.common_info.ext_track_params = std::move(ext_track_params);
    }
    ...
    /*throw(InvalidParamException, Exception)*/
  {
    ...
    for(JsonAdSlotProcessingContextList::const_iterator
          ...
          ++slot_iter)
    {
      for(auto ul_set_iter = slot_iter->inventory_audits_content_categories.begin();
        ...
        slot_it != context.ad_slots.end(); )
    {
      ...
      if (slot_it->allowed_media_types.find(4) != slot_it->allowed_media_types.end())
      {
        ...
        ad_slot_request.allowed_durations.reserve(allowed_durations.size());
        ad_slot_request.allowed_durations.insert(
          std::end(ad_slot_request.allowed_durations),
          std::begin(allowed_durations),
          std::end(allowed_durations));
      }
      else
      {
      ...
      ad_slot_request.exclude_categories.reserve(context.exclude_categories.size() + 1);
      ad_slot_request.exclude_categories.insert(
        std::end(ad_slot_request.exclude_categories),
        std::begin(context.exclude_categories),
        std::end(context.exclude_categories));
      ...
      if (context.no_flash)
      {
        ad_slot_request.exclude_categories.emplace_back("flash");
      }
      ...
      if (!appnexus_vast)
      {
        ...
        {
          ad_slot_request.sizes.emplace_back(*(slot_it->appnexus_sizes.begin()));
        }
      }
      else if (!slot_it->appnexus_sizes.empty())
      {
    ...
    noexcept
  {
    ...
    add_param_processor_(
      ...
      new FrontendCommons::NumberParamProcessor<RequestInfo, unsigned long>(
        &RequestInfo::flag));
    add_param_processor_(
      Request::Context::Grpc::SOURCE_ID,
    ...
    noexcept
  {
    ...
    if(!user_agent.empty())
    {
      ...
      request_params.common_info.user_agent =
        std::string_view(user_agent.data(), user_agent.size());
    ...
    if (!user_agent.empty() || application)
    {
      ...
      request_params.context_info.platform_ids.reserve(platform_ids.size());
    ...
    noexcept
  {
    if(!add_url.url().empty())
    {
      try
      {
        ...
        request_params.common_info.urls.emplace_back(std::move(normalized_add_url));
    ...
    noexcept
  {
    ...
    else
    {
      ...
      if(!ip.empty())
      {
        request_params.common_info.peer_ip =
          std::string_view(ip.data(), ip.size());

        if(ip_logging_enabled_)
        {
          std::string ip_hash;
          FrontendCommons::ip_hash(ip_hash, ip, ip_salt_);
          request_params.context_info.ip_hash = std::move(ip_hash);
        }
    ...
    const noexcept
  {
    ...
    if (!signed_user_id.empty())
    {
      try
      {
        ...
        request_params.common_info.user_id = uid;
  ...
  {
    request_params.publisher_account_ids.reserve(
      request_info.publisher_account_ids.size());
    request_params.publisher_account_ids.insert(
