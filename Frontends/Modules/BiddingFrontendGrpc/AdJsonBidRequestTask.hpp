#ifndef BIDDINGFRONTENDGRPC_ADJSONBIDREQUESTTASK_HPP
#define BIDDINGFRONTENDGRPC_ADJSONBIDREQUESTTASK_HPP
...
{
  class AdJsonBidRequestTask final : public BidRequestTask
  {
  public:
  ...
  protected:
    ~AdJsonBidRequestTask() override = default;

    void fill_by_adjson_request_(
...
#endif /*BIDDINGFRONTENDGRPC_ADJSONBIDREQUESTTASK_HPP*/
