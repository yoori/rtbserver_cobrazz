...
namespace AdServer::ChannelSvcs
{
  ...
  public:
    ...
    ChannelUpdateStatLogger(unsigned long size, unsigned long period, const char* out_dir)
      /*throw(eh::Exception)*/;
  protected:
    virtual ~ChannelUpdateStatLogger() noexcept;
  public:

    void process_config_update(unsigned long colo_id, const std::string& version)
      /*throw(Exception)*/;
