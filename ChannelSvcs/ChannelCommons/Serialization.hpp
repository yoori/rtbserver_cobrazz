...
namespace AdServer::ChannelSvcs
{
  ...
  public:
    ...
    static SubStringVector& get_parts(const void* data, size_t size, SubStringVector& parts)
      /*throw(eh::Exception, BadFormatException)*/;

    static Parts& get_parts(const void* data, size_t size, Parts& parts)
      /*throw(eh::Exception, BadFormatException)*/;

    static SubStringVector& get_parts(const std::string& data, SubStringVector& parts)
      /*throw(eh::Exception, BadFormatException)*/;

    static std::string& get_trigger(const void* data, size_t size, std::string& trigger)
      /*throw(eh::Exception, BadFormatException)*/;

    static std::string& get_trigger(const std::string& in_trigger, std::string& trigger)
      /*throw(eh::Exception, BadFormatException)*/;
  ...
  private:
    static void add_bit_(unsigned char& bitvalue, bool value, unsigned char* &result)
      noexcept;
    static bool get_bit_(size_t& position, unsigned char& bitvalue, const unsigned char* result)
      noexcept;
  };
}
...
namespace AdServer::ChannelSvcs
{
    ...
    /*throw(eh::Exception)*/
  {
    ...
    for (typename PARTS::const_iterator it = parts.begin(); it != parts.end(); ++it)
    {
  ...
  void Serialization::serialize(
    ...
    /*throw(eh::Exception)*/
  {
    serialize(parts, type, exact, negative, StringAllocator(result), result, PartAdapter());
  }

  inline
  SubStringVector& Serialization::get_parts(const void* data, size_t size, SubStringVector& parts)
    /*throw(eh::Exception, BadFormatException)*/
  {
    if (size < 3)
    {
  ...
  inline
  Parts& Serialization::get_parts(const void* data, size_t size, Parts& parts)
    /*throw(eh::Exception, BadFormatException)*/
  {
    if (size < 3)
    {
    ...
    while (word_ptr < end)
    {
      ...
      it_last->quotes = quoted(data, std::distance(parts.begin(), it_last));
  ...
  inline
  SubStringVector& Serialization::get_parts(const std::string& data, SubStringVector& parts)
    /*throw(eh::Exception, BadFormatException)*/
  {
  ...
  inline
  std::string& Serialization::get_trigger(const void* data, size_t size, std::string& trigger)
    /*throw(eh::Exception, BadFormatException)*/
  {
  ...
  inline
  std::string& Serialization::get_trigger(const std::string& in, std::string& trigger)
    /*throw(eh::Exception, BadFormatException)*/
  {
  ...
  size_t Serialization::get_reserve_size(const void* data) noexcept
  {
    ...
    for (const unsigned char* flags = static_cast<const unsigned char*>(data) + 1;
  ...
  {
    const unsigned char* trigger_flags = static_cast<const unsigned char*>(trigger);
    ...
    noexcept
  {
    ...
    unsigned char bitvalue = (1 << (index - index_in_flags * k_flags_in_byte));
    const unsigned char* trigger_flags = static_cast<const unsigned char*>(trigger) + 1;
