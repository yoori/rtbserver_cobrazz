...
namespace AdServer::LogProcessing
{
  ...
  void
  LogGeneralizerImpl::apply_log_proc_config_part2_(const LogProcessingType &config)
    /*throw(eh::Exception)*/
  {
    ...
    init_log_proc_info_<AdvertiserUserStatProcTraits>(config.AdvertiserUserStat());
    ...
    init_log_proc_info_<ChannelImpInventoryProcTraits>(config.ChannelImpInventory());
    ...
    init_log_proc_info_<ExpressionPerformanceProcTraits>(config.ExpressionPerformance());
