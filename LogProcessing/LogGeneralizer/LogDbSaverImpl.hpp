...
namespace AdServer::LogProcessing
{
  ...
  DECLARE_NESTED_LOG_DB_SAVER_EXT_2(CmpStat, CustomCmpStat, LogGeneralizerStatMapBundle_var);
  ...
  DECLARE_NESTED_LOG_PG_CSV_SAVER(CmpStat, CustomCmpStat, LogGeneralizerStatMapBundle_var);
