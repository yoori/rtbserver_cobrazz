...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const CampaignStatKeyDef &rhs) const
    {
      ...
      return sdate_ == rhs.sdate_ &&
        ...
        campaign_id_ == rhs.campaign_id_ && ccg_id_ == rhs.ccg_id_;
    }
  ...
  private:
    void calc_hash()
    {
      ...
      hash_ = Generics::CRC::quick(hash_, &adv_account_id_, sizeof(adv_account_id_));
  ...
  public:
    ...
    CreativeStatValueDef(long requests, long imps, long clicks, long actions)
    :
      requests_(requests),
      imps_(imps),
      clicks_(clicks),
  ...
  public:
    ...
    CampaignTagStatValueDef(DecimalT pub_isp_amount, DecimalT adv_amount, DecimalT adv_comm_amount)
    :
