...
namespace AdServer::LogProcessing
{
    ...
    /*throw(eh::Exception)*/
  {
    ...
    init_log_proc_info_<PageLoadsDailyStatProcTraits>(config.PageLoadsDailyStat());
    ...
    init_log_proc_info_<ChannelPerformanceProcTraits>(config.ChannelPerformance());

    init_log_proc_info_<ChannelPriceRangeProcTraits>(config.ChannelPriceRange());

    init_log_proc_info_<ChannelTriggerImpStatProcTraits>(config.ChannelTriggerImpStat());

    init_log_proc_info_<ChannelTriggerStatProcTraits>(config.ChannelTriggerStat());

    init_log_proc_info_<DeviceChannelCountStatProcTraits>(config.DeviceChannelCountStat());
    ...
    init_log_proc_info_<CcgSelectionFailureStatProcTraits>(config.CCGSelectionFailureStat());
