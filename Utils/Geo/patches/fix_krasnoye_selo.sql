...
BEGIN
  PERFORM set_config(
    ...
    $geo_plan$[{"merge_no":1,"keep_region":"Saint Petersburg City","keep_name":"Krasnoye Selo","keep_latitude":"59.738300","keep_longitude":"30.089400","delete_region":"Leningrad","delete_name":"Krasnoye Selo","delete_latitude":"59.733300","delete_longitude":"30.083300"}]$geo_plan$,
    true);
END
$configure$;
