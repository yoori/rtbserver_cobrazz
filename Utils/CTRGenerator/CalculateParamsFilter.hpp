...
namespace AdServer::CampaignSvcs
{
  ...
  protected:
    ...
    public:
      virtual void
      set_value(CTRGenerator::CalculateParams& calc_params, const String::SubString& str) = 0;
    ...
    {
    public:
      CalcParamFillerIntImpl(IntType CTRGenerator::CalculateParams::* field);

      virtual void
      set_value(CTRGenerator::CalculateParams& calc_params, const String::SubString& str);
    ...
    {
    public:
      CalcParamFillerStringImpl(std::string CTRGenerator::CalculateParams::* field);
    ...
    public:
      ...
      void
      set_value(CTRGenerator::CalculateParams& calc_params, const String::SubString& str) override;
    ...
    {
    public:
      CalcParamFillerIntListImpl(CTRGenerator::IdSet CTRGenerator::CalculateParams::* field);
