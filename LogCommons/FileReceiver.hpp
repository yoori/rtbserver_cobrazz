...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool
    fetch_files(const char* input_dir, const char* prefix)
  ...
  protected:
    ...
    void
    fetch_files_handler_(const char* full_path, const std::string& prefix)
      /*throw(eh::Exception)*/;

    void
    fetch_intermediate_dir_handler_(const char* full_path, const std::string&)
      /*throw(eh::Exception)*/;

    void
    fetch_file_(const std::string& name, const std::string& full_path)
      /*throw(eh::Exception)*/;
    ...
    void
    check_top_changed_(const std::string& top, const std::string& file_name)
      noexcept;
