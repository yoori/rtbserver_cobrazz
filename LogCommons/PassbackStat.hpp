...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const PassbackStatInnerKey_V_2_4& rhs) const
    {
      ...
      return user_status_ == rhs.user_status_ &&
        country_code_ == rhs.country_code_ && tag_id_ == rhs.tag_id_;
    }
  ...
  public:
    ...
    PassbackStatInnerKey(const PassbackStatInnerKey_V_2_4& key)
    :
    ...
    bool operator==(const PassbackStatInnerKey& rhs) const
    {
      ...
      return user_status_ == rhs.user_status_ &&
        country_code_ == rhs.country_code_ && tag_id_ == rhs.tag_id_ && size_id_ == rhs.size_id_;
    }
  ...
  public:
    ...
    explicit
    PassbackStatInnerData(unsigned long requests)
    :
      requests_(requests)
    {
    }
  ...
  struct PassbackStatKey
  {
    ...
    PassbackStatKey(const DayHourTimestamp& sdate, std::uint32_t colo_id)
    :
      sdate_(sdate),
      colo_id_(colo_id),
      hash_()
