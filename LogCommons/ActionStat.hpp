...
namespace AdServer::LogProcessing::v3_2_0_28
{
  ...
  public:
    ...
    bool operator==(const ActionStatInnerKey& rhs) const
    {
      return this == &rhs ||
        ...
        request_id_ == rhs.request_id_ && cc_id_ == rhs.cc_id_);
    }
  ...
  struct ActionStatKey
  {
    ...
    ActionStatKey(const DayHourTimestamp& sdate, std::uint32_t colo_id)
    :
      sdate_(sdate),
      colo_id_(colo_id),
      hash_()
