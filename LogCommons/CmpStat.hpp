...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const CmpStatInnerKey_V_2_3& rhs) const
    {
      ...
      return publisher_account_id_ == rhs.publisher_account_id_ &&
        ...
        fraud_ == rhs.fraud_ && walled_garden_ == rhs.walled_garden_;
    }
  ...
  public:
    ...
    CmpStatInnerKey(const CmpStatInnerKey_V_2_3& key)
    :
  ...
  public:
    ...
    bool operator==(const CmpStatInnerData& rhs) const
    {
      ...
      return imps_ == rhs.imps_ &&
        ...
        adv_amount_cmp_ == rhs.adv_amount_cmp_ && cmp_sys_amount_ == rhs.cmp_sys_amount_;
    }
  ...
  struct CmpStatKey
  {
    ...
    bool operator==(const CmpStatKey& rhs) const
    {
      ...
      return sdate_ == rhs.sdate_ && adv_sdate_ == rhs.adv_sdate_ && colo_id_ == rhs.colo_id_;
    }
