...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const ChannelHitStatInnerData_V_1_0& rhs) const
    {
      ...
      return hits_ == rhs.hits_ &&
        ...
        hits_search_kws_ == rhs.hits_search_kws_ && hits_repeat_kws_ == rhs.hits_repeat_kws_;
    }
  ...
  public:
    ...
    bool operator==(const ChannelHitStatInnerData& rhs) const
    {
      ...
      return hits_ == rhs.hits_ &&
        hits_urls_ == rhs.hits_urls_ &&
        hits_kws_ == rhs.hits_kws_ &&
        hits_search_kws_ == rhs.hits_search_kws_ && hits_url_kws_ == rhs.hits_url_kws_;
    }
  ...
  struct ChannelHitStatKey
  {
    ...
    ChannelHitStatKey(const DayTimestamp& sdate, std::uint32_t colo_id)
    :
      sdate_(sdate),
      colo_id_(colo_id),
      hash_()
