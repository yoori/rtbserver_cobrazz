...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    ChannelImpInventoryInnerKey(std::uint32_t channel_id, CCGType ccg_type)
    :
    ...
    {
      return channel_id_ == rhs.channel_id_ && ccg_type_ == rhs.ccg_type_;
    }
  ...
  public:
    ...
    struct Counter
    {
      ...
      Counter(const FixedNum& imps_val, const FixedNum& user_count_val, const FixedNum& revenue_val)
      :
        imps(imps_val),
      ...
      bool operator==(const Counter& cntr) const
      {
        ...
        return imps == cntr.imps && user_count == cntr.user_count && value == cntr.value;
      }
    ...
    bool operator==(const ChannelImpInventoryInnerData& rhs) const
    {
      ...
      return meaningful_data_ == rhs.meaningful_data_ &&
        ...
        imp_other_count_ == rhs.imp_other_count_ && no_impops_count_ == rhs.no_impops_count_;
    }
  ...
  public:
    ...
    struct ImpOtherImpsAndRevenueCounter
    {
      ...
      ImpOtherImpsAndRevenueCounter(const FixedNum& imps_val, const FixedNum& revenue_val)
    ...
    struct NoImpopsImpsAndRevenueCounter
    {
      ...
      NoImpopsImpsAndRevenueCounter(const FixedNum& imps_val, const FixedNum& revenue_val)
        : imps(imps_val), revenue(revenue_val)
      {}
    };
  ...
  struct ChannelImpInventoryKey
  {
    ...
    ChannelImpInventoryKey(const DayTimestamp& sdate, std::uint32_t colo_id)
    :
      sdate_(sdate),
      colo_id_(colo_id),
      hash_()
