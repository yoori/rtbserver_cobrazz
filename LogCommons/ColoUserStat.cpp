...
namespace AdServer::LogProcessing
{
  ...
  template <> const char* ColoUserStatTraits::B::base_name_ = "ColoUserStat";
  template <> const char* ColoUserStatTraits::B::signature_ = "ColoUserStat";
  template <> const char* ColoUserStatTraits::B::current_version_ = "2.8.1";

  template <> const char* GlobalColoUserStatTraits::B::base_name_ = "GlobalColoUserStat";
  template <> const char* GlobalColoUserStatTraits::B::signature_ = "GlobalColoUserStat";
  template <> const char* GlobalColoUserStatTraits::B::current_version_ = "2.8.1";
