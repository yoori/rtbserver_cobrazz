...
public:
  ...
  typedef RequestData_V_3_7_1::DeliveryThresholdT DeliveryThresholdT;
  typedef RequestData_V_3_7_1::DeviceChannelIdOptional
    DeviceChannelIdOptional;

  typedef RequestData_V_3_7_1::CmpChannel CmpChannel;

  typedef RequestData_V_3_7_1::CmpChannelList CmpChannelList;
