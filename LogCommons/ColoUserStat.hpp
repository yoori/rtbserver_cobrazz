...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const ColoUserStatInnerKey_V_2_5& rhs) const
    {
      ...
      return create_date_ == rhs.create_date_ && last_appearance_date_ == rhs.last_appearance_date_;
    }
  ...
  public:
    ...
    ColoUserStatInnerData_V_2_5(long unique_users, long network_unique_users)
    :
  ...
  public:
    ...
    ColoUserStatInnerData_V_2_6(long unique_users, long network_unique_users, long unique_hids)
    :
      unique_users_(unique_users),
      network_unique_users_(network_unique_users),
    ...
    bool operator==(const ColoUserStatInnerData_V_2_6& rhs) const
    {
      ...
      return unique_users_ == rhs.unique_users_ &&
        network_unique_users_ == rhs.network_unique_users_ && unique_hids_ == rhs.unique_hids_;
    }
  ...
  public:
    ...
    bool operator==(const ColoUserStatInnerData& rhs) const
    {
      ...
      return unique_users_ == rhs.unique_users_ &&
        network_unique_users_ == rhs.network_unique_users_ &&
        profiling_unique_users_ == rhs.profiling_unique_users_ && unique_hids_ == rhs.unique_hids_;
    }
    ...
    bool is_null() const
    {
      return !unique_users_ && !network_unique_users_ && !profiling_unique_users_ && !unique_hids_;
    }
  ...
  struct ColoUserStatKey
  {
    ...
    ColoUserStatKey(const DayTimestamp& sdate, std::uint32_t colo_id)
    :
      sdate_(sdate),
      colo_id_(colo_id),
      hash_()
  ...
  )
  {
    ...
    unsigned long weekly_or_monthly_users_count =
      std::max(colo_users_data.weekly_users_count(), colo_users_data.monthly_users_count());
    ...
    if (colo_users_data.daily_network_users_count() < colo_users_data.monthly_network_users_count())
    {
      Stream::Error es;
    ...
    if (colo_users_data.weekly_users_count() > colo_users_data.monthly_users_count())
    {
