...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const ReachStatInnerData& rhs) const
    {
      ...
      return daily_reach_ == rhs.daily_reach_ &&
        monthly_reach_ == rhs.monthly_reach_ && total_reach_ == rhs.total_reach_;
    }
  ...
  struct ReachStatKey
  {
    ...
    ReachStatKey(const DayTimestamp& sdate, std::uint32_t colo_id)
    :
      sdate_(sdate),
      colo_id_(colo_id),
      hash_()
    ...
    ReachStatKey(const DayTimestamp& timestamp)
    :
      sdate_(timestamp),
      colo_id_(),
      hash_()
  ...
  public:
    ...
    CcgStatInnerData_V_2_3(const CcgStatInnerData_V_1_1& rhs)
    :
      ReachStatInnerData(rhs.daily_reach(), rhs.monthly_reach(), rhs.total_reach()),
      impops_(0),
      auctions_lost_()
    {
    }

    CcgStatInnerData_V_2_3(const CcgStatInnerData_V_1_2& rhs)
    :
      ReachStatInnerData(rhs.daily_reach(), rhs.monthly_reach(), rhs.total_reach()),
      impops_(0),
    ...
    bool operator==(const CcgStatInnerData_V_2_3& rhs) const
    {
      return static_cast<const ReachStatInnerData&>(*this) ==
        ...
        impops_ == rhs.impops_ && auctions_lost_ == rhs.auctions_lost_;
    }

    CcgStatInnerData_V_2_3&
    operator+=(const CcgStatInnerData_V_2_3& rhs)
    {
      static_cast<ReachStatInnerData&>(*this) += static_cast<const ReachStatInnerData&>(rhs);
      impops_ += rhs.impops_;
  ...
  public:
    ...
    explicit
    CcgStatInnerData(unsigned long auctions_lost)
    :
      auctions_lost_(auctions_lost)
    {
    }

    CcgStatInnerData(const CcgStatInnerData_V_1_1&)
    :
      auctions_lost_()
    {
    }

    CcgStatInnerData(const CcgStatInnerData_V_1_2& rhs)
    :
      auctions_lost_(rhs.auctions_lost())
    {
    }

    CcgStatInnerData(const CcgStatInnerData_V_2_3& rhs)
    :
      auctions_lost_(rhs.auctions_lost())
    {
    }
  ...
  public:
    ...
    CcStatInnerData_V_2_3(const CcStatInnerData_V_1_1& rhs)
    :
      ReachStatInnerData(rhs.daily_reach(), rhs.monthly_reach(), rhs.total_reach()),
      impops_(),
      auctions_lost_()
    ...
    CcStatInnerData_V_2_3(const CcStatInnerData_V_1_2& rhs)
    :
      ReachStatInnerData(rhs.daily_reach(), rhs.monthly_reach(), rhs.total_reach()),
      impops_(),
      auctions_lost_(rhs.auctions_lost())
  ...
  public:
    ...
    explicit
    CcStatInnerData(unsigned long auctions_lost)
    :
      auctions_lost_(auctions_lost)
    {
    }

    CcStatInnerData(const CcStatInnerData_V_1_1&)
    :
      auctions_lost_()
    {
    }

    CcStatInnerData(const CcStatInnerData_V_1_2& rhs)
    :
      auctions_lost_(rhs.auctions_lost())
    {
    }
  ...
  public:
    ...
    AdvertiserUserStatInnerData_V_1_0(const AdvertiserUserStatInnerData_V_1_0& data)
    :
      reach_(data.reach()),
    ...
    bool operator==(const AdvertiserUserStatInnerData_V_1_0& data) const
    {
      return reach_ == data.reach_ &&
        text_reach_ == data.text_reach_ && display_reach_ == data.display_reach_;
    }
    ...
    bool is_null() const
    {
      return reach_.is_null() && text_reach_.is_null() && display_reach_.is_null();
    }
    ...
    friend
    FixedBufStream<TabCategory>&
    operator>>(FixedBufStream<TabCategory>& is, AdvertiserUserStatInnerData_V_1_0& data);
  ...
  public:
    ...
    explicit
    AdvertiserUserStat_V_1_0_To_CurrentLoader(const CollectorBundlePtrT& bundle)
    :
      bundle_(bundle)
    {
    }
  ...
  private:
    ...
    AdvertiserUserStat_V_1_0_To_CurrentLoader(const AdvertiserUserStat_V_1_0_To_CurrentLoader&);
