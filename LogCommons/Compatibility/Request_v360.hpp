...
#include <LogCommons/Compatibility/Request_v354.hpp>
#include <CampaignSvcs/CampaignCommons/CampaignTypes.hpp>

namespace AdServer {
namespace LogProcessing {

class RequestData_V_3_6
{
public:
  DECLARE_EXCEPTION(InvalidSystemRevenue, eh::DescriptiveException);

  typedef RequestData_V_3_5_4 PrevVersion;
  ...
  //Conversion from 3.5.4
  RequestData_V_3_6(const PrevVersion& data)
  :
    holder_(
      new DataHolder(
        data.time(),
  ...
  bool operator==(const RequestData_V_3_6& data) const
  {
