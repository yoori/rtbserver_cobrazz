#ifndef AD_SERVER_LOG_PROCESSING_REQUEST_V371_HPP
#define AD_SERVER_LOG_PROCESSING_REQUEST_V371_HPP
...
public:
  ...
  RequestData_V_3_7_1() noexcept {}

  RequestData_V_3_7_1(const RequestData_V_3_7_1& init) noexcept
    : holder_(init.holder_)
  {}

  RequestData_V_3_7_1(RequestData_V_3_7_1&& init) noexcept
  {
  ...
  RequestData_V_3_7_1(const RequestData_V_3_6_1& data)
    : holder_(new DataHolder(
        data.time(),
        data.isp_time(),
        data.pub_time(),
  ...
  bool operator==(const RequestData_V_3_7_1& data) const
  {
...
private:
  struct DataHolder: public ReferenceCounting::AtomicImpl
  {
    ...
    void invariant() const /*throw(ConstraintViolation)*/
    {
      ...
      {
        Stream::Error es;
        es << "RequestData_V_3_7_1::DataHolder::invariant(): ccg_type "
      ...
      {
        Stream::Error es;
        es << "RequestData_V_3_7_1::DataHolder::invariant(): user_status "
      ...
      {
        Stream::Error es;
        es << "RequestData_V_3_7_1::DataHolder::invariant(): delivery_threshold "
...
private:
  ...
  friend
  std::ostream&
  operator<<(std::ostream& os, const RequestData_V_3_7_1& data)
    /*throw(eh::Exception)*/;
...
typedef SeqCollector<RequestData_V_3_7_1, true> RequestCollector_V_3_7_1;

} // namespace LogProcessing
} // namespace AdServer

#endif /* AD_SERVER_LOG_PROCESSING_REQUEST_V371_HPP */
