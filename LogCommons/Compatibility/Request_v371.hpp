...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    RequestData_V_3_7_1(const RequestData_V_3_7_1& init) noexcept = default;

    RequestData_V_3_7_1(RequestData_V_3_7_1&& init) noexcept = default;
    ...
    struct DataHolder: public ReferenceCounting::AtomicImpl
    {
      ...
      operator==(const DataHolder& data) const
      {
        return time == data.time &&
          ...
          pub_cost_coef == data.pub_cost_coef && at_flags == data.at_flags;
      }
