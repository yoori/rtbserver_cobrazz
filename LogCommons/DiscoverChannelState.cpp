...
namespace AdServer::LogProcessing
{
  ...
  template <> const char* DiscoverChannelStateTraits::B::base_name_ = "DiscoverChannelState";
  template <> const char* DiscoverChannelStateTraits::B::signature_ = "DiscoverChannelState";
