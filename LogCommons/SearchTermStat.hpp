...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    explicit
    SearchTermStatInnerKey(const std::string& search_term)
      /*throw(eh::Exception)*/
  ...
  private:
    ...
    Aux_::StringIoWrapper search_term_;
    size_t hash_;
  };
  ...
  using SearchTermStatInnerCollector = StatCollector<
  ...
  struct SearchTermStatTraits: LogDefaultTraits<SearchTermStatCollector, true, true>
  {
