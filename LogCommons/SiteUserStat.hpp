...
namespace AdServer::LogProcessing
{
  ...
  private:
    ...
    void invariant() const
    {
      if (!site_id_)
      {
        throw ConstraintViolation("SiteUserStatInnerKey::invariant(): site_id_ must be > 0");
      }
    }
  ...
  public:
    ...
    explicit
    SiteUserStatInnerData(long unique_users)
  ...
  public:
    ...
    explicit
    SiteStatToSiteUserStatLoader(const CollectorBundlePtrT& bundle)
      : bundle_(bundle)
    {}
