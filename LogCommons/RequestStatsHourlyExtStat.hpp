...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const RequestStatsHourlyExtInnerData& rhs) const
    {
      ...
      return unverified_imps_ == rhs.unverified_imps_ &&
        ...
        ym_robots_clicks_ == rhs.ym_robots_clicks_ && ym_session_time_ == rhs.ym_session_time_;
    }
  ...
  public:
    ...
    RequestStatsHourlyExtKey(const DayHourTimestamp& sdate, const DayHourTimestamp& adv_sdate)
    :
      sdate_(sdate),
    ...
    RequestStatsHourlyExtKey(const DayHourTimestamp& timestamp)
    :
      sdate_(timestamp),
      adv_sdate_(sdate_),
      hash_()
