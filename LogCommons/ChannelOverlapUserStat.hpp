...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    ChannelOverlapUserStatInnerKey(std::uint32_t channel1_id, std::uint32_t channel2_id)
    :
    ...
    bool operator==(const ChannelOverlapUserStatInnerKey& rhs) const
    {
      ...
      return channel1_id_ == rhs.channel1_id_ && channel2_id_ == rhs.channel2_id_;
    }
  ...
  public:
    ...
    explicit
    ChannelOverlapUserStatInnerData(unsigned long unique_users)
    :
