...
namespace AdServer::LogProcessing
{
  ...
  template <> const char*
  ResearchPostImpressionTraits::B::base_name_ = "<UNDEFINED>";
  template <> const char*
  ResearchPostImpressionTraits::B::signature_ = "<UNDEFINED>";
  template <> const char*
  ResearchPostImpressionTraits::B::current_version_ = "<UNDEFINED>";
} // namespace AdServer::LogProcessing
