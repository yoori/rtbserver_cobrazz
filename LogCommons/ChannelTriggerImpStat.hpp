...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    ChannelTriggerImpStatInnerKey_V_2_3(std::uint32_t channel_trigger_id, char type)
    :
    ...
    bool operator==(const ChannelTriggerImpStatInnerKey_V_2_3& rhs) const
    {
      ...
      return channel_trigger_id_ == rhs.channel_trigger_id_ && type_ == rhs.type_;
    }
  ...
  public:
    ...
    ChannelTriggerImpStatInnerKey(const ChannelTriggerImpStatInnerKey_V_2_3& key)
    :
  ...
  struct ChannelTriggerImpStatKey
  {
    ...
    ChannelTriggerImpStatKey(const DayTimestamp& sdate, std::uint32_t colo_id)
    :
      sdate_(sdate),
      colo_id_(colo_id),
      hash_()
