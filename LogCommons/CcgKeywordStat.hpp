...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const CcgKeywordStatInnerKey& rhs) const
    {
      ...
      return ccg_keyword_id_ == rhs.ccg_keyword_id_ &&
        currency_exchange_id_ == rhs.currency_exchange_id_ && cc_id_ == rhs.cc_id_;
    }
  ...
  public:
    ...
    CcgKeywordStatInnerData_V_1_4(unsigned long imps, unsigned long clicks, const FixedNum& revenue)
    :
      imps_(imps),
      clicks_(clicks),
      revenue_(revenue)
    ...
    bool operator==(const CcgKeywordStatInnerData_V_1_4& rhs) const
    {
      ...
      return imps_ == rhs.imps_ && clicks_ == rhs.clicks_ && revenue_ == rhs.revenue_;
    }
    ...
    friend
    FixedBufStream<TabCategory>&
    operator>>(FixedBufStream<TabCategory>& is, CcgKeywordStatInnerData_V_1_4& data)
      /*throw(eh::Exception)*/;
  ...
  public:
    ...
    CcgKeywordStatInnerData(const CcgKeywordStatInnerData_V_1_4& data)
    :
      imps_(data.imps()),
      clicks_(data.clicks()),
  ...
  struct CcgKeywordStatKey
  {
    ...
    CcgKeywordStatKey(const DayHourTimestamp& sdate, std::uint32_t colo_id)
    :
      sdate_(sdate),
      colo_id_(colo_id),
      hash_()
