...
namespace AdServer::LogProcessing
{
    ...
    /*throw(eh::Exception)*/
  {
    ...
    String::SubString::ConstPointer ptr = RESTRICTED_CHARS.find_owned(begin, end);
    if (ptr != end)
    {
  ...
  inline std::string
  hex_request_id(const AdServer::Commons::RequestId& request_id)
  {
    // convert last uint64 of uuid to hex
    return String::StringManip::hex_encode(request_id.end() - 8, 8, true);
  }
