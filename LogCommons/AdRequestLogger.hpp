...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const AdvertiserActionData_V_3_3_1& data) const
    {
      ...
      return time_ == data.time_ &&
        ...
        ip_address_ == data.ip_address_ && cur_value_ == data.cur_value_;
    }
  ...
  public:
    ...
    AdvertiserActionData(const AdvertiserActionData_V_3_3_1& data)
    :
      time_(data.time()),
  ...
  struct ActionOpportunityData
  {
    ...
    bool operator==(const ActionOpportunityData& data) const
    {
      ...
      return time == data.time &&
        user_id == data.user_id && cid == data.cid && request_id == data.request_id;
    }
  ...
  public:
    PassbackOpportunityData(
      ...
      distribution_hash_(request_distribution_hash(request_id, user_id))
    {}
    ...
    bool operator==(const PassbackOpportunityData& data) const
    {
      ...
      return time_ == data.time_ &&
        ...
        request_id_ == data.request_id_ && user_status_ == data.user_status_;
    }
  ...
  public:
    ...
    ClickData(const ClickData_V_1_0& data)
    :
      time_(data.time()),
    ...
    bool operator==(const ClickData& data) const
    {
      ...
      return time_ == data.time_ && request_id_ == data.request_id_ && referrer_ == data.referrer_;
    }
  ...
  public:
    ...
    bool operator==(const ImpressionData_V_3_1& data) const
    {
      ...
      return time_ == data.time_ &&
        ...
        pub_sys_revenue_ == data.pub_sys_revenue_ && request_id_ == data.request_id_;
    }
  ...
  public:
    ...
    bool operator==(const ImpressionData_V_3_2& data) const
    {
      ...
      return time_ == data.time_ &&
        ...
        pub_revenue_type_ == data.pub_revenue_type_ && request_id_ == data.request_id_;
    }
  ...
  public:
    ...
    bool operator==(const ImpressionData_V_3_3& data) const
    {
      ...
      return time_ == data.time_ &&
        ...
        pub_revenue_ == data.pub_revenue_ &&
        pub_sys_revenue_ == data.pub_sys_revenue_ &&
        pub_revenue_type_ == data.pub_revenue_type_ && request_type_ == data.request_type_;
    }
  ...
  public:
    ...
    bool operator==(const ImpressionData_V_3_3_1& data) const
    {
      ...
      return time_ == data.time_ &&
        ...
        request_type_ == data.request_type_ && action_name_.get() == data.action_name_.get();
    }
  ...
  private:
    ...
    bool request_type_is_valid_() const
    {
      return request_type_ == 'N' || request_type_ == 'T' || request_type_ == 'C';
    }
  ...
  public:
    ...
    ImpressionData(const ImpressionData_V_1_0& data)
    :
      time_(data.time()),
      request_id_(data.request_id()),
      user_id_(),
    ...
    ImpressionData(const ImpressionData_V_3_1& data)
    :
      time_(data.time()),
      request_id_(data.request_id()),
      user_id_(),
    ...
    ImpressionData(const ImpressionData_V_3_2& data)
    :
      time_(data.time()),
      request_id_(data.request_id()),
      user_id_(),
    ...
    ImpressionData(const ImpressionData_V_3_3& data)
    :
      time_(data.time()),
      request_id_(data.request_id()),
      user_id_(data.user_id()),
    ...
    ImpressionData(const ImpressionData_V_3_3_1& data)
    :
      time_(data.time()),
      request_id_(data.request_id()),
      user_id_(data.user_id()),
