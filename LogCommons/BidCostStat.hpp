...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const BidCostStatInnerKey& rhs) const
    {
      ...
      return tag_id_ == rhs.tag_id_ &&
        ...
        url_.get() == rhs.url_.get() && cost_ == rhs.cost_;
    }
  ...
  public:
    ...
    explicit
    BidCostStatInnerData(long unverified_imps, long imps, long clicks)
    ...
    bool operator==(const BidCostStatInnerData& rhs) const
    {
      ...
      return unverified_imps_ == rhs.unverified_imps_ &&
        imps_ == rhs.imps_ && clicks_ == rhs.clicks_;
    }
  ...
  struct BidCostStatKey
  {
    ...
    BidCostStatKey(const DayTimestamp& adv_sdate)
    :
