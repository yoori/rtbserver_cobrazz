...
namespace AdServer::LogProcessing
{
  ...
  public:
    ...
    bool operator==(const DeviceChannelCountStatInnerKey& rhs) const
    {
      ...
      return device_channel_id_ == rhs.device_channel_id_ &&
        channel_type_ == rhs.channel_type_ && channel_count_ == rhs.channel_count_;
    }
  ...
  public:
    ...
    explicit
    DeviceChannelCountStatInnerData(unsigned long users_count)
    :
  ...
  public:
    ...
    DeviceChannelCountStatKey(const DayTimestamp& isp_sdate, std::uint32_t colo_id)
    :
